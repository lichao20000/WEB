 ...
 * 
 */
public class DeviceNameFilter extends AbstractFilter
{
	public DeviceNameFilter(String value,BaseOperation operation)
	{
	...
	{
		return this.getOperation().compareTo(getValue(),event.m_SourceName);
	}
}
