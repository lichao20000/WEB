 ...
 * @version 1.0
 */
public class ReadDeviceInfo extends DeviceCommonData implements InterfaceReadInfo {
  ...
  public ArrayList getDeviceInfo()
  {
    ...
    String[][]    m_strOID = {
            {"1.3.6.1.2.1.1.1",     "系统描述信息"},
            {"1.3.6.1.2.1.1.2",     "系统sysObjectID"},
            {"1.3.6.1.2.1.1.3",     "系统活动的时间"},
            {"1.3.6.1.2.1.1.4",     "联系人"},
            {"1.3.6.1.2.1.1.5",     "系统名字"},
            {"1.3.6.1.2.1.1.64",    "所在位置"},
    ...
    for(int i=0;i<list.size();i++)
    {
      ...
      DataList=(Data[])dataMap.get((String)list.get(i));
      if(DataList!=null)
      {
