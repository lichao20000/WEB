...
/**
 *
 * <p>Title: GlobalView</p>
 *
 * <p>Description: 全球眼视频监控系统</p>
 *
 * <p>Copyright: Copyright (c) 2007</p>
 *
 * <p>Company: 南京联创网络科技有限公司</p>
 *
 * @author 汪敏
 * @version 1.0
 *
 ...
 *             logger.error(fe.getFriendlyLocateInfo());
 * </code>
 *
 *<p> or: </p>
 * <code>
...
public class FriendlyException extends Throwable {
  ...
  public static int PrintLineNum = 3;
  private static Logger logger = LoggerFactory.getLogger(FriendlyException.class);
  ...
  public String getFriendlyLocateInfo() {
    ...
    for (int i = 0; i < st.length; i++) {
      ...
      if (fullClsName.startsWith(this.localPackageName)) { //输出前1后2行定位信息
        ...
        for (int j = i; j < st.length && j < i + PrintLineNum; j++) {
          msgbuf.append(st[j].toString());
          msgbuf.append("\n");
          printNum++;
        }
        break;
