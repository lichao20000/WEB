...
import com.linkage.module.gtms.stb.report.bio.SheetCustReportBIO;
 ...
 */
public class SheetCustReportACT extends splitPageAction implements SessionAware, ServletResponseAware
  {

	//	日志记录
	private static Logger logger = LoggerFactory.getLogger(SheetCustReportACT.class);
	...
	// bio
	private SheetCustReportBIO bio;
	...
	public SheetCustReportBIO getBio() {
		return bio;
	}

	public void setBio(SheetCustReportBIO bio) {
		this.bio = bio;
	}
