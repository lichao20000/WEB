...
import com.linkage.module.gtms.stb.report.bio.SheetDailyCustReportBIO;
 ...
 */
public class SheetDailyCustReportACT extends splitPageAction implements SessionAware, ServletResponseAware
  {

	//	日志记录
	private static Logger logger = LoggerFactory.getLogger(SheetDailyCustReportACT.class);
	...
	// bio
	private SheetDailyCustReportBIO bio;
	...
	public String getStatsReport()
	{
		...
		statsReportList = bio.getStatsReport(cityId, servTypeId, startOpenDate, endOpenDate,dateList);
		for(int i=0;i<dateList.size();i++){
			System.out.println("............."+dateList.get(i));
		}
		datenum = dateList.size();
		return "result";
	}
	...
	*/
	...
	private String getStartDate()
	{
		...
		long l = now.getLongTime() - 86400*6;
		return new DateTimeUtil(l*1000).getDate();
	}
	...
	public SheetDailyCustReportBIO getBio() {
		return bio;
	}

	public void setBio(SheetDailyCustReportBIO bio) {
		this.bio = bio;
	}
