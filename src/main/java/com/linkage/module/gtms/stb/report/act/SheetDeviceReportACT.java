...
import com.linkage.module.gtms.stb.report.bio.SheetDeviceReportBIO;
 ...
 */
public class SheetDeviceReportACT extends splitPageAction implements SessionAware, ServletResponseAware
  {

	//	日志记录
	private static Logger logger = LoggerFactory.getLogger(SheetDeviceReportACT.class);
	...
	// bio
	private SheetDeviceReportBIO bio;
	...
	public String getStatsReport()
	{
		...
		statsReportList = bio.getStatsReport(cityId, servTypeId, startOpenDate, endOpenDate);
		return "result";
	}
	...
	public SheetDeviceReportBIO getBio() {
		return bio;
	}

	public void setBio(SheetDeviceReportBIO bio) {
		this.bio = bio;
	}
