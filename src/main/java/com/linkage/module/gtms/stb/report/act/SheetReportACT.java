...
import com.linkage.module.gtms.stb.report.bio.SheetReportBIO;
 ...
 */
public class SheetReportACT extends splitPageAction implements SessionAware, ServletResponseAware
  {

	//	日志记录
	private static Logger logger = LoggerFactory.getLogger(SheetReportACT.class);
	...
	public SheetReportBIO getBio() {
		return bio;
	}

	public void setBio(SheetReportBIO bio) {
		this.bio = bio;
	}
