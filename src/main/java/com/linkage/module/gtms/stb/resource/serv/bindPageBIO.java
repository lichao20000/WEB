...
import com.linkage.module.gtms.stb.resource.dao.bindPageDAO;
...
public class bindPageBIO
{
	private bindPageDAO dao;
	private static Logger logger = LoggerFactory
			.getLogger(bindPageBIO.class);
	public static void main(String[] args)
	{
		String a="11:11";
		 boolean status = a.contains(":");  
		 if(status)
		 {
	...
	public String bindcheck(String authUser, String authPwd, String endtime,String cityId,String mac,
...
//			String resultCode = element.elementTextTrim("resultCode");
	...
	public Map<String, String> queryCustomer(String servaccount,String mac) {
		return dao.queryCustomer(servaccount,mac);
	}
	...
	public void addLogBind(long user_id, String user_ip, String city_id,
		...
		dao.addLogBind(user_id,user_ip,city_id, mac, servaccount,ajax,map);
		
	}
	
	
	public bindPageDAO getDao(){
		return dao;
	}
	
	public void setDao(bindPageDAO dao){
		this.dao = dao;
	}
