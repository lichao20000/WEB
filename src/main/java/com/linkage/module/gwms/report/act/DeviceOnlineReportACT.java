 ...
 * 
 */
public class DeviceOnlineReportACT extends splitPageAction implements ServletRequestAware {
	 ...
	 * bio
	 */
	I_DeviceOnlineReportBIO deviceOnlineReportBIO;
	...
	private String displaydevice_type = "none";
	private String displaylast_time = "none";
	...
	public String getDayReport() throws ParseException {
		...
		if(null!=this.bookparam && !"".equals(this.bookparam)){
			...
			for(int i=0;i<tempParam.length;i++){
				...
				if("device_type".equals(tempParam[i])){
					this.displaydevice_type = "";
				}
				if("last_time".equals(tempParam[i])){
					this.displaylast_time = "";
				}
			}
		}else{
			this.displaydevice_serialnumber = "";
		...
		if("excel".equals(isReport)){
			...
			if(null!=this.bookparam && !"".equals(this.bookparam)){
				...
				column[1] = "city_name";
				column[2] = "oui";
				column[3] = "device_type";
				column[4] = "last_time";
			}
			
			this.data = new ArrayList();
			List temp = deviceOnlineReportBIO.getReportData(cityId,startDate, endDate);
			for(int i=0;i<temp.size();i++){
				this.data.add((Map)temp.get(i));
			}
			this.fileName = "终端在线统计";
			...
			//报表
			if ("1".equals(reportType)) {
				this.pdfTitle = "终端在线小时统计";
				this.pdfFileName = "deviceStatus";
			}
			//日报表
			if ("2".equals(reportType)) {
				this.pdfTitle = "终端在线日统计";
				this.pdfFileName = "deviceStatus";
			}
			//周报表
			if ("3".equals(reportType)) {
				this.pdfTitle = "终端在线周统计";
				this.pdfFileName = "deviceStatus";
			}
			//月报表
			if ("4".equals(reportType)) {
				this.pdfTitle = "终端在线月统计";
				this.pdfFileName = "deviceStatus";
			}
			...
			if(null!=this.bookparam && !"".equals(this.bookparam)){
				...
				tbName[0] = "device_serialnumber";
				tbName[1] = "city_name";
				tbName[2] = "oui";
				tbName[3] = "device_type";
				tbName[4] = "last_time";
			}
			
			this.pdfListData = deviceOnlineReportBIO.getReportData(cityId,startDate, endDate);
			
			return "pdfByList";
		}else if("print".equals(isReport)){
			this.exceptinList = deviceOnlineReportBIO.getReportData(cityId,startDate, endDate);
			return "print";
		}else{
			this.exceptinList = deviceOnlineReportBIO.getReportData(cityId,startDate, endDate);
			//this.maxPage_splitPage = deviceOnlineReportBIO.getServStrategyCount(curPage_splitPage, num_splitPage,cityId,startDate, endDate);
			return "list";
		}
	}
	...
	public String goPage() throws Exception {
		...
		this.exceptinList = deviceOnlineReportBIO.getReportData(curPage_splitPage, num_splitPage,cityId,startDate, endDate);
		this.maxPage_splitPage = deviceOnlineReportBIO.getServStrategyCount(curPage_splitPage, num_splitPage,cityId,startDate, endDate);
	...
	/**
	 * @return the deviceOnlineReportBIO
	 */
	public I_DeviceOnlineReportBIO getDeviceOnlineReportBIO() {
		return deviceOnlineReportBIO;
	}

	/**
	 * @param deviceOnlineReportBIO the deviceOnlineReportBIO to set
	 */
	public void setDeviceOnlineReportBIO(
			I_DeviceOnlineReportBIO deviceOnlineReportBIO) {
		this.deviceOnlineReportBIO = deviceOnlineReportBIO;
	}
	...
	/**
	 * @return the displaydevice_type
	 */
	public String getDisplaydevice_type() {
		return displaydevice_type;
	}

	/**
	 * @param displaydevice_type the displaydevice_type to set
	 */
	public void setDisplaydevice_type(String displaydevice_type) {
		this.displaydevice_type = displaydevice_type;
	}

	/**
	 * @return the displaylast_time
	 */
	public String getDisplaylast_time() {
		return displaylast_time;
	}

	/**
	 * @param displaylast_time the displaylast_time to set
	 */
	public void setDisplaylast_time(String displaylast_time) {
		this.displaylast_time = displaylast_time;
	}
