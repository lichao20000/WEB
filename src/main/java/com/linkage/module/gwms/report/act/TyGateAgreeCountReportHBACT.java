...
import com.linkage.module.gwms.report.bio.TyGateAgreeCountReportHBBIO;
 ...
 * @since 2019-4-15
 */
public class TyGateAgreeCountReportHBACT extends ActionSupport implements
		ServletRequestAware {

	private static final long serialVersionUID = 1L;
	Logger logger = LoggerFactory.getLogger(TyGateAgreeCountReportHBACT.class);
	// request取登陆帐号使用
	 ...
	 * BIO
	 */
	private TyGateAgreeCountReportHBBIO bio;
	...
	public TyGateAgreeCountReportHBBIO getBio()
	{
		return bio;
	}

	
	public void setBio(TyGateAgreeCountReportHBBIO bio)
	{
		this.bio = bio;
	}
