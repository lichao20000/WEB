...
import com.linkage.module.gwms.report.dao.TyGateAgreeCountReportHBDAO;
 ...
 * @since 2019-4-15
 */
public class TyGateAgreeCountReportHBBIO {
	Logger logger = LoggerFactory.getLogger(TyGateAgreeCountReportHBBIO.class);
	// 持久层
	TyGateAgreeCountReportHBDAO dao;
	
	public TyGateAgreeCountReportHBDAO getDao()
	{
		return dao;
	}

	
	public void setDao(TyGateAgreeCountReportHBDAO dao)
	{
		this.dao = dao;
	}
