...
import com.linkage.module.gwms.resource.dao.BatchHttpTestBlackListManaDAO;
import com.linkage.module.gwms.util.StringUtil;

public class BatchHttpTestBlackListManaBIO {

	private BatchHttpTestBlackListManaDAO dao;
	
	
	public void setDao(BatchHttpTestBlackListManaDAO dao) {
		this.dao = dao;
	}
