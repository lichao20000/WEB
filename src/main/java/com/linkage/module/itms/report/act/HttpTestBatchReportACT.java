...
import com.linkage.module.itms.report.bio.HttpTestBatchReportBIO;
 ...
 *
 */
public class HttpTestBatchReportACT extends splitPageAction
{
	...
	private static Logger logger = LoggerFactory.getLogger(HttpTestBatchReportACT.class);

	private HttpTestBatchReportBIO bio;
	...
	public String getDetailExcel(){
		fileName = "高宽带详细测速报表";
		title = new String[] { "LOID", "厂家", "属地","型号", "硬件版本", "软件版本","签约速率","测速速率","上网方式","测速时间" };
		column = new String[] { "loid", "vendor_add", "city_name", "device_model", "hardwareversion","softwareversion",
				"speed","test_rate","wan_type","test_time" };
	...
	public HttpTestBatchReportBIO getBio()
	{
		return bio;
	}
	public void setBio(HttpTestBatchReportBIO bio)
	{
		this.bio = bio;
	}
