...
import com.linkage.module.itms.report.bio.MoreBroadbandBusinessBIO;

@SuppressWarnings("serial")
public class MoreBroadbandBusinessACT extends splitPageAction implements
		ServletRequestAware, SessionAware {

	private static Logger logger = LoggerFactory
			.getLogger(MoreBroadbandBusinessACT.class);
	...
	private MoreBroadbandBusinessBIO bio;
	...
	public String countMoreBroadbandBusiness() {
		...
		this.setTime();
		data = bio.countMoreBroadbandBusiness(startOpenDate1, endOpenDate1,
				city_id, userType, user);
		return "list";
	}
	...
	public String getDevListForWbdTerminal() {
		logger.debug("MoreBroadbandBusinessACT=>getDevListForWbdTerminal");
		this.setTime();
		devList = bio.getDeviceListForWBdTerminal(city_id, startOpenDate1,
				endOpenDate1, userType, user, curPage_splitPage, num_splitPage);
		maxPage_splitPage = bio.getDeviceListForWBdTerminalCount(city_id,
				startOpenDate1, endOpenDate1, userType, user,
	...
	public String getDevExcel() {
		...
		data = bio.getDevExcel(city_id, startOpenDate1, endOpenDate1, userType,
				user);
		title = new String[] { "属地", "LOID", "用户终端规格", "BSS受理时间", "客户类型" };
	...
	public MoreBroadbandBusinessBIO getBio() {
		return bio;
	}

	public void setBio(MoreBroadbandBusinessBIO bio) {
		this.bio = bio;
	}
