...
import com.linkage.module.itms.report.bio.SheetStatsReportBIO;
 ...
 * 工单统计报表
 */
public class SheetStatsReportACT extends splitPageAction implements SessionAware, ServletResponseAware
  {

	//	日志记录
	private static Logger logger = LoggerFactory.getLogger(SheetStatsReportACT.class);
	...
	// bio
	private SheetStatsReportBIO bio;
	...
	public SheetStatsReportBIO getBio() {
		return bio;
	}

	public void setBio(SheetStatsReportBIO bio) {
		this.bio = bio;
	}
