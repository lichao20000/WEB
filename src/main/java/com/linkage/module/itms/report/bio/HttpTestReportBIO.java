 ...
 *
 */
public class HttpTestReportBIO
{
	private Logger logger = LoggerFactory.getLogger(HttpTestReportBIO.class);
	private HttpTestReportDAO dao;
    ...
    public static void main(String args[]){
    	System.out.println(new HttpTestReportBIO().getPercentPar(0, 0));
    }
    
	public HttpTestReportDAO getDao()
	{
		return dao;
	}

	public void setDao(HttpTestReportDAO dao)
	{
		this.dao = dao;
	}
}
