...
import com.linkage.module.itms.resource.bio.BssSpecRealInfoBIO;
import com.opensymphony.xwork2.ActionSupport;

public class BssSpecRealInfoACT extends ActionSupport  implements
		ServletRequestAware, SessionAware {
	
	private static Logger logger = LoggerFactory.getLogger(BssSpecRealInfoACT.class);
	
	private BssSpecRealInfoBIO bio;
	...
	public String getBssSpecRealInfo(){
		this.setTime();
		bssSpecList = bio.getURealInfo(startOpenDate1, endOpenDate1, city_id, devicetype, spec_id);
		return "list";
	}
	...
	public BssSpecRealInfoBIO getBio() {
		return bio;
	}

	public void setBio(BssSpecRealInfoBIO bio) {
		this.bio = bio;
	}
	...
	public List<Map> getBssSpecList()
	{
		return bssSpecList;
	}

	
	public void setBssSpecList(List<Map> bssSpecList)
	{
		this.bssSpecList = bssSpecList;
	}
