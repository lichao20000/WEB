 ...
 * @since 2012-12-14
 */
public class DeviceVersionManageBIO {
	
	// 日志记录
	private static Logger logger = LoggerFactory.getLogger(DeviceVersionManageBIO.class);
	
	private DeviceVersionManageDAO dao;
			...
			String startTime, String endTime, int curPage_splitPage, int num_splitPage)
	{
		...
		List<Map> list = dao.queryDeviceVersion(vendorId, deviceModelId, hardVersion, softVersion, specVersion, startTime, endTime, curPage_splitPage, num_splitPage);
		maxPage_splitPage = dao.countDeviceVersion(vendorId, deviceModelId, hardVersion, softVersion, specVersion, startTime, endTime, curPage_splitPage, num_splitPage);
		return list;
	}
	...
	public DeviceVersionManageDAO getDao() {
		return dao;
	}

	public void setDao(DeviceVersionManageDAO dao) {
		this.dao = dao;
	}
