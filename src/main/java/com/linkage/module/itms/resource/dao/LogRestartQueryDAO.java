...
public class LogRestartQueryDAO extends SuperDAO
{
	 ...
	 * 查询
	 */
	public List<Map> getrestart(String cityId, String starttime, String endtime,
			int curPage_splitPage, int num_splitPage,long acc_oid)
	{
		logger.debug("Query({},{},{})", new Object[] { cityId, starttime, endtime });
	 ...
	 * 查询结果导出
	 */
	public List<Map> QueryDerive(String cityId, String starttime, String endtime,long acc_oid)
	{
		logger.debug("getrestart({},{},{})", new Object[] { cityId, starttime, endtime });
		StringBuffer sql = new StringBuffer();
		// sql.append("select b.add_time,b.task_name,b.task_id from tab_batch_account a,tab_batch_task b where a.task_id=b.task_id ");
		if(acc_oid==1)
		{
		sql.append("select a.add_time,a.task_name,b.status,count(1) num from tab_batch_task a,tab_batch_account b "
				+ "where a.task_id = b.task_id and b.status!=3");
		 if(!StringUtil.IsEmpty(starttime))
	 	    {
	 	    	sql.append(" and a.add_time>="+starttime);
	 	    }
		...
		sql.append("  group by a.add_time,a.task_name,b.status");
		}
		else
		{
			sql.append("select a.add_time,a.task_name,b.status,count(1) num from tab_batch_task a,tab_batch_account b "
