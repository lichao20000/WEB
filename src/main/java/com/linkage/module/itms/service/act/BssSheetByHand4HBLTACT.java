...
import com.linkage.module.itms.service.bio.BssSheetByHand4HBLTBIO;
import com.linkage.module.itms.service.obj.SheetObj;

public class BssSheetByHand4HBLTACT
  implements SessionAware, RequestAware
{
  public static Logger logger = LoggerFactory.getLogger(BssSheetByHand4HBLTACT.class);
  ...
  private String loid = "";
  private BssSheetByHand4HBLTBIO bio;
  ...
  public BssSheetByHand4HBLTBIO getBio()
  {
    return this.bio;
  }

  public void setBio(BssSheetByHand4HBLTBIO bio)
  {
    this.bio = bio;
  }
