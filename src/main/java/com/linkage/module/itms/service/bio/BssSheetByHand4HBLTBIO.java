...
import com.linkage.module.itms.service.dao.BssSheetByHand4HBLTDAO;
import com.linkage.module.itms.service.obj.SheetObj;

public class BssSheetByHand4HBLTBIO
{
  private static Logger logger = LoggerFactory.getLogger(BssSheetByHand4HBLTBIO.class);
  private BssSheetByHand4HBLTDAO dao;
  ...
  public BssSheetByHand4HBLTDAO getDao()
  {
    return this.dao;
  }

  public void setDao(BssSheetByHand4HBLTDAO dao)
  {
    this.dao = dao;
  }
  ...
  {
    logger.debug("BssSheetByHand4AHBIO.delBusiness(SheetObj obj)");
    ...
    if ((StringUtil.IsEmpty(obj.getHvoipServTypeId())) && (StringUtil.IsEmpty(obj.getNetServTypeId())) && (StringUtil.IsEmpty(obj.getIptvServTypeId()))) {
      ...
      this.dao.addHandSheetLog(obj, curUser, 20, 3, "000".equals(getMessage(resultMessage, "resultCode")) ? 1 : 0, getMessage(resultMessage, "resultDes"));
    }
    else
    {
      try {
        ...
        if (!StringUtil.IsEmpty(obj.getHvoipServTypeId()))
        {
          ...
          this.dao.addHandSheetLog(obj, curUser, Integer.valueOf(obj.getHvoipServTypeId()).intValue(), 3, 
        ...
        if (!StringUtil.IsEmpty(obj.getNetServTypeId()))
        {
          ...
          this.dao.addHandSheetLog(obj, curUser, Integer.valueOf(obj.getNetServTypeId()).intValue(), 3, 
        ...
        if (!StringUtil.IsEmpty(obj.getIptvServTypeId()))
        {
          ...
          this.dao.addHandSheetLog(obj, curUser, Integer.valueOf(obj.getIptvServTypeId()).intValue(), 3, 
  ...
  public String doBusiness(SheetObj obj, UserRes curUser)
  {
    ...
    this.dao.addHandSheetLog(obj, curUser, Integer.valueOf(obj.getUserServTypeId()).intValue(), Integer.valueOf(obj.getUserOperateId()).intValue(), "000".equals(getMessage(resultMessage, "resultCode")) ? 1 : 0, getMessage(resultMessage, "resultDes"));
    if ("000".equals(getMessage(resultMessage, "resultCode")))
	{
	    try
	    {
	      ...
	      if (!StringUtil.IsEmpty(obj.getHvoipServTypeId()))
	      {
	        ...
	        this.dao.addHandSheetLog(obj, curUser, Integer.valueOf(obj.getHvoipServTypeId()).intValue(), Integer.valueOf(obj.getHvoipOperateId()).intValue(), 
	          "000".equals(getMessage(voipResult, "resultCode")) ? 1 : 0, getMessage(voipResult, "resultDes"));
	      }
	      if (!StringUtil.IsEmpty(obj.getNetServTypeId()))
	      {
	        ...
	        this.dao.addHandSheetLog(obj, curUser, Integer.valueOf(obj.getNetServTypeId()).intValue(), Integer.valueOf(obj.getNetOperateId()).intValue(), 
	          "000".equals(getMessage(netResult, "resultCode")) ? 1 : 0, getMessage(netResult, "resultDes"));
	      }
	      if (!StringUtil.IsEmpty(obj.getIptvServTypeId()))
	      {
	        ...
	        this.dao.addHandSheetLog(obj, curUser, Integer.valueOf(obj.getIptvServTypeId()).intValue(), Integer.valueOf(obj.getNetOperateId()).intValue(), 
	          "000".equals(getMessage(itvResult, "resultCode")) ? 1 : 0, getMessage(itvResult, "resultDes"));
	      }
	    }
	    catch (Exception e)
  ...
  private String doH248VoipSheet(SheetObj order)
  {
    ...
    /*if ("243".equals(order.getHvoipOltFactory())) {
      param.addElement("vlanId").addText("8");
    }
    else {
