...
public class BssSheetByHand4HBLTDAO extends SuperDAO
{
 ...
 public List<HashMap<String, String>> getBssSheetInfo(String userId)
  ...
  public Map<String, String> getUserInfo(String loid, String userType)
  {
    ...
    psql.append("select a.*,u.type_id from " +
            "(select city_id, office_id, zone_id, access_style_id, linkman, linkphone, email, mobile, linkaddress, credno ");
  ...
  public List<HashMap<String, String>> getServInfo(String loid, String userType)
  {
    ...
    psql.append("select l.*,v.eid,n.speed from (select b.serv_type_id, b.oltfactory, b.username, b.passwd, " +
