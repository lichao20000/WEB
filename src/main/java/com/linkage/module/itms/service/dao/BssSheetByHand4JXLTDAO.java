...
public class BssSheetByHand4JXLTDAO extends SuperDAO{

	private static Logger logger = LoggerFactory.getLogger(BssSheetByHand4JXLTDAO.class);
	...
	public List<HashMap<String, String>> getServInfo(String loid, String userType)
	{
		...
		PrepareSQL psql = new PrepareSQL();
		psql.append("select b.serv_type_id, b.username, b.passwd, b.vlanid, b.wan_type, b.ipaddress, b.ipmask, b.gateway, b.adsl_ser, \n" +
				"b.ip_type, b.user_id, b.bind_port, b.serv_num from ");
		psql.append(tabUser);
		psql.append(",");
		psql.append(tabServ);
	...
	public List<HashMap<String, String>> getVoipParaInfo(String userId, String userType,String servType)
	{
		...
		psql.append("select a.protocol, a.voip_phone, a.reg_id, a.reg_id_type, a.voip_port, " +
