$(document).ready(function(){ 
    ...
    var searchType = $.trim($("input[@name='searchType']").val());
	 $.ajax({  
		 	type:'POST',     
            url: "itms/resource/devRepairTestInfo!getQualifiedRatePieData.action",
            data:{                    
            ...
            success:function(data){ 
            	...
            	var myCharts = echarts.init(document.getElementById('qualifiedRateCharts'));
            	var option = {
            	...
            	$("#qualfiedRatePie").html(data.qualify);
            },
