$(document).ready(function(){  
	 $.ajax({  
            ...
            success:function(data){ 
            	...
            	var myCharts1 = echarts.init(document.getElementById('managerGW1'));
            	var myCharts2 = echarts.init(document.getElementById('managerGW2'));
            	var myCharts3 = echarts.init(document.getElementById('managerGW3'));
            	...
            	$("#e8cMterminal").html(data[0].total + data[0].unit);
            	
            	$("#e8bMterminal").html(data[1].total + data[1].unit);
            	
            	$("#hwMterminal").html(data[2].total + data[2].unit);
            	
            	total = parseFloat(data[0].total) + parseFloat(data[1].total) + parseFloat(data[2].total);
            	$("#totalPieMTerminal").html(total.toFixed(2));
            },
