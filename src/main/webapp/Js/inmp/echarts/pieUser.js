$(document).ready(function(){  
	 $.ajax({  
            ...
            success:function(data){
            	...
            	var myCharts1 = echarts.init(document.getElementById('user1'));
            	var myCharts2 = echarts.init(document.getElementById('user2'));
            	var myCharts3 = echarts.init(document.getElementById('user3'));
            	...
            	$("#e8cuser").html(data[0].total + data[0].unit);
            	
            	$("#e8buser").html(data[1].total + data[1].unit);
            	
            	$("#hwuser").html(data[2].total + data[2].unit);
            	
            	total = parseFloat(data[0].total) + parseFloat(data[1].total) + parseFloat(data[2].total);
            	$("#totalUser").html(total.toFixed(2));
