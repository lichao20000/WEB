...
function refreshData(lms_now){
	...
	page = "worksheet_xml_iptv.jsp?start="+lms_start+"&end=" + lms_end + "&refresh="+Math.random();
...
function reloadfilter(){
	...
	var filter = $("input[name='filterstatus'][checked]").val();
	page = s1 + "&refresh=" + Math.random() + "&filter=" + filter + "&ifcontainChild=" + ifcontainChild + "&city_id=" + city_id + s2;
	//--------------------------------------------------------------------
...
function exportExcel() {
	...
	var url = page.replace(/worksheet_xml_iptv.jsp/g,"worksheet_xml_exportiptv.jsp");
			...
			<TR>
				...
				<TABLE border=0 cellpadding=0 cellspacing=0 width="98%">
					...
					<TR id="idFilterStatus">
						<TD height=10>
						<FORM name="frm2" style="margin:0px">显示选择：&nbsp;&nbsp; 
						<INPUT TYPE="radio" NAME="filterstatus" id="filterstatus" value="-1" checked>所有&nbsp; 
						<INPUT TYPE="radio" NAME="filterstatus" id="filterstatus" value="0">成功&nbsp; 
						<INPUT TYPE="radio" NAME="filterstatus" id="filterstatus" value="1">失败&nbsp; 
						<INPUT TYPE="button" NAME="btnFilter" value=" 过 滤 " onclick="reloadfilter()" class=jianbian></FORM>
						</TD>
					</TR>					
					<TR>
						<TD valign=top>
