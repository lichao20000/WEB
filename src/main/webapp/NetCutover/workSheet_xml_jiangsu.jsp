...
//查询数据库
String strSql = updateManage.getSqlAll(request);
Cursor cursor = (Cursor)updateManage.excSheetList(strSql);
...
<TABLE width="100%" height="30" border="0" cellpadding="0"
	...
	<TR>
		<TD width="162" align="center" class="title_bigwhite">任务列表</TD>
	</TR>
</TABLE>
