    ...
    <TD id="test1" style="display:" bgcolor=#999999>
		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" valign="middle">
		  ...
		  <tr>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="send_warn1" theme="simple" headerKey="-1" headerValue="请选择" value="-1"/>
			</td>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="renew_warn1" theme="simple" headerKey="-1" headerValue="请选择"  value="-1"/>
			</td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="send_warn2" theme="simple" headerKey="-1" headerValue="请选择"  value="-1"/>
			</td>
			<td class=column1 align=center>恢复告警级别</td>
			<td class=column2 align=left>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="renew_warn2" theme="simple" headerKey="-1" headerValue="请选择"  value="-1"/>
			</td>
		  </tr>
    ...
    <TD id="test2" style="display:none" bgcolor=#000000>
		<table width="100%"  border="0" cellspacing="1" cellpadding="2" valign="middle" align="center">
		  ...
		  <tr>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="sdynamic_send_warn" theme="simple" headerKey="-1" headerValue="请选择"  value="-1"/>
			</td>
			<td class=column1 align=center>恢复告警级别</td>
			<td class=column2 align=left>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="sdynamic_renew_warn" theme="simple" headerKey="-1" headerValue="请选择"  value="-1"/>
			</td>
		  </tr>
		  <tr>
    ...
    <TD id="test3" style="display:none" bgcolor=#000000>
		<table width="100%"  border="0" cellspacing="1" cellpadding="2" valign="middle" align="center">
		  ...
		  <tr>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="send_warn3" theme="simple" headerKey="-1" headerValue="请选择"  value="-1"/>
			</td>
		  </tr>
		  <tr>
