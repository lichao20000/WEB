  	...
  	<td>
  		<table width="100%" border="0" cellspacing="1" cellpadding="2" align=center bgcolor=#999999>
			<TR>
  			...
  			<tr>
				<TD bgcolor=#ffffff>自动刷新：<INPUT TYPE="radio" NAME="isRefresh" onclick="changIsRefresh(true)" checked>是
				<INPUT TYPE="radio" NAME="isRefresh" onclick="changIsRefresh(false)" >否&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
					刷新频率：<INPUT TYPE="radio" NAME="polltime" value="3" onclick="refreshIframe(this.value)">3分钟&nbsp;&nbsp; 
							   ...
							   <INPUT TYPE="radio" NAME="polltime" value="30" onclick="refreshIframe(this.value)">30分钟</TD>
  			</tr>
  			<tr>
				<td align=left bgcolor=#ffffff>采集点：<%=strGatherList%>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 主机IP：<span id='divHostIP'>－请选择采集点－</span></td>
  			</tr>
  			<tr>
...
function getReloadtime(){
	var o = document.getElementsByName('polltime');
...
function loadData(){
	document.all("childframe").src = "getStatusHTML.jsp?hostip="+document.getElementsByName("hostip").value+"&polltime="+reloadtime+"&gather_id="+document.frm.gather_id.value+"&refresh="+Math.random();
	showMsgDlg();
}
