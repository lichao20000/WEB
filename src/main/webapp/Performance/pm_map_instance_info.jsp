...
<%@ page import="com.linkage.litms.common.database.*, java.util.Map,com.linkage.module.gwms.dao.gw.EventLevelLefDAO"%>
<%
...
<form name="topfrm" target="hiddenFrm">
	<table width="100%"  border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="#000000"> 
		...
		<div>
		<tr>
			<td colspan="4" class=blue_foot align="center">&nbsp;</td>
		</tr>
    ...
    <TD id="test1" style="display:" bgcolor=#000000>
		<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" valign="middle">
		  ...
		  <tr>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="renew_warn1" theme="simple" headerKey="-1" headerValue="请选择"/>
			</td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<s:select list="#request.warnMap" listKey="key" listValue="value" name="send_warn2" theme="simple" headerKey="-1" headerValue="请选择"/>
			</td>
			<td class=column1 align=center>恢复告警级别</td>
			<td class=column2 align=left>
