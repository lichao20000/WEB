...
function ToExcel()
{
	var page="<s:url value='/gtms/stb/report/batchImpQryStbInfo!getExcel.action'/>"+"?importQueryField="+$("#importQueryField").val();
			...
			<s:if test="statsReportList.size()>0">
				<s:iterator value="statsReportList">
					<tr>
						...
						<td align="center"><s:property value="broadbandname" /></td>
		...
		<tfoot>
			<tr>
				<td colspan="10" align="right">
					<lk:pages url='/gtms/stb/report/batchImpQryStbInfo!query.action' styleClass=""
