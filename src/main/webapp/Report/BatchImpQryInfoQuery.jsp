...
function query(){
    ...
    document.selectForm.action = "<s:url value='/gtms/stb/report/batchImpQryStbInfo!imp.action'/>";
...
$(window).resize(function(){
	...
	<body>
		<form name="selectForm" action="<s:url value='/gtms/stb/report/batchImpQryStbInfo!imp.action'/>"
			target="dataForm">
						...
						<table class="querytable">
							...
							<tr id="gwShare_tr32" >
								...
								1、需要导入的文件格式限于Excel、文本文件，即xls、txt格式 。
								 <br>
								2、文件的第一行为标题行，即【宽带账号】、【LOID】或者【设备序列号】。
								 <br>
								3、文件只有一列。
								 <br>
