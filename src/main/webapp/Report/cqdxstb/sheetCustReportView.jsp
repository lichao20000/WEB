...
function query(){
    ...
    document.selectForm.action = "<s:url value='/gtms/stb/report/sheetCustReport!getStatsReport.action'/>";
...
$(window).resize(function(){
	...
	<body>
		<form name="selectForm" action="<s:url value='/gtms/stb/report/sheetCustReport!getStatsReport.action'/>"
			target="dataForm">
