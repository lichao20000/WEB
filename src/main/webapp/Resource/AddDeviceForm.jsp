...
$(function(){
	...
	<% 
		if(null == device_id){ 
	%>
		$("input[@name='device_serialnumber']").attr('readonly','');
		$("input[@name='port']").attr('readonly','');
	<%} %>
...
function CheckForm(){
	...
	if(GetDate(obj.buy_time.value) > GetDate(obj.complete_time.value) ){
		alert("入网时间必须早于维保时间");
		obj.buy_time.focus();
		obj.buy_time.select();
		return false;
...
<TABLE border=0 cellspacing=0 cellpadding=0 width="100%">
	...
	<TR>
		<TD>
		<FORM NAME="frm" METHOD="post" ACTION="DeviceSave.jsp"  target="childFrm">
			...
			<TR>
				...
				<TABLE width="100%" height="30" border="0" cellspacing="0" cellpadding="0" class="green_gargtd">
					<TR>
						...
						<TD>
							<IMG src="../images/attention_2.gif" width="15"	height="12"><%=innerHtml%>
						</TD>
					</TR>
				</TABLE>
				</TD>
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<TR>
						<TD colspan="4" align="center" class=green_foot>
							<INPUT TYPE="submit" value=" 保 存 " onclick = "save()" class=btn> &nbsp;&nbsp;
