...
{    
    ...
    //document.all("childFrm").src ="BBMSSheet_bbs_list.jsp?city_id="
    //	+city_id+"&start_day="+start_day+"&end_day="+end_day
...
<FORM name="frm" action="BBMSSheet_bss_list.jsp" onsubmit="checkForm()">
	...
	<TABLE width="95%" border=0 cellspacing=0 cellpadding=0 align="center">
		...
		<TR>
			...
			<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
				<TR><TH colspan="4">BSS原始工单信息统计</TH></TR>
				<tr bgcolor="#FFFFFF">
