...
//导出
String prt_Page="DeviceListByCompleteDealTime_prt.jsp?vendor_id="+ vendor_id+"&device_model_id="+device_model_id+"&gw_type="+gw_type+"&completeStartTime="+completeStartTime+"&completeEndTime="+completeEndTime;

List list  = null;
String strData = "";
list = DeviceStatByCompleteDealTimeAct.showDetail(request);
