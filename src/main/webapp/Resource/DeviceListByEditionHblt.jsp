...
<jsp:useBean id="DeviceActHblt" scope="request" class="com.linkage.litms.resource.DeviceActHblt"/>
...
function DetailDevice(device_id,gw_type){
	var strpage;
	if("4" == gw_type){
		strpage = "/stb/gtms/stb/resource/gwDeviceQueryStb!queryZeroDeviceDetail.action?gw_type=4&deviceId=" + device_id;
	}else{
