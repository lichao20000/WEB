...
<jsp:useBean id="DeviceActSpeedUser" scope="request" class="com.linkage.litms.resource.DeviceActSpeedUser"/>
...
List list  = null;
String strData = "";
list = DeviceActSpeedUser.getDeviceListByVender(request);

String strBar = String.valueOf(list.get(0)); 
Cursor cursor = (Cursor)list.get(1);
Map fields = cursor.getNext();
Map area_Map = DeviceActSpeedUser.getAreaIdMapName();
Map city_Map = CityDAO.getCityIdCityNameMap();
Map cityPidMap = CityDAO.getCityIdPidMap();
Map venderMap = DeviceActSpeedUser.getOUIDevMap(gw_type);
