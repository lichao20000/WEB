...
prt_Page = "DeviceListBySpeedNX_prt.jsp?city_id="+cityid+"&speed="+speed+"&isOut="+isOut+"&gw_type="+gw_type+"&gbbroadband="+gbbroadband;
...
// teledb
if (DBUtil.GetDB() == 3) {
	sql = "select device_model, softwareversion, devicetype_id " +
