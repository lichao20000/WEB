			...
			<tr>
				...
				<table width="100%" height="30" border="0" cellspacing="0"
					...
					<tr>
						...
						<td>
						<INPUT type="radio" name="reportType" value="0" <%=checked1%>>首次上报时间
	      				<INPUT type="radio" name="reportType" value="1" <%=checked2%>>最新更新时间
	      				</td>
	      				<td>
						起始时间：<input type="text" class="bk" name="start_day" readonly="readonly" value="<%=start_day %>" />
						...
						结束时间：<input type="text" class="bk" name="end_day" readonly="readonly" value="<%=end_day %>" />
						<img name="endimg" onclick="new WdatePicker(document.frm.end_day,'%Y-%M-%D',false,'whyGreen')" 
						src="../images/search.gif" width="15" height="12" border="0" alt="选择">
						<input type="submit" name="query" value=" 查 询 "></td>
					</tr>
				</table>
				</td>
			</tr>
