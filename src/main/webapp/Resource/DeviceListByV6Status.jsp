...
String prt_Page="DeviceListByV6Status_prt.jsp?city_id="+cityId+"&rela_dev_type_id="+ rela_dev_type_id+"&devicetype_id="+devicetypeId+"&gw_type="+gw_type+"&isBind="+isBind+"&vendor_id="+vendorId+"&startTime="+startTime+"&endTime="+endTime+"&is_normal="+is_normal+"&gw_type="+gw_type+"&deviceModelId="+deviceModelId+"&devicetype="+devicetype+"&citynext="+citynext+"&recentStartTime="+recentStartTime+"&recentEndTime="+recentEndTime+"&cityIdSelect="+cityIdSelect;

String __debug = request.getParameter("__debug");
List list  = null;
String strData = "";
list = DeviceActHblt.getDeviceListByV6Status(request);
