...
<head>
	...
	<script language="javascript">
      ...
      function save(){
      	...
      	$.ajax({
      		type:"Post",
      		url:"deviceModelInfo!executeSxlt.action",
      		data: $("#frm").serialize(),
      		dataType:'json',
      ...
      function checkForm(){
        ...
        if(frm.deviceModelName.value==""){
          alert("请输入型号名称");
          frm.deviceModel.focus();
          return false;
        }
        return true;
      }
...
<body onload="init()">
	...
	<br>
	<%--<form name = "queryFrm" action="deviceModelInfo!executeSxlt.action">--%>
	<form name="frm" action="deviceModelInfo!executeSxlt.action" method="post" id="frm" onsubmit="return checkForm();">
		...
		<TR>
			<TD bgcolor=#999999>
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<tr>
						<td align="right" CLASS=green_foot colspan="4"><%@ include file="/PageFoot.jsp"%></td>
					</tr>
				</TABLE>
			</TD>
		</TR>
