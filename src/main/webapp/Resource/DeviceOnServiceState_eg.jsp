...
function detail(city_id,service_id){
	...
	window.open("./DeviceListByService.jsp?city_id="+city_id+"&gw_type=2&service_id="+service_id,"","left=20,top=20,width=800,height=600,resizable=no,scrollbars=yes");
}
//-->
</SCRIPT>
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<TR>
						<TD class=column colspan="20" height="30">
							<a href="DeviceOnServiceState_prt_eg.jsp?isPrt=1" alt="导出当前页数据到Excel中">&nbsp;&nbsp;&nbsp;导出到Excel</a>
						</TD>
					</TR>
				</TABLE>
			</TD>
