...
<%
	...
	{
		Cursor cursor_hblt = ServiceActHblt.getCity(city_id);
...
function detailId(city_id,devicetype_id, gw_type){
	...
	var page="DeviceListByEditionHblt.jsp?city_id="+city_id+"&devicetype_id="+devicetype_id + "&gw_type=" + gw_type + "&startTime=<%=startTime%>&endTime=<%=endTime%>&use_state=<%=use_state%>";
