		...
		<TABLE width="95%" border=0 cellspacing=0 cellpadding=0 align="center">
			...
			<TR>
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					if(start_Time != null){
					%>
					<%=ServiceAct.getHtmlDeviceByModelDetail(request)%>
					<TR id="exportId">
						<TD class=column colspan="<%=count%>" height="30"><a
							href="DeviceStatByModelDetail_prt.jsp?isPrt=1&gw_type=<%=gw_type%>&countTime=<%=start_Time%>&endTime=<%=endTime%>&vendorId=<%=vendorId%>&modelId=<%=modelId%>&cityId=<%=cityId%>"
