...
function checkform(){
   ...
   // form.attr("action","DeviceStatByEditionList.jsp?devicetypeid='"+deviceTypeId+"'");
    form.action="DeviceStatByV6StatusList.jsp?devicetypeid='"+deviceTypeId+"'";
		...
		<TABLE width="100%" border=0 cellspacing=0 cellpadding=0 align="center">
			<TR>
				...
				<TABLE width="100%" height="30" border="0" cellspacing="0"
					...
					<TR>
						<TD width="164" align="center" class="title_bigwhite">家庭网关IPV6开通查询报表</TD>
					</TR>
				</TABLE>
				</TD>
			</TR>
			<TR>
				...
				<TABLE width="100%" class="querytable" align="center">
					...
					<TR id="gwShare_tr22" >
						...
						<TD align="right" style="display: none" class="title_2" width="15%">版    本</TD>
