		...
		<tr>
			<td bgcolor="#999999">
				<table border=0 cellspacing=1 cellpadding=1 width="100%">
					<tr>
						<th colspan="4" align="center">编辑定制终端模板
						</th>
					</tr>
					<s:iterator value="resultList" var="rl" status="status">
					<input type="hidden" name="templateId" value="<s:property value="#rl.template_id" />">
					<tr>
						<td class="column" height="17" align="right" width="13%" nowrap>模板名称</td>
						<td class="column" height="17" width="29%">
							<input type="text" class="bk" name="template_name" value="<s:property value="#rl.template_name" />">
						...
						<td class="column" height="17" width="29%">
							<select class="bk" name="vendor_id">
								...
								<option value="<s:property value="#vl.vendor_id" />" <s:if test="#vl.vendor_id == #rl.vendor_id">selected</s:if> >
									<s:property value="#vl.vendor_name" />/<s:property value="#vl.vendor_add" />
								</s:iterator>
					...
					<tr>
						...
						<td class="column" height="17" width="29%">
							<select class="bk" name="device_type">
								<option value="-1">==请选择==
								<option value="Navigator1-1" <s:if test="#rl.device_type == 'Navigator1-1'">selected</s:if> >Navigator1-1
								<option value="Navigator1-2" <s:if test="#rl.device_type == 'Navigator1-2'">selected</s:if> >Navigator1-2
								<option value="Navigator2-1" <s:if test="#rl.device_type == 'Navigator2-1'">selected</s:if> >Navigator2-1
								<option value="Navigator2-2" <s:if test="#rl.device_type == 'Navigator2-2'">selected</s:if> >Navigator2-2
							</select>
							<font color="#FF0000">*</font>
						</td>
						...
						<td class="column" height="17" width="29%">
							<select class="bk" name="access_style_id">
								<option value="-1" >==请选择==
								<option value="0" <s:if test="#rl.access_style_id == 0">selected</s:if> >ADSL接入
								<option value="1" <s:if test="#rl.access_style_id == 1">selected</s:if> >LAN接入
							</select>
							<font color="#FF0000">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="column" height="17" width="29%">
							<input type="text" class="bk" name="max_lan_num" value="<s:property value="#rl.max_lan_num" />"  onkeyup="onlyNum(this);">
							<font color="#FF0000">*</font>
						</td>
						<td class="column" height="17" align="right" width="13%" nowrap>最大支持SSID数</td>
						<td class="column" height="17" width="29%">
							<input type="text" class="bk" name="max_ssid_num" value="<s:property value="#rl.max_ssid_num" />"  onkeyup="onlyNum(this);">
							<font color="#FF0000">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="column" height="17" colspan="3" >
							<input type="text" class="bk" name="max_wan_num" id="max_wan_num" onblur="showInfo();" value="<s:property value="#rl.max_wan_num" />"  onkeyup="onlyNum(this);">
							<font color="#FF0000">*</font>
						</td>
					</tr>
					</s:iterator>
					<s:iterator value="wanPortList" var="wpl" status="status">
					<tr name="wanPort">
						<td class="column" height="17" align="right" width="13%" nowrap>WAN端口<s:property value="#wpl.wanport_idex" />支持最大地址数</td>
						<td class="column" height="17" width="29%">
							<input type="text" class="bk" name="addresspool" value="<s:property value="#wpl.addresspool" />"  onkeyup="onlyNum(this);">
							<font color="#FF0000">*</font>
						</td>
						<td class="column" height="17" align="right" width="13%" nowrap>WAN端口<s:property value="#wpl.wanport_idex" />连接方式</td>
						<td class="column" height="17" width="29%">
							<select class="bk" name="wan_type" >
								<option value="-1">==请选择==
								<option value="0" <s:if test="#wpl.wan_type == 0">selected</s:if>>桥接
								<option value="1" <s:if test="#wpl.wan_type == 1">selected</s:if>>路由
								<option value="2" <s:if test="#wpl.wan_type == 2">selected</s:if>>静态IP
								<option value="3" <s:if test="#wpl.wan_type == 3">selected</s:if>>DHCP
							</select>
							<font color="#FF0000">*</font>
						</td>
					</tr>
