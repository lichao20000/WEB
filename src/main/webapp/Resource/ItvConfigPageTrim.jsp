...
function ShowDialog(valu){
	...
	if(queryType==3){
		...
		document.frm.dsQueryBtn.disabled = false;
		document.frm.unQueryBtn.disabled = false;
	}else if(queryType==1){
...
function queryDevice(){
	...
	if(chekType == 3){
		...
		if(devSerialnumber.trim() == "" || devSerialnumber.length < 5){
			alert("请输入至少5位序列号");
			devSerial.focus();
			return false;
		}
		...
		document.frm.dsQueryBtn.disabled = true;
	}else {
		...
		//按钮按下的时候把按钮置灰 add by zhangcong 2011-06-07
		document.frm.unQueryBtn.disabled = true;
	}
}
...
<input type="hidden" id="gw_type" name="gw_type" value='<s:property value="gw_type" escapeHtml="false"/>' />
				...
				<table width="100%" height="30" border="0" cellspacing="0"
					...
					<tr>
						...
						<td nowrap><img src="../images/attention_2.gif" width="15"
							...
							<input type="radio" value="1" onclick="ShowDialog(this.value)" name="checkType" checked>按用户&nbsp;&nbsp;
						...
						<TR>
							<TD bgcolor=#999999>
								<table border=0 cellspacing=1 cellpadding=2 width="100%">
									...
									<tr id="userQuery" bgcolor="#FFFFFF">
										<td align="right" width="15%">宽带账号：</td>
										<td align="left" width="30%"><input type="text" name="username"></td>
										<td align="left" colspan="2">&nbsp;<input type="button" name="unQueryBtn" class=jianbian value=" 查 询 " onclick="queryDevice();"></td>
									</tr>
									<tr id="deviceQuery" bgcolor="#FFFFFF" style="display:none">
										...
										<td align="left" colspan="2">&nbsp;<input type="button" name="dsQueryBtn" class=jianbian value=" 查 询 " onclick="queryDevice();"></td>
									</tr>
									<tr id="importUserQuery" bgcolor="#FFFFFF"  style="display:none">
									...
									<tr id="importUserQuery2" style="display:none" bgcolor="#FFFFFF">
										<td align="right">注意事项：
										<td colspan="3">
										<font color="#7f9db9">
										1、需要导入的文件格式为Excel。
									...
									<tr bgcolor="#FFFFFF" id="softUp">
										...
										<td align="left" width="30%">立即执行</td>
									...
									<tr bgcolor="#FFFFFF">
										...
										<td align="left" width="30%">设备下次连到系统</td>

										<td align="right">PVC/VLANID：</td>
										<td align="left">ADSL上行:8/85||LAN上行:43||EPON上行:43</td>
										<!--
										<td align="right">VPI/VCI：</td>
										<td align="left"><input type="text" name="vpi" size="2" value="8" class="bk">&nbsp;/&nbsp;<input type="text" name="vci" size="3" value="85" class="bk"></td>
										-->
									</tr>
									...
									<TR bgcolor="#FFFFFF">
										<TD colspan="4" align="right" CLASS="green_foot">
											...
											<input type="hidden" name="softStrategy_type" value="4">
											<input type="hidden" name="lanstrategy_type" value="4">
