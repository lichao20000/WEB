...
function detail(city_id,speed){
	window.open("./DeviceListBySpeedJX.jsp?city_id="+city_id+"&gbbroadband=<%=gbbroadband%>"+"&gw_type=1&speed="+speed,"","left=20,top=20,width=800,height=600,resizable=no,scrollbars=yes");
}
