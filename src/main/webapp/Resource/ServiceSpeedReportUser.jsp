...
function doSubmit(){
	...
	document.frm.action="ServiceSpeedReportUserList.jsp?devicetypeid='"+deviceTypeId+"'";
	document.frm.submit();
}
		...
		<TABLE width="95%" border=0 cellspacing=0 cellpadding=0 align="center">
			...
			<TR>
				...
				<TABLE width="100%" class="querytable" align="center">
					<TR id="gwShare_tr22" >
						<td align="right" class="title_2" width="15%">厂商</td> <td width="35%"><select id="vendorId" name="vendorId"
							class="bk" onchange="change_select('deviceModel')"><%=strVendorId%></select></td>
						<td align="right" class="title_2" width="15%">型号</td> <td width="35%"><select id="modelId" name="modelId" class="bk"
							onchange="change_select('deviceType')"><%=strModelId%></select>
							</td>
					</TR>
					<TR id="gwShare_tr22" >
						<td align="right" class="title_2" width="15%">版本</td> <td width="35%"><select name="deviceTypeId" class="bk"><%=strDeviceTypeId%></select></td>
