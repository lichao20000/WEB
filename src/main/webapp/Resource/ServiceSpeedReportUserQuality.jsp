...
<jsp:useBean id="ServiceSpeedUserActQuality" scope="request"
	class="com.linkage.litms.resource.ServiceSpeedUserActQuality" />
<jsp:useBean id="qualityAct" scope="request" class="com.linkage.litms.resource.QualityServiceAction" />
<%@ page contentType="text/html;charset=GBK"%>

<%
	List cityList = new ArrayList();
	Cursor cursor = ServiceSpeedUserActQuality.getCityList(request);
...
function doSubmit(){
	...
	document.frm.action="ServiceSpeedReportUserListQuality.jsp?devicetypeid='"+deviceTypeId+"'";
	document.frm.submit();
}

function change_select(str){
	var gw_type= document.frm.gw_type.value;
	if("deviceModel"==str){
		...
		<TABLE width="95%" border=0 cellspacing=0 cellpadding=0 align="center">
			<TR>
				...
				<TABLE width="100%" height="30" border="0" cellspacing="0"
					...
					<TR>
						<TD width="164" align="center" class="title_bigwhite">光猫百兆口统计</TD>
					</TR>
				</TABLE>
				</TD>
			</TR>
			<TR>
				...
				<TABLE width="100%" class="querytable" align="center">
					<TR id="gwShare_tr22" >
						<td align="right" class="title_2" width="15%">厂商</td> 
						<td width="35%"><select id="vendorId" name="vendorId"
							class="bk" onchange="change_select('deviceModel')"><%=strVendorId%></select></td>
						<td align="right" class="title_2" width="15%">型号</td> 
						<td width="35%"><select id="modelId" name="modelId" class="bk"
								onchange="change_select('deviceType')"><option value='-1'>==请先选择厂商==</option></select>
							</td>
					</TR>
					<TR id="gwShare_tr22" >
						<td align="right" class="title_2" width="15%">版本</td> <td width="35%">
						<select name="deviceTypeId" class="bk"><option value='-1'>==请先选择型号==</option></select>
						</td>
						<TD align="right" class="title_2" width="15%">是否支持百兆宽带</TD>
					...
					<TR id="gwShare_tr22" >
						<td align="right" class="title_2" width="15%">开始时间</td> <td width="35%"><input type="text"
                            ...
                            <td align="right" class="title_2" width="15%">结束时间 </td> <td width="35%"><input
					...
					<tr align="right">
						<td align="left" class="title_2" colspan="4"><input type="button" name="btn0" id="queryButGrey"
...
<%
ServiceSpeedUserActQuality = null;
%>
<%
qualityAct = null;
%>