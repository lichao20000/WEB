...
String __debug = request.getParameter("__debug");
	...
	List list  = null;
	list = commonAct.getUnBindedDeviceInfoList(request);
...
if (fields == null) {
	...
	strData += "<TR><TD class=column COLSPAN=10 nowrap>&nbsp;"
	 	...
	 	+ "<a href='DeviceList_prt.jsp?"
		+ "cpe_allocatedstatus=0&gw_type=2'>导出未绑定设备列表</a></TD></TR>";
}
...
<TR><TD>
	<FORM NAME="frm" METHOD="post" ACTION="UnBindedDeviceList.jsp" onsubmit="return CheckForm()">
			...
			<table width="100%" height="30" border="0" cellspacing="0" cellpadding="0" class="green_gargtd">
				<tr>
					...
					<td>
						...
						设备序列号：<input type="text" name="device_serialnumber" value="<%=device_serialnumber%>" class=bk>
						设备IP：<input type="text" name="loopback_ip" class=bk value="<%=loopback_ip%>">
