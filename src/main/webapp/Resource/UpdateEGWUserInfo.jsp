...
<%
	...
	String strSQL = "select * from tab_egwcustomer where user_id="
	...
	if (fields != null) {
		...
		.toLowerCase());
		EGWid = (String) fields.get("e_id".toLowerCase());
		EGWUsername = (String) fields.get("e_username".toLowerCase());
		EGWPasswd = (String) fields.get("e_passwd".toLowerCase());
...
<TABLE border=0 cellspacing=0 cellpadding=0 width="100%" id="myTable">
	...
	<TR>
		<TD>
			<FORM NAME="frm" METHOD="post" ACTION="EGWUserInfoSave.jsp"
					...
					<TR>
						<TD bgcolor=#999999>
							...
							<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
								...
								<TR bgcolor="#FFFFFF" id="wanType" isShow="gd_dx" style="display:none">
									<TD class=column align="left">
										上网类型
									</TD>
									<TD colspan="3">
								...
								<TR bgcolor="#FFFFFF" leaf="suggestedContent" style="display:none">
									<TD class=column align="left">企业ID</TD>
									<TD><INPUT TYPE="text" NAME="EGWid" maxlength=15 class=bk value="<%=EGWid %>"></TD>
									<TD class=column align="left">企业用户名</TD>
									<TD><INPUT TYPE="text" NAME="EGWUsername" maxlength=15 class=bk value="<%=EGWUsername %>"></TD>
								</TR>
								<TR bgcolor="#FFFFFF" leaf="suggestedContent" style="display:none">
									<TD class=column align="left">企业用户密码</TD>
									<TD colspan=3><INPUT TYPE="password" NAME="EGWPasswd" maxlength=15 class=bk value="<%=EGWPasswd %>"></TD>
								</TR>
								<TR bgcolor="#FFFFFF" leaf="suggestedContent" style="display:none">
								    <TD class=column align="left">
										采集点
...
function show() {
	...
	if (tr != null) {
		if (tr.isShow == shortName) {
			tr.style.display = "";
			document.forms[0].wan_type.value = '<%=wan_type%>';
		}
	}
...
function selDev()
{
	var retValue = window.showModalDialog("./selDeviceList.jsp?oui="+document.frm.oui.value+"&vender="+document.frm.vender.value +"&gw_type=2",window,"status:yes;resizable:yes;edge:raised;scroll:no;help:no;center:yes;dialogHeight:600px;dialogWidth:800px");
