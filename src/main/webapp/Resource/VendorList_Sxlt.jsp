...
function save(){
	...
	$.ajax({
		type:"Post",
		url:"deviceModelInfo!VendorInfoForSxlt.action",
		data: $("#frm").serialize(),
		dataType:'json',
...
function checkForm(){
    temp =document.frm.vendor_name.value;
    if(temp=="")
    {
      alert("请填写设备厂商名称！");
      return false;
    }
    temp =document.frm.vendor_add.value;
    if(temp=="")
    {
      alert("请填写设备厂商别名！");
      return false;
...
<tr>
	<td>
		<form name = "queryFrm" action="deviceModelInfo!VendorInfoForSxlt.action">
...
<TR><TD>
    <FORM NAME="frm" id="frm" METHOD="post" ACTION="deviceModelInfo!VendorInfoForSxlt.action" onsubmit="return checkForm()">
