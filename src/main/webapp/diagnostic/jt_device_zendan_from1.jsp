...
$(function(){
	...
	gw_type = '<%=request.getParameter("gw_type")%>';
  	...
  	function ExecMod(){ 
  		if(CheckForm()){
  			var t_obj = document.getElementById('device_id');
			...
			if(devicetype =="snmp"){
       		...
       		page = "jt_device_zendan_from1_save.jsp?device_id=" + __device_id + "&gw_type="+gw_type+"&devicetype=" + devicetype + param;
	...
	function setPingResult(html){

		document.getElementById("div_ping").innerHTML = html;
	}
								...
								<tr>
									<td width="162">
										...
										<ms:inArea areaCode="sx_lt" notInMode="false">
											<div style="position: relative; left: 50px" class="title_bigwhite">Ping测试</div>
										</ms:inArea>
										<ms:inArea areaCode="sx_lt" notInMode="true">
											<div align="center" class="title_bigwhite">Ping测试</div>
										</ms:inArea>
									</td>
								</tr>
							</table>
							...
							<table width="100%" border=0 align="center" cellpadding="1"
								...
								<tr bgcolor="#FFFFFF" id="line1" style="display:">
									...
									<td class=column nowrap width="35%">
										...
										<input type="button" onclick="getInterfaceAct()" value="获取"/>
									</td>
									<td nowrap class=column width="15%">
										<div align="right">
											包大小:
										...
										<table width="100%" border="0" cellspacing="0"
											...
											<tr align="right" CLASS="green_foot">
												<td>
													...
													<input type="button" onclick="ExecMod()" value="诊 断"/>
													&nbsp;&nbsp;
