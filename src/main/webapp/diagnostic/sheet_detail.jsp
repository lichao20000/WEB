...
if(fields!= null){
	...
	exec_count = (String)fields.get("exec_count");
...
if(office_id != null && !office_id.equals("")){
    String sqlOfficeName = "select * from tab_office where office_id='"+ office_id +"'";
    // teledb
    if (DBUtil.GetDB() == 3) {
        sqlOfficeName = "select office_name from tab_office where office_id='"+ office_id +"'";
    }
    com.linkage.commons.db.PrepareSQL psql = new com.linkage.commons.db.PrepareSQL(sqlOfficeName);
    psql.getSQL();
	field2 = DataSetBean.getRecord(sqlOfficeName);
	office_name = (field2 != null)?(String.valueOf(field2.get("office_name"))):"";
}
if(zone_id !=null && !zone_id.equals("")){

    String sqlZoneName = "select * from tab_zone where zone_id='"+ zone_id +"'";
    // teledb
    if (DBUtil.GetDB() == 3) {
        sqlZoneName = "select zone_name from tab_zone where zone_id='"+ zone_id +"'";
    }
    com.linkage.commons.db.PrepareSQL psql2 = new com.linkage.commons.db.PrepareSQL(sqlZoneName);
    psql2.getSQL();
	field2 = DataSetBean.getRecord(sqlZoneName);
		...
		<TR>
			...
			<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
			  ...
			  <TR> 
                ...
                <td class=column colspan="3"><%=exec_count%></td>
              </TR>
              <TR> 
