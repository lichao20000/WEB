...
<form name="detailsForm" action="droitRoleSave.jsp" target="actionframe" method="post">
	...
	<table width="100%"  cellpadding="3" cellspacing="2" border="0">
		<tr>
			<td  class="jive-setup-category-header">角色名称：
                    <input type=text name=role_name class="jive-description" size="40">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<tr>
			<td  class="jive-setup-category-header">角色描述：
                    <input type=text name=role_desc class="jive-description" size="40">
			</td>
		</tr>		
		<tr >
			<!--- tree area --->
	...
	<button type="button" onclick="RoleLeafLink()" style="width:200px;" class=btn><角色-权限>关联</button>
