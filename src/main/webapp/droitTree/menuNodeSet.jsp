...
<script>
		...
		function loadTree(){
			...
			tree.loadXML("treefromdb.jsp?tt="+new Date());
			status();
		}
		...
		function leafLink(){
			...
			var returnObj = window.showModalDialog("chooseItem.jsp?tree_id="+ tree_id +"&t="+new Date().getTime(),window,"status:yes;resizable:yes;edge:raised;help:no;center:yes;dialogHeight:650px;dialogWidth:400px");
		}	
</script>
...
<%@ include file="./left_bar.jsp"%>
    ...
    <td width="98%">
      <p class="jive-setup-page-header">创建系统目录与功能节点关联关系</p>
		
        
      <p>欢迎来到Liposs系统目录节点编辑界面. 这个工具是用来编辑系统目录结构都存在具体哪些功能点而设计. 在继续之前,请注意系统有可能是用户在网运行系统，任何编辑变更目录结构的行为都会导致其它用户使用系统功能的变化.</p>
