...
MzTreeView.prototype.nodeClick = function(id)
{
  ...
  if(!(!this.getAttribute(source, "url") && this.url=="#")){
		//alert(source);
		var temp_url = source.substring(source.lastIndexOf("url:")+4);
		//进行地址转向
		//alert(temp_url);
		parent.parent.window.frames[2].document.all('viewPage').src = temp_url;
  }
