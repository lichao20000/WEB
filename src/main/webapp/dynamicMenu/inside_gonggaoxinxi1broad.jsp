...
<%
	...
	while(fields != null){
		strData += "<TR>";
		String titletype = "";
		if("1".equals(fields.get("titletype"))){
			titletype = "公告";
		}else if("2".equals(fields.get("titletype"))){
			titletype = "新增功能";
		}else if("3".equals(fields.get("titletype"))){
			titletype = "提示";
		}
		strData += "<TD CLASS=column1 align=center>"+ titletype + "</TD>";
		...
		<TR>
			<TD bgcolor=#000000>
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					<TR>
				     <td colspan=6 class="green_title" align="center">公告信息显示</td>
					</TR>
					<TR>
						<td class="green_title">公告类型</td>
						<td class="green_title">公告标题</td>
						<td class="green_title">属　地</td>
						<td class="green_title">公告内容</td>
						<td class="green_title">操作[默认增加]</td>
					</TR>
					<%out.println(strData);%>
				</TABLE>
			</TD>
	...
	<TABLE width="95%" border=0 align="center" cellpadding=0 cellspacing=0 bgcolor="#999999" class="text">
		<TR>
			<TD bgcolor=#000000>
              <TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
                <TR bgcolor="#FFFFFF">
				<td colspan=2 class="green_title">
