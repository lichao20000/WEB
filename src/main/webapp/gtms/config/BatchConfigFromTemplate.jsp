...
<script type="text/javascript">
	...
	function loadSelect(){
		$.ajax({
    	    type:"POST",
    	    url:"<s:url value='/itms/resource/servTemplate!queryTemplateStr.action' />",
    	    data: {"name":$("#name").val()},
	...
	function batchSet(){
	    ...
	    if(check_val == '')
	    {
	    	...
	    	var url = "<s:url value='/gtms/config/paramNodeBatchConfigAction!addTemplateTask.action' />?task_name="+$("#task_name").val()+"&template_id="+templateId+"&dotype="+check_val+"&starttime="+startdate+" "+starttime+"&endtime="+enddate+" "+endtime+"&donow="+donow;
	    	if("1"==queryTypeNew){
