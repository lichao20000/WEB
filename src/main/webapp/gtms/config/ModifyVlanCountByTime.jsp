...
function doQuery(){
    ...
    var url = '<s:url value='/gtms/config/modifyVlanTools!queryModifyVlanInfoByTime.action'/>'; 
	$.post(url,{
		cityId:cityId,
		starttime:starttime,
		endtime:endtime,
...
function ToExcel(cityId) {
    ...
    var endtime = $.trim($("input[@name='endtime']").val());
	var cityId = $.trim($("select[@name='cityId']").val());
	var page="<s:url value='/gtms/config/modifyVlanTools!getInfoExcelByTime.action'/>?"
...
function openDev(cityId,status){
	...
	var starttime = $.trim($("input[@name='starttime']").val());
	var endtime = $.trim($("input[@name='endtime']").val());
	var page="<s:url value='/gtms/config/modifyVlanTools!getDevByTime.action'/>?"
		+ "cityId=" + cityId 
		+"&status=" + status
		+ "&type=" +type1
