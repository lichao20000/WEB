...
<script type="text/javascript">
	...
	function deviceResult(returnVal){
		...
		if(returnVal[0]==0){
			...
			if (area == "gs_dx" && 50000<totalNum) {
				alert("单次配置设备数应小于50000台！");
	       		$("#exeButton").attr("disabled",true);
	            return;
			}else if(5000<totalNum && "nx_dx"!=returnVal[3] && area != "gs_dx"){
		...
		if (area == "gs_dx" && 50000<returnVal[0]) {
			alert("单次配置设备数应小于50000台！");
       		$("#exeButton").attr("disabled",true);
            return;
		}else if(5000<returnVal[0] && "nx_dx"!=returnVal[3] && area != "gs_dx"){
			alert("单次配置设备数应小于5000台！");
       		$("#exeButton").attr("disabled",true);
            return;
		}
