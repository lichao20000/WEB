...
<script type="text/javascript">
	...
	function ToExcel() {
		...
		var page="<s:url value='/gtms/config/restartDeviceBatch!queryTaskGyCityExcel.action'/>"+"?task_id="+task_id+"&&task_name="+task_name;
	...
	function deviceDetail(type,countNum,city_id){
		var task_id='<s:property value="task_id" />';
		var url = "<s:url value='/gtms/config/restartDeviceBatch!queryDevList4CQ.action?countNum='/>"+countNum+"&&type="+type+"&&city_id="+city_id+"&&task_id="+task_id;
		...
		<tfoot>
			<tr>
				<td colspan="6" align="right">
					<lk:pages url="/gtms/config/restartDeviceBatch!queryTaskGyCity.action" styleClass=""
