...
function query(){
	...
	form.action = "<s:url value='/gtms/config/restartDeviceBatch!queryList.action'/>";
	form.submit();
}
...
<TABLE border=0 cellspacing=0 cellpadding=0 width="100%">
	...
	<TR>
		...
		<table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="green_gargtd">
			<tr>
				<td width="162"> <div align="center" class="title_bigwhite">批量重启任务管理</div> </td>
		...
		<TABLE border=0 cellspacing=0 cellpadding=0 width="98%" align="center">
			<tr>
				...
				<table border=0 cellspacing=1 cellpadding=2 width="100%"
					align="center">
					<tr>
						<th colspan="4" id="gwShare_thTitle">批量重启任务管理</th>
					</tr>
					<tr bgcolor="#FFFFFF">
