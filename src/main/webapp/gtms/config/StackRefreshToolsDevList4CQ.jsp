	...
	function ToExcel() {
		...
		if(countNum>100000){
			...
			if(choice==true){
				...
				var page="<s:url value='/gtms/config/stackRefreshTools!queryDevListExcel4CQ.action'/>"+"?task_id="+task_id+"&&city_id="+city_id+"&&type="+type;
		...
		<tfoot>
			<tr>
				<td colspan="10" align="right">
					<lk:pages url="/gtms/config/stackRefreshTools!queryDevList4CQ.action" styleClass=""
