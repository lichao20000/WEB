									...
									<div id="">
										<table border=0 cellspacing=1 cellpadding=2 width="100%">
											<TR bgcolor="#FFFFFF">
												...
												<td  width="70%">
													<input type="radio" name="wlanEnable"  class=btn value="1" >开启&nbsp;
													<input type="radio" name="wlanEnable"  class=btn value="0" checked>关闭  
												</td>
												</td>
											</TR>
...
<script type="text/javascript">
	...
	function doExecute(){
	    ...
	    var gwType = <%=gwType%>;
	    var wlanEnable =$("input[@name='wlanEnable']:checked").val();
		 $.post(
	        url,{
	        deviceId : deviceId,
