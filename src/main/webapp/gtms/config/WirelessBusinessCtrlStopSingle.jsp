	...
	<TR>
		<TD>
			...
			<table width="98%" border="0" align="center" cellpadding="0"
				...
				<TR bgcolor="#FFFFFF">
					<td colspan="4">
						<%@ include file="/gwms/share/gwShareDeviceQuery_wirelessStopSingle.jsp"%>
					</td>
				</TR>
				<TR>
										...
										<TABLE border=0 cellspacing=1 cellpadding=2 width="100%" id="table_showConfig">
											...
											<TR>
												<TD colspan="4" align="right" CLASS="green_foot">
													<INPUT TYPE="button" id="doButton" name="doButton" onclick="doExecute(0,1)" value=" 关 闭 业 务 " disabled class=btn>
												</TD>
											</TR>
											<TR bgcolor="#FFFFFF">
