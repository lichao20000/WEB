...
function doExecute(do_type){
	...
	var url;
	if(user_type == 1){
		url = "<s:url value='/gtms/config/wirelessBusnissCtrl!doConfig.action'/>";
		ssid = $.trim($("#ssid").val());
		...
		url = "<s:url value='/gtms/config/wirelessBusnissCtrl!doConfigAll4Special.action'/>";
		ssid = ssidArr;
				...
				<tr >
					<td>
						<FORM NAME="frm" METHOD="post"
							...
							<input type="hidden" id="location_name" value="WirelessOpenBySpecialBuss" />
