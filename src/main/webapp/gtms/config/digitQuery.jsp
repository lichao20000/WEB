...
//	var type = $.trim($("input[@name='type']").val());
	...
	document.frm.action = "<s:url value='/gtms/config/digitMapConfig!getCountAll.action'/>";
	document.frm.submit();
		...
		<td>
			<table class="green_gargtd">
				<tr>
						...
						<th style="Font-size:12px">虚拟网语音数图配置策略查询</th>
					...
					<tr bgcolor=#ffffff>
						<td class=column align=center width="25%">
							<select name="con" class=column>
								...
								<option value="0">用户LOID</option>
								<option value="-1">宽带账号</option>
								<option value="2">语音账号</option>
							</select>
						</td>
