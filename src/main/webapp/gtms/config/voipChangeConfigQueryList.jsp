...
<input type="hidden" name="gwShare_param_one" 
	value="<s:property value="loid"/>|<s:property value="city_id"/>|<s:property value="device_id"/>
		  |<s:property value="user_id"/>|linkage" />
		  
<input type="hidden" name="faultListStr" id="faultListStr" value="<s:property value="faultList"/>" />
<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center" bgcolor=#999999>
	...
	<tr>
		<!--<th align="center">
			 <input type="checkbox" name="gwShare_select" checked="true" onclick="javascript:gwShare_rsselect();" /> 
		</th>-->
			<input type="hidden" name="gwShare_select" checked="true"  οnclick="return false" />
			<input type="hidden" name="taskid" id="taskid" value="<s:property value="taskid"/>"/>
		<th align="center">LOID</th>
		<th align="center">用户属地</th>
	</tr>
	<s:iterator value="deviceList">
		<tr bgcolor="#FFFFFF">
				<%-- <td class=column1> 
			 <input type="checkbox" name="radioDeviceId" checked="true"  οnclick="return false"
					value="<s:property value="loid"/>|<s:property value="device_id"/>|<s:property value="user_id"/>" /></td> 
			</td>--%>
				<input type="hidden" name="radioDeviceId" checked="true"  οnclick="return false"
					value="<s:property value="loid"/>|<s:property value="device_id"/>|<s:property value="user_id"/>" />
