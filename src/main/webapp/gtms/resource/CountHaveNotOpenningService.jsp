...
function countBycityId(cityId){
    ...
    var url = "<s:url value='/gtms/resource/countByServTypeId!countHaveNotOpenningService.action'/>"; 
	$.post(url,{
		cityId:cityId,
		gw_type:gw_type
	},function(ajax){	
...
function ToExcel(cityId) {
	var page="<s:url value='/gtms/resource/countByServTypeId!outputHaveNotOpenServiceToExcel.action'/>?"
		+ "&cityId=" + cityId
		+ "&gw_type=" + gw_type;
		...
		<TR>
			<TD class="colum">
				<table class="listtable">
					...
					<tbody>
						<s:if test="haveNotResultList.size()>0">
							<s:iterator value="haveNotResultList">
								<tr>
									<td >
