...
<script type="text/javascript">
	...
	function ToExcel() {
		...
		mainForm.action = "<s:url value='/gtms/resource/importQuery!getExcel.action'/>";
		mainForm.submit();
		mainForm.action = "<s:url value='/gtms/resource/importQuery!readUploadFile.action'/>";
	}
</script>
</head>
...
<body>
	<form id="form" name="selectForm"
		action="<s:url value='/gtms/resource/importQuery!readUploadFile.action'/>"
