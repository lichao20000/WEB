...
//系统类型
	...
	<br>
		<s:form action="batchCustomNodeConfig!importConfig.action" method="post"  onsubmit="">
...
function dyniframesize()
{
 ...
 // window.onload = getDeviceModel;
  function Init(){
		...
		form.action = "../resource/stbDeviceTypeInfo!editionList.action";
		form.submit();
	}
   ...
   function getDeviceModel(){
		var vendorId = $("select[@name='vendorId']").val();
		var url = "../resource/openDeviceShowPic!getDeviceModel.action";
   ...
   function searchEdition(){
	   ...
	   var bootadv = "";
		...
		var form = document.getElementById("mainForm");
		form.action = "../resource/stbDeviceTypeInfo!editionList.action?gw_type=4&vendor=" + vendor + "&device_model=" + device_model + "&hard_version="+hard_version+ "&soft_version="+soft_version+ "&bootadv="+bootadv;
		form.submit();
  ...
  function getSoftVersion(){
		...
		var url = "../resource/openDeviceShowPic!getSoftVersion.action";
		if(deviceModelIds!=""){
