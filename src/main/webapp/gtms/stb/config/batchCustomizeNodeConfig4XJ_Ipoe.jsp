	 ...
	 //   }
		...
		<%
	 	if("1".equals(type)){
	 		...
	 		paramNodePath = ",Device.LAN.AddressingType,Device.X_CTC_IPTV.ServiceInfo.DHCPID,Device.X_CTC_IPTV.ServiceInfo.DHCPPassword" ;
 			paramValue    = ",-,-,-";
 			paramType     = ",1,1,1";
	 		<%
	 	}
		...
		<TABLE width="98%" align="center" class="querytable">
			<TR>
				<TD>
					...
					您当前的位置：<% if("1".equals(type)){%>IPOE<%} %>批量定制节点配置
				</TD>
			</TR>
		</TABLE>
		<br>
			...
			<table class="querytable" width="98%" align="center">
				<tr>
					<td colspan="4" class="title_1">
						<% if("1".equals(type)){%>IPOE<%} %>批量定制节点配置
					</td>
				</tr>
				<TR>
				...
				<TR <% if("1".equals(type)){%>style="display: none;"<%} %>>
				...
				<TR>
				 ...
				 -->
				<TR>
					<TD class="title_2" align="center" width="15%" <% if("1".equals(type)){%>style="display: none;"<%} %>>
						添加配置版本
					</TD>
					<TD width="85%" colspan="3" <% if("1".equals(type)){%>style="display: none;"<%} %>>
				...
				<TR id="nodeAddIP" <% if("1".equals(type)){%>style="display: none;"<%} %>>
					<TD class="title_2" align="center" width="15%">
						启用MAC地址段
					</TD>
					<TD width="85%" colspan="3">
				...
				<TR id="addCustomer" <% if("1".equals(type)){%>style="display: none;"<%} %>>
					<TD class="title_2" align="center" width="15%">
						业务帐号列表
					</TD>
					<TD width="85%" colspan="3">
						...
						<% if("1".equals(type)){%>checked="checked"<%} %> >是</input>&nbsp;&nbsp;&nbsp;
				...
				<tr id="importCustomer" <% if("1".equals(type)){%>style="display: block;"<%}else{%>style="display: none;"<%} %>>
					<td class="title_2" align="center" width="15%">
						请选择文件
					</td>
					<td width="85%" colspan="3">
				...
				<TR id="nodeAddMAC" <% if("1".equals(type)){%>style="display: none;"<%} %>>
					<TD class="title_2" align="center" width="15%">
						节点
					</TD>
					<TD width="85%" colspan="3">
