					...
					<TR>
						<TD bgcolor=#999999>
							<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
								<TR>
									<TH colspan="4" align="center">参数实例列表</TH>
								</TR>
								<TR bgcolor="#FFFFFF">
                              ...
                              <%if(null != authType  && "0".equals(authType)){ %>
                               <TR>
									...
									<INPUT TYPE="button" name="getValue" id="getValue" value="获取参数值"
                              ...
                              <%}else{ %>
								<TR>
									<TD colspan="4" class=green_foot align=center>
										<INPUT TYPE="button" name="getValue" id="getValue" value="获取参数值" class=mybutton onclick="getParam()">&nbsp;&nbsp;
										<s:if test="#parameters.read_flag[0]==2">
											<INPUT TYPE="button" name="setValue" id="setValue" value="配置参数值" class=mybutton onclick="setParam()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<INPUT TYPE="button" name="add_child" id="add_child" value="增加参数实例" class=mybutton onclick="createParam()">&nbsp;&nbsp;
											<INPUT TYPE="button" name="delValue" id="delValue" value="删除参数实例" class=mybutton onclick="delParam()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<INPUT TYPE="button" name="upconfigvalue" id="upconfigvalue" value="参数属性上报" class=mybutton onclick="upParamConfig()">&nbsp;&nbsp;
										</s:if>
									</TD>
								</TR>
								...
								<TR bgcolor="#FFFFFF" id="write_able" style="display: none">
									...
									<TD width="40%"><INPUT TYPE="checkbox" NAME="doesInform"
										id="doesInform" class="bk" value="1" onclick="ChangeNotify()">是否通知
									</TD>
								...
								<TR bgcolor="#FFFFFF" id="write_able" style="display: none">
									...
									<TD width="40%"><INPUT TYPE="checkbox"
										...
										onclick="ChangeProperty()">属性是否变化</TD>
								...
								<TR class=green_foot id="write_able" style="display: none">
									<TD colspan="4" class=foot align=right><INPUT
										...
										value="配置可写属性" class=mybutton onclick="writeableConfig()">&nbsp;&nbsp;
									</TD>
								</TR>
								<%} %>
							</TABLE>
