...
{	
	if(nodeStr==""){
		...
		this.location = "paramAllConfig4Sxlt.jsp?gw_type="+<%=gw_type %>;
		return;
	}
...
function getParam(){
		...
		showMsgDlg();
		var page="para_configForm4Sxlt.jsp?param_name=" 
				...
				<TABLE width="90%" border=0 cellspacing=0 cellpadding=0
					...
					<TR>
						<TD bgcolor=#999999>
							...
							<tr>
								<TD class=column align="laft">参数名称</TD>
								<TD class=column align="laft">参数列表</TD>
							</tr>
							<TR bgcolor="#FFFFFF">
											...
											<tr>
												<td>
													...
													<INPUT TYPE="button" style="background-color: white;border: solid 1px #000;cursor: pointer;" 
														name="setValue" id="setValue" value="修改参数值" class=btn onclick="setParam()">
												</td>
										    </tr>
											<tr>
												<td>
