	...
	<body>
		...
		<table class="querytable" width="98%" align="center">
            ...
            <tr>
				...
				<TD width="85%"  >
					<a href="<s:property value="taskDetailMap.sd_kj_pic_url" />" target="_blank"><s:property value="taskDetailMap.sd_kj_pic_url" />
				</td>
			</tr>
			 <tr>
				<TD class="title_2" align="center" width="15%">
				...
				<TD width="85%"  >
					<a href="<s:property value="taskDetailMap.sd_qd_pic_url" />" target="_blank"><s:property value="taskDetailMap.sd_qd_pic_url" /></a>
				</td>
			</tr>
			 <tr>
				<TD class="title_2" align="center" width="15%">
				...
				<TD width="85%"  >
					<a href="<s:property value="taskDetailMap.sd_rz_pic_url" />" target="_blank"><s:property value="taskDetailMap.sd_rz_pic_url" />
				</td>
			</tr>
