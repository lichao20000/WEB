...
//系统类型
	...
	function ExecMod(){
		...
		$("form[@name='batchexform']").attr("action","<s:url value='/gtms/stb/resource/batchSendUserInfo!saveBatchSendUserInfoTask.action'/>");
	...
	{
		$("form[@name='batchexform']").attr("action","<s:url value='/gtms/stb/resource/batchSendUserInfo!downloadTemplateCustExcel.action'/>");
		$("form[@name='batchexform']").submit();
	}
	
	function toExportCustTxt()
	{
		$("form[@name='batchexform']").attr("action","<s:url value='/gtms/stb/resource/batchSendUserInfo!downloadTemplateCustTxt.action'/>");
		$("form[@name='batchexform']").submit();
	}
			...
			<table class="querytable" width="98%" align="center">
				...
				<tr id="importCustomer" >
					...
					<td width="85%" colspan="3">
						...
						<TR>
						<TD class="title_2" align="center" width="15%">下发类型</TD>
						<TD colspan="3">
						<select name="configType">
						<option value="0">接入账号及密码</option>
						<option value="1">接入账号及密码、业务账号及密码</option>
						</select>
						</TD>
					</TR>
				<TR>
					<td colspan="4" class="foot" align="right">
						<div class="right">
							<button id="doButton" onclick="ExecMod()" name="">
								定制
							</button>
						</div>
					</td>
