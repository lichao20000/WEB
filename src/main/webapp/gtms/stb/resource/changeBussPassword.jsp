...
<script type="text/javascript">
	...
	function CheckForm(){
		...
		var _newPwd = $.trim($("input[@name='newPwd']").val());
					...
					<table id="tblQuery" width="100%" class="querytable">
						...
						<thead>
							...
							value='<s:property value="operateType" />'>
								<td colspan="4" class="title_1">修改业务账号密码工单</td>
							</tr>
						</thead>
						<TR>
						...
						<tr>
							...
							<TD class="title_2" align="right">新密码</TD>
							<TD><INPUT TYPE="password" NAME="newPwd" class=bk
