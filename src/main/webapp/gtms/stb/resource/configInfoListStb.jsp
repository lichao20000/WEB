			...
			<s:if test="configList.size()>0">
				<s:iterator value="configList">
					<tr>
						...
						<td>
							<a href="javascript: configDetailInfo('<s:property value="deviceId" />','<s:property value="deviceSN" />')">详细信息</a>|
							<a href="javascript: configLog('<s:property value="deviceSN" />','<s:property value="deviceId" />')">历史配置</a>|
