...
<script type="text/javascript">
	...
	function checkUserInfo() {
		...
		var url = "<s:url value='/gtms/stb/resource/stbSimulateSheet!showSTBSheet.action'/>";
		$.post(url, {
			username : _username
		}, function(ajax) {
			var relt = ajax.split("#");
...
<body>   
<form name="mainfrm" action="<s:url value='/gtms/stb/resource/stbSimulateSheet!showSTBSheet.action'/>" target="dataForm">
...
<table>
		...
		<table class="querytable">
			...
			<TR bgcolor="#FFFFFF">
				...
				<TD width="30%"><select name="servTypeId" class=bk>
					<option selected value="25">机顶盒业务</option>
				...
				<TD width="30%"><select name="operateType" class=bk onchange="">
					...
					<option value="1">开户</option>
					<option value="3">销户</option>
					<option value="6">更改业务帐号</option>
					<option value="5">更改业务帐号密码</option>
					<option value="7">更换机顶盒</option>
					<%}%>
				</select>&nbsp; <font color="#FF0000">* </font></TD>
			</TR>
	...
	<tr>
		<td><iframe id="dataForm" name="dataForm" height="100"
