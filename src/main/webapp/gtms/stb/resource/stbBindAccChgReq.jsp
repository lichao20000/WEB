...
function query()
{
	...
	frm.action = "<s:url value='/gtms/stb/resource/stbEServerQuery!query.action'/>";
	frm.submit();
}
...
<form name="frm" id="frm" target="dataForm">
	<table>
		...
		<tr>
			<td>
				<table width="100%" class="querytable" align="center">
					...
					<tr>
                        <td class=column width="15%" align='right'>工单状态</td>
                        <td width="35%" >
		...
		<tr>
			<td>
				<iframe id="dataForm" name="dataForm" height="300" frameborder="0" scrolling="no" width="100%" src=""></iframe>
			</td>
		</tr>
	</table>
</form>
