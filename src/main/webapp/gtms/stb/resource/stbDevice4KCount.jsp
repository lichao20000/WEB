...
function query(data_type,queryTime)
{
	...
	form.action = "<s:url value='/gtms/stb/resource/stbDeviceCount!stb4KCount.action'/>";
	form.submit();
}
		...
		<TR>
			<TD >
				<IMG height=20 src="<s:url value='/images/bite_2.gif'/>" width=24>
	            	您当前的位置：全省4K机顶盒分布及软探针部署报表
			</TD>
		</TR>
	</TABLE>
	<TABLE width="98%" class="querytable" align="center">
		<tr>
			<th id="thTitle" class="title_1">全省4K机顶盒分布及软探针部署报表</th>
		</tr>
		<tr align="right">
