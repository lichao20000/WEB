...
function getStbDeviceList(){
	...
	$("input[name=deviceMac]").val(deviceMac);
				...
				<table class="green_gargtd">
					<tr>
						...
						<td>
							...
							开始时间和结束时间分别为用户添加的日期<font color="red">*</font>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td>
				<table width="100%" class="querytable" align="center">
					...
					<tr>
						<td align="right" class=column width="15%">最近上报开始时间</td>
						<td width="35%">
							<input type="text" name="lastStartTime" readonly value="<s:property value='lastStartTime'/>" /> 
							<img name="shortDateimg"
								onClick="WdatePicker({el:document.frm.lastStartTime,dateFmt:'yyyy-MM-dd HH:mm:ss',skin:'whyGreen'})"
								src="../../../images/dateButton.png" width="15" height="12" border="0" alt="选择" />
						</td>
						<td align="right" class="column" width="15%">最近上报结束时间</td>
						<td width="35%">
							<input type="text" name="lastEndTime" readonly value="<s:property value='lastEndTime'/>" /> 
							<img name="shortDateimg"
								onClick="WdatePicker({el:document.frm.lastEndTime,dateFmt:'yyyy-MM-dd HH:mm:ss',skin:'whyGreen'})"
								src="../../../images/dateButton.png" width="15" height="12" border="0" alt="选择" />
						</td>
					</tr>
					<tr>
