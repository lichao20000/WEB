				...
				<s:if test="date.size()>0">
					<s:iterator value="date">
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD colspan=3><select name="platformType" class="bk">
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD colspan=3>
									<select name="userGroupID" class="bk" >
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD colspan="3" ><input type="text" id="iptvBindPhone" name="iptvBindPhone" class="bk" value="<s:property value="iptvBindPhone"/>"></TD>
						</TR>
						<TR bgcolor="#FFFFFF">
							<TD class=column width="15%" align='right'>属地</TD>
							<TD width="35%"><select name="gwShare_cityId"
								class="bk" onchange="gwShare_change('cityid','-1')">
									<option value="<s:property value="cityId" />">==请选择==</option>
							</select> &nbsp; <font
								color="red"> *</font>
								</select></TD>
						</TR>
						<TR bgcolor="#FFFFFF">
							...
							<TD width="35%"><select name="citynext"
								class="bk">
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD colspan=3><input type="text" id="stbuser" name="stbuser" class="bk" value="<s:property value="stbuser" />"></TD>
						</TR>
						<TR bgcolor="#FFFFFF">
