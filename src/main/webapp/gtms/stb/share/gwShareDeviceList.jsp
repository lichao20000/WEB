	...
	<tfoot>
		...
		<ms:inArea areaCode="hn_lt" notInMode="false">
			<td colspan="9" align="right">
				<s:if test="ITV!='yes'">
				<lk:pages url="/gtms/stb/share/shareDeviceQuery!goPage.action" styleClass="" showType="" isGoTo="true" changeNum="false"/>
				</s:if>
			</td>
		</ms:inArea>
		<ms:inArea areaCode="hn_lt" notInMode="true">
		...
		<ms:inArea areaCode="hn_lt" notInMode="false">
			<td colspan="9" align="right" class="green_foot" width="100%">
				<button onclick="javascript:gwShare_rsselectall();" style="display:none" name="gwShare_selectall">全部选中</button>
