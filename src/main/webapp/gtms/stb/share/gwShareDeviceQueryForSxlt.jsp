...
function gwShare_queryDevice(){
	...
	var url="<s:url value='/gtms/stb/share/shareDeviceQuery!queryDeviceListForSxlt.action'/>?gwShare_queryResultType="+gwShare_queryResultType;
	...
	<tr id="gwShare_tr12" STYLE="display:">
		<td colspan="4" align="center" width="100%">
			<div align="center">
				...
				<input type="radio" class=jianbian name="gwShare_queryField" value="deviceIpSix" onclick="gwShare_queryField_selected(this)"/> 设备IPV6地址 &nbsp;&nbsp;
				</ms:inArea>
		...
		<td colspan="4" align="right" class="green_foot" width="100%">
			<div align="right">
				<input type="button" class=jianbian onclick="javascript:gwShare_queryDevice();" 
					name="gwShare_queryButton" style="CURSOR:point;display:" value="查 询 "/>
				<input type="button" class=jianbian onclick="javascript:gwShare_queryChange('1');" 
					name="gwShare_jiadan" style="CURSOR:pointer;display: none" value="简单查询"/>
				<input type="button" class=jianbian onclick="javascript:gwShare_queryChange('2');" 
					name="gwShare_gaoji" style="CURSOR:pointer;display: none" value="高级查询"/>
				<input type="button" class=jianbian onclick="javascript:gwShare_revalue();" 
					name="gwShare_reButto" style="CURSOR:pointer;display: none" value=" 重 置">
			</div>
		</td>
	</tr>
</TABLE>
