...
function gwShare_queryDevice(){
	...
	var url="<s:url value="/gtms/stb/share/shareDeviceQuery!queryDeviceList.action"/>?ITV=yes&gwShare_queryResultType="+gwShare_queryResultType;
	...
	var returnVal=window.showModalDialog(url ,null,'dialogWidth='+width+'px;dialogHeight='+ height+'px;resizable=no;help=no;center=yes;status=no;scroll=yes;edge=raised');    
