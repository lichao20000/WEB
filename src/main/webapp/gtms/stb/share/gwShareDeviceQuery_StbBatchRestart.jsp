...
function gwShare_queryDevice(){
	...
	var url="<s:url value="/gtms/stb/diagnostic/StbBatchRestart!queryDeviceList.action"/>?gwShare_queryResultType="+gwShare_queryResultType;
		...
		<td bgcolor=#999999>
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<tr id="gwShare_tr32" style="display:none">
					...
					1、需要导入的文件格式限于文本文件，txt格式 。
					 <br>
					2、文件的第一行为标题行，即"业务账号"。
					 <br>
					3、文件只有一列。
					 <br>
					4、文件行数最大支持2万，如果间隔时间不为空，行数不能超过2千。
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
