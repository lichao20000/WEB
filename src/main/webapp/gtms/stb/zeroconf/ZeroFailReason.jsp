...
<script type="text/javascript">
   $(function(){
        ...
        $("#query").click(function(){
            ...
            $("#resultFrame").hide("");
            $("#tip_loading").show();
            var url="<s:url value='/gtms/stb/zeroconf/zeroFailReasonQuery!getZeroConfStatisticsReportByCityid.action'/>";
        ...
        $("#export").click(function(){
           ...
           $("#queryForm").attr("action",
                   "<s:url value='/gtms/stb/zeroconf/zeroFailReasonQuery!exportExcel.action'/>");
           $("#queryForm").submit();
        });
   })
   /**
...
<body>
	<form id="queryForm" name="queryForm">
		<table id="tblQuery" width="98%" class="querytable">
			<thead>
				<tr>
					<td colspan="4" class="title_1">失败原因统计</td>
				</tr>
			</thead>
