...
function DetailCustomerInfo(customer_id){
	var strpage = "<s:url value='/bbms/CustomerInfo!detailInfo.action'/>?customer_id=" + customer_id;
...
//------------------------------------------------------------------------------------------------------
	String workid = (String) fields.get("workid");  // 工单编号
	String bandwidth = (String) fields.get("bandwidth");   // 带宽
	String sheetStatus = "成功";   // 回单状态
	String busi_para = "";   // 工单业务参数
	String action_log = ""; // 工单执行日志
	
	String opendate = "";  // 生成时间  回单时间
	DateTimeUtil dt1 = new DateTimeUtil(Long.parseLong((String)fields.get("opendate"))*1000);
	opendate = dt1.getLongDate();
//-------------------------------------------------------------------------------------------------------
...
/***********************************************************/
%>
<TABLE border=0 align="center" cellspacing=0 cellpadding=0 width="100%" id="myTable">
	<TR>
		<TD>
			...
			<TR>
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<TR bgcolor="#FFFFFF">
						...
						<TD width="15%" class=column align="left">工单类型</TD>
						<TD width="35%">
						<%
							String user_state = "";
					...
					<tr bgcolor="#FFFFFF">
						<td class=column align="left">申请带宽</td>
						<td ><%=bandwidth%></td>
						<td class=column align="left">工单编号</td>
						<td ><%=workid%></td>
					</tr>
					<tr bgcolor="#FFFFFF">
						<td class=column align="left">生成时间</td>
						<td ><%=opendate%></td>
						<td class=column align="left">回单时间</td>
						<td ><%=opendate%></td>
					</tr>
					<tr bgcolor="#FFFFFF">
						<td class=column align="left">回单状态</td>
						<td ><%=sheetStatus%></td>
						<td class=column align="left">工单执行日志</td>
						<td >&nbsp;</td>
					</tr>
			...
			<TR>
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<tr bgcolor="#FFFFFF">
						...
						<td width="35%"><a onclick="DetailCustomerInfo('<%=customer_id%>')" href="javascript:"><%=customer_name%></a></td>
