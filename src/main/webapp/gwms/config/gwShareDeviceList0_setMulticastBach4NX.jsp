...
function gwShare_comfirmDevice(){
	...
	for(var i=0;i<alldata.length;i++){
		...
		rs_[i] = new Array(device[0],device[1],device[2],device[3]);
	}
...
<input type="hidden" name="gwShare_param_one" 
	value="<s:property value="city_id"/>|<s:property value="device_id"/>|<s:property value="device_serialnumber"/>|<s:property value="file_username"/>|linkage" />
...
<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center" bgcolor=#999999>
	...
	<tr>
		...
		<th align="center">导入账号</th>
		<!-- <th align="center">IPTV账号</th> -->
		<th align="center">设备序列号</th>
		<th align="center">设备属地</th>
	</tr>
	<s:iterator value="deviceList">
		<tr bgcolor="#FFFFFF">
			<td class=column1>
				<input type="checkbox" name="radioDeviceId" 
					value="<s:property value="city_id"/>|<s:property value="device_id"/>|<s:property value="device_serialnumber"/>|<s:property value="file_username"/>" /></td>
			<td class=column1><s:property value="file_username"/></td>
