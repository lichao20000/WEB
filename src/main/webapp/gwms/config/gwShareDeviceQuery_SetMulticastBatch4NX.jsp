...
function gwShare_queryDevice(){
	...
	var url="<s:url value="/gwms/config/setMulticastBatch!queryDeviceList.action"/>?gwShare_queryResultType="+gwShare_queryResultType;
			...
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<tr id="gwShare_tr31" bgcolor="#FFFFFF"  style="display:none">
					...
					<td colspan="3" width="85%">
						<input type="text" name="taskname" id="taskname" align="left"/>
					</td>
				</tr>
				...
				<tr id="gwShare_tr32" style="display:none">
					...
					1、需要导入的文件格式限于Excel、文本文件，即xls、txt格式 。
					 <br>
					2、文件的第一行为标题行，即"用户账号"或"设备序列号"。
					 <br>
					3、文件只有一列。
					 <br>
					4、文件行数不要超过3000行，以免影响性能。
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
