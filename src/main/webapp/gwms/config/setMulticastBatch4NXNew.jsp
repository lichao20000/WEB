...
function doQuery(){
	...
	if(deviceIds == ""){
		...
		url = "<s:url value='/gwms/config/setMulticastBatch!addTaskInfo4NX.action'/>";
		$.post(url,{
			taskname : taskname,
		...
		<TD>
			...
			<table width="98%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<tr bgcolor=#ffffff>
						<td class=column align=right width="15%">任务名称：</td>
						<td class=column align=left width="35%"><input type="text" name="taskname"  > </td>
						
						<td class=column align=right width="15%">策略方式：</td>
						<td class=column align=left width="35%">
