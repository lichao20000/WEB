...
//type 1:add; 2:edit.
function chgForm (type, lanId, lanWlanId, ssid, beacontype, wep_key, wpa_key,channel) {
...
function editWlanConn() {
	...
	if($("jxchannel")[0]){
		if(!(/^\d+$/.test(channel.val())) || parseInt(channel.val()) > 255){
			alert("信道必须为0~255的整数");
			channel.focus();
			return;
		}
		...
		<TD bgcolor=#999999>
			...
			<FORM NAME="frm1" METHOD="post">
				...
				<TR bgcolor="#FFFFFF">
					...
					<TD colspan="2"><INPUT TYPE="text" NAME="wpsKeyWord" size="8" maxlength="8" value="<s:property value='wpsKeyWord' default=''/>"></TD>
				</TR>
				<TR bgcolor="#FFFFFF">
				...
				<s:else>
					<s:iterator var="list" value="list" status="row">
						<TR bgcolor="#FFFFFF">
							...
							<TD align="center"><IMG SRC="../../images/edit.gif" WIDTH="14" HEIGHT="12" BORDER="0" ALT="编辑" onclick="chgForm(2,<s:property value='#list.lanId' default=''/>,<s:property value='#list.lanWlanId' default='1'/>,'<s:property value='#list.ssid' default='1'/>', '<s:property value='#list.beacontype' default='None'/>', '<s:property value='#list.wepKey' default=''/>', '<s:property value='#list.wpaKey' default=''/>','<s:property value='#list.channel' default=''/>')" onMouseOver="this.style.cursor='hand';">&nbsp;&nbsp;<IMG SRC="../../images/del.gif" WIDTH="14" HEIGHT="12" BORDER="0" ALT="删除"  onclick="del(<s:property value='#list.lanId' default='1'/>,<s:property value='#list.lanWlanId' default='1'/>)" onMouseOver="this.style.cursor='hand';">&nbsp;&nbsp;<IMG SRC="../../images/add.gif" WIDTH="14" HEIGHT="12" BORDER="0" ALT="添加"  onclick="chgForm(1,<s:property value='#list.lanId' default='1'/>,'','','','','','')" onMouseOver="this.style.cursor='hand';"></TD>
						</TR>
					</s:iterator>
				</s:else>
			</TABLE>
		...
		<TD bgcolor=#999999 colspan="9">
			<TABLE border=0 cellspacing=1 cellpadding=1 width="100%">
				...
				<TR bgcolor="#FFFFFF">
					...
					<TD colspan=3>
						...
						<SELECT name="beacontype" class="bk" onchange="chg_auth(this.value)">
							...
							<OPTION value="WPA/WPA2">WPA2-PSK</OPTION>
							</ms:inArea>
				...
				<TR bgcolor="#FFFFFF">
					...
					<TD >
						<input type="text" name="channel" class="bk" maxlength=3 id="jxchannel">
						<font color="red">* 0：表示自动选择信道,1～255：实际信道值！</font>,
					</TD>
				</TR>
				</ms:inArea>
