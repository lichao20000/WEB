...
<%
String telecoms = LipossGlobals.getLipossProperty("telecom");
%>
...
function chgmode()
{
	...
	{
		if(randompasswd.val().indexOf("cu") > -1){
			xcompasswd.val("cuadmin");
		}else{
...
function CheckPost() {
	...
	var url = "<s:url value='/gwms/diagnostics/xcompasswdACT!config.action'/>";
	$.post(url,{
		deviceId:deviceId,
