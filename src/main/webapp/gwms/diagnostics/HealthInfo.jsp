...
function getWireInfoHtml() {
	...
	var url = "<s:url value='/gwms/diagnostics/HealthInfo!gatherWireInfo.action'/>";
	$.post(url,{
...
function editBuss(stv) {
	...
	var url = "<s:url value='/gwms/diagnostics/HealthInfo!editBussInfo.action'/>";
...
function editHealth() {
	...
	var url = "<s:url value='/gwms/diagnostics/HealthInfo!editHealthInfo.action'/>";
...
function getBussHtml() {
	...
	var url = "<s:url value='/gwms/diagnostics/HealthInfo!getBussInfo.action'/>";
						...
						<TABLE border=0 cellspacing=1 cellpadding=2 width="100%" >
							<tr align="left">
								 <td colspan="4" align="right" class="column">
									<input type="button" name='addImg' onclick="getWireInfoHtml()" value="重新采集"> &nbsp;

									<input type="button" name='addImg' onclick="editHealthHtml()" value="编辑">
								</td>
							</tr>
