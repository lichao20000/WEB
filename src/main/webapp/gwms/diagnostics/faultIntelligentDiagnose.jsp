...
<SCRIPT LANGUAGE="JavaScript">
	...
	var iframeSrc=["<s:url value='/gwms/diagnostics/deviceInfo.action?deviceId='/>",
	               "<s:url value='/gwms/diagnostics/algACT.action?deviceId='/>",
	               "<s:url value='/gwms/diagnostics/deviceDiagnostics.action?deviceId='/>"];
	...
	var iframeSrcAdvance=["<s:url value='/gwms/diagnostics/algACT.action?deviceId='/>","<s:url value='/gwms/diagnostics/mwbandACT.action?deviceId='/>","<s:url value='/gwms/diagnostics/wlanACT.action?deviceId='/>","<s:url value='/gwms/diagnostics/xcompasswdACT.action?deviceId='/>"];
