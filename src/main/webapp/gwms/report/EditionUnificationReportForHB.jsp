...
$(function() {
	...
	function doQuery(){
		...
		var url = "<s:url value='/gwms/report/tyGateAgreeCountReportForHb!queryDataListJXDX.action'/>";
		$.post(url,{
			gwType:gw_type,
			vendorId:vendorId,
	...
	function getdetailListJXDX(gwType,vendorId,deviceModelId,isExcludeUpgrade,
		...
		var page = "<s:url value='/gwms/report/tyGateAgreeCountReportForHb!querydetailListJXDX.action'/>"
				...
				<td>
					<table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#999999">
						...
						<tr>
							...
							<td width="30%" class=column <ms:inArea areaCode="hb_dx" notInMode="true">colspan="5"</ms:inArea>>
