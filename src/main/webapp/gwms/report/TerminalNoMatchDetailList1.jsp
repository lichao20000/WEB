...
function ListToExcel(cityId) {
	var page="<s:url value='/gwms/report/terminalNoMatchReport!getNoMatchDevForAllExcel.action'/>?"+ "cityId=" + cityId;
		...
		<tr>
			<td colspan="7">
				<span style="float: right;"> <lk:pages
						url="/gwms/report/terminalNoMatchReport!queryNoMatchDetailList.action" styleClass=""
