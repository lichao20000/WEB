...
function ListToExcel(cityId) {
	var page="<s:url value='/gwms/report/terminalNoMatchReport!getOldCompleteDevDetailExcel.action'/>?"+ "cityId=" + cityId;
		...
		<tr>
			<td colspan="8">
				<span style="float: right;"> <lk:pages
						url="/gwms/report/terminalNoMatchReport!queryOldCompleteDevDetailList.action" styleClass=""
