		...
		<tr>
			<td>
				<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center" bgcolor="#000000">
					<tr bgcolor="#FFFFFF">
						<th><strong>宽带账号</strong></th>
						<th><strong>设备序列号</strong></th>
						<th><strong>注册时间</strong></th>
					</tr>
					<s:iterator value="bindDataList">
						<tr bgcolor="#FFFFFF">
			...
			<td>
				<table border=0 cellspacing=1 cellpadding=2 width="100%" align="right"
					...
					<s:else>
						<tr bgcolor="#FFFFFF">
							<td class=column1 align="right" width="100">
							 	<a href="javascript:queryDataForPrint('getBindData','<s:property value="cityId"/>','<s:property value="startTime"/>','<s:property value="endTime"/>');">
						 			<img src="../../images/print.gif" width="16"  border="0" height="16"></img>
							 	</a>
							 	&nbsp;
							 	<s:if test='#session.isReport=="1"'>
							 	<a href="javascript:queryDataForExcel('getBindData','<s:property value="cityId"/>','<s:property value="startTime"/>','<s:property value="endTime"/>');">
						 			<img src="../../images/excel.gif" width="16"  border="0" height="16"></img>
							 	</a>
							 	</s:if>
							 	&nbsp;
								<a href="javascript:queryDataForPdf('getBindData','<s:property value="cityId"/>','<s:property value="startTime"/>','<s:property value="endTime"/>');">
