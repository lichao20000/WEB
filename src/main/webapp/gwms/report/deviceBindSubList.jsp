...
function ListToExcel(flag,cityId,starttime1,endtime1,vendorId,deviceModelId,deviceTypeId,accessType,usertype) {
	var page="<s:url value='/gwms/report/deviceBindWay!getDeviceExcel.action'/>?"
		+ "flag=" + flag
		+ "&cityId=" + cityId 
		...
		<s:if test="deviceList.size()>0">
			<s:iterator value="deviceList">
				<tr>
					...
					<td>
						<s:property value="deviceIdEx" />
					</td>
					<td>
						<s:property value="device_type" />
					</td>
					<td>
						<s:property value="completeTime" />
					</td>
					<td>
		...
		<tr>
			<td colspan="10">
				<span style="float: right;"> <lk:pages
						url="/gwms/report/deviceBindWay!getBindDeviceList.action" styleClass=""
