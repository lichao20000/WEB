...
function queryDataForExcel(reportType,city_id,timeStart,bookparam){
	...
	var url = "gwms/report/deviceOnline!getDayReport.action";	
	...
	<table border=0 cellspacing=0 cellpadding=0 width="95%" align="center">
		<tr>
			<td>
				...
				<table border=0 cellspacing=1 cellpadding=2 width="100%"  height="50" align="center"
					bgcolor="#000000">
					<tr>
		...
		<!-- <tr>
			<td colspan="5" align="right">
				<lk:pages url="/gwms/report/deviceOnline!goPage.action" styleClass="" showType="" isGoTo="true" changeNum="true"/>
			</td>
		</tr>
	 	-->
	</table>
