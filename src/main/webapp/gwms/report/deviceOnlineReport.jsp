...
function subscribe_to(){
	document.all("url").value = "/gwms/report/deviceOnline.action";
	document.all("bookparamfirst").value = "device_serialnumber|设备序列号$city_name|属地$oui|厂商$device_type|终端类型$last_time|最近交互时间";
						...
						<TABLE width="100%" border=0 cellspacing=1 cellpadding=2 align="center">
							...
							<tr bgcolor="#FFFFFF" id="query1" style="display:">
								<td align=right>
									...
									<input type="button" name="button" value=" 查 询 " class=jianbian onclick="javascript:queryUser(1)">
								</td>
							</tr>
							<tr bgcolor="#FFFFFF" id="query2" style="display:none">
								<td align=right>
									...
									<input type="button" name="button" value=" 查 询 " class=jianbian onclick="javascript:queryUser(2)">
								</td>
							</tr>
