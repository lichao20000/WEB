...
function queryData(reportType,city_id,timeStart){
	...
	var url = "gwms/report/deviceStatusReport!getDayReport.action";
...
function queryDataForExcel(reportType,city_id,timeStart){
	...
	url = url + "?reportType="+reportType+"&cityId="+city_id+"&longData="+timeStart;
...
function subscribe_to(){
	document.all("url").value = "/gwms/report/deviceStatusReport.action";
						...
						<TABLE width="100%" border=0 cellspacing=1 cellpadding=2 align="center">
	     					<TR bgcolor="#FFFFFF" align=right>
	   						...
	   						<tr bgcolor="#FFFFFF" id="query1" style="display:">
								<td align=right>
									...
									<input type="button" name="button" value=" 查 询 " class=jianbian onclick="javascript:queryUser(1)"></td>
							</tr>
							<tr bgcolor="#FFFFFF" id="query2" style="display:none">
								<td align=right>
									...
									<input type="button" name="button" value=" 查 询 " class=jianbian onclick="javascript:queryUser(2)"></td>
							</tr>
							<tr bgcolor="#FFFFFF" id="query3" style="display:none">
								<td align=right>
									...
									<input type="text" name="start" value='<s:property value="weekData" />' readonly class=bk> <img name="shortDateimg"
										...
										src="../../images/search.gif" width="15" height="12" border="0" alt="选择">(YYYY-MM-DD)
									<input type="button" name="button" value=" 查 询 " class=jianbian onclick="javascript:queryUser(3);">
								</td>
							</tr>
							<tr bgcolor="#FFFFFF" id="query4" style="display:none">
								<td align=right>
									...
									<input type="text" name="q_month" value='<s:property value="weekData" />' readonly class=bk> <img name="shortDateimg"
										...
										src="../../images/search.gif" width="15" height="12" border="0" alt="选择">(YYYY-MM-DD)
									<input type="button" name="button" value=" 查 询 " class=jianbian onclick="javascript:queryUser(4)">
								</td>
							</tr>
						</TABLE>
					</TD>
