...
function query(){
    ...
    form.action = "<s:url value='/gwms/resource/batchConfigNodeACT!getBatchDevList.action'/>";
    form.submit();
}
...
<body>
<form name="gwShare_selectForm" action="<s:url value="/gwms/resource/batchConfigNodeACT!getBatchDevList.action"/>"
    target="dataForm" >
