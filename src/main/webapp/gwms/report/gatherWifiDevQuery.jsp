...
function query(){
    ...
    form.action = "<s:url value='/gwms/resource/batchConfigNodeACT!getBatchWifiDevList.action'/>";
    form.submit();
}
...
<body>
<form name="gwShare_selectForm" action="<s:url value="/gwms/resource/batchConfigNodeACT!getBatchWifiDevList.action"/>"
    target="dataForm" >
		...
		<td bgcolor=#999999>
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
                <tr>
                    ...
                    <TD width="35%" class=column colspan="3">
