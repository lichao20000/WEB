...
function toExcel(cityId) {
	var page="<s:url value='/gwms/report/MismathSpeed!toAddExcel.action'/>?"+ "cityId=" + cityId;
		...
		<tr>
			<td colspan="11">
				<span style="float: right;"> <lk:pages
						url="/gwms/report/MismathSpeed!queryAddDetail.action" styleClass=""
