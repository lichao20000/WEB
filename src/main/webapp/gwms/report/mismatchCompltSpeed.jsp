...
function detail(cityId){
	var page="<s:url value='/gwms/report/MismathSpeed!queryChangedDetail.action'/>?cityId=" + cityId;
	window.open(page,"","left=50,top=50,height=550,width=900,toolbar=no,menubar=no,location=no,resizable=yes scrollbars=yes");
}

function toExcel(){
	var page="<s:url value='/gwms/report/MismathSpeed!chageExcel.action'/>";
...
<table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td><table class="listtable" id="listTable">
	  <tr bgcolor='#ffffff'><td colspan='2' align='center'>家庭网关不匹配速率与上次对比修改清单</td></Tr>
      <tr>
