...
function toExcel(){
    ...
    $.post(url,{
            ...
            {
                var page="<s:url value='/gwms/report/multicastDownReport!toBusinessExcel.action'/>?gwShare_fileName="+gwShare_fileName;
...
<body>
<form name="gwShare_selectForm" action="<s:url value="/gwms/report/multicastDownReport!queryBusinessList.action"/>"
    target="dataForm">
