...
<table width="98%" border=0 cellspacing=0 cellpadding=0 align="center">
	...
	<TR>
		...
		<TABLE width="100%" height="30" border="0" cellspacing="0"
			...
			<TR>
				<TD width="164" align="center" class="title_bigwhite">业务配置工单结果的统计报表查询</TD>
	...
	<tr>
		...
		<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
			<tr>
				<th colspan="4">业务配置工单结果的统计报表查询统计</th>
			</tr>
		</TABLE>
			...
			<tr>
				...
				<table width="100%" border=0 cellspacing=1 cellpadding=2
					...
					<tr>
						...
						<td class="green_title" align='center' width="5%">宽带用户数</td>
						<td class="green_title" align='center' width="5%">宽带业务下发成功数</td>
						<td class="green_title" align='center' width="5%">宽带业务下发成功率(%)</td>
						<td class="green_title" align='center' width="5%">VOIP用户数</td>
						<td class="green_title" align='center' width="5%">VOIP业务下发成功数</td>
						<td class="green_title" align='center' width="5%">VOIP业务下发成功率(%)</td>
						<td class="green_title" align='center' width="5%">IPTV用户数</td>
						<td class="green_title" align='center' width="5%">IPTV业务下发成功数</td>
						<td class="green_title" align='center' width="5%">IPTV业务下发成功率(%)</td>
