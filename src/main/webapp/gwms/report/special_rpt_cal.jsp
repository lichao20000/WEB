...
function queryData(reportType,city_id,timeStart){
	...
	var url = "gwms/report/bssSheetReport!getDayReport.action";
...
function subscribe_to(){
	document.all("url").value = "/gwms/report/bssSheetReport.action";
	document.all("bookparamfirst").value = "sum1|开户$sum2|暂停$sum3|销户$sum4|复机$sum5|更改速率$sum6|更改账号$sum7|更换设备$sum8|更改IP";
						...
						<TABLE width="100%" border=0 cellspacing=1 cellpadding=2 align="center">
							...
							<tr bgcolor="#FFFFFF" id="query1" style="display:">
								<td align=right>
									...
									<input type="button" name="btn0" value=" 查 询 " class=jianbian onclick="javascript:queryUser(1)"></td>
							</tr>
							<tr bgcolor="#FFFFFF" id="query2" style="display:none">
								<td align=right>
									...
									<input type="text" name="q_date" value='<s:property value="dayData" />' readonly class=bk> <img name="shortDateimg"
										onclick="new WdatePicker(document.form1.q_date,'%Y-%M-%D',false,'whyGreen')"
										src="../../images/search.gif" width="15" height="12" border="0" alt="选择">(YYYY-MM-DD)
									<input type="button" name="btn0" value=" 查 询 " class=jianbian onclick="javascript:queryUser(2)"></td>
							</tr>
							<tr bgcolor="#FFFFFF" id="query3" style="display:none">
								<td align=right>
									...
									<input type="text" name="start" value='<s:property value="weekData" />' readonly class=bk> <img name="shortDateimg"
										onclick="new WdatePicker(document.form1.start,'%Y-%M-%D',false,'whyGreen')"
										src="../../images/search.gif" width="15" height="12" border="0" alt="选择">(YYYY-MM-DD)
							...
							<tr bgcolor="#FFFFFF" id="query4" style="display:none">
								<td align=right>
									...
									<input type="text" name="q_month" value='<s:property value="weekData" />' readonly class=bk> <img name="shortDateimg"
										onclick="new WdatePicker(document.form1.q_month,'%Y-%M-%D',false,'whyGreen')"
										src="../../images/search.gif" width="15" height="12" border="0" alt="选择">(YYYY-MM-DD)
