	...
	function ToExcel() {
		...
		if(countNum>100000){
			...
			if(choice==true){
				...
				var page="<s:url value='/gwms/resource/batchSetTempManaACT!queryDevListExcel.action'/>"+"?task_id="+task_id+"&&type="+type;
		...
		<tfoot>
			<tr>
				<td colspan="10" align="right">
					<lk:pages url="/gwms/resource/batchSetTempManaACT!queryDevList.action" styleClass=""
