...
<table class="querytable" width="98%" align="center">
	<tr>
		...
		<td colspan="4" class="title_1">软件升级任务详情</td>
	</tr>
	<TR>
	...
	<TR>
		<TD class="title_2" align="center" width="15%">定制方式</TD>
		<TD width="85%" colspan="3">
	...
	<s:elseif test="taskResultMap.querytype==1">
		<TR>
			<TD class="title_2" align="center" width="15%">查询条件</TD>
			<TD width="85%" colspan="3">
				<s:property value="taskResultMap.queryfield" />
			</TD>
		</TR>
		<TR>
			<TD class="title_2" align="center" width="15%">参数值</TD>
			<TD width="85%" colspan="3">
	...
	<tr>
		<TD class="title_2" align="center" width="15%">更新时间</td>
		<TD width="85%" colspan="3">
