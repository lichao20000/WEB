...
<SCRIPT LANGUAGE="JavaScript">
   ...
   function saveTemplate(id){
    ...
    if('' == $("#name").val()){
    	...
    	$.ajax({
    	    type:"POST",
    	    async:false,
    	    url:"<s:url value='/gwms/resource/servTemplate!addTemplate.action' />?id="+id,
    	    dataType:"text",
    	    data: {"checkedData":JSON.stringify(sNodes),"name":$("#name").val(),"describe":$("#describe").val(),"update_time":$("#update_time").val()},
   ...
   */
	...
	*/
	...
	$('input[type=radio][name=template_type]').change(function() {
		if (this.value == 'serv') {
			$("#service_id_tr").show();
