...
function doQuery(){
    ...
    var url = '<s:url value='/gwms/config/setMulticastBatch!queryModifyVlanInfoByTime.action'/>'; 
	$.post(url,{
		cityId:cityId,
		starttime:starttime,
		endtime:endtime,
...
function ToExcel(cityId) {
    ...
    var endtime = $.trim($("input[@name='endtime']").val());
	var cityId = $.trim($("select[@name='cityId']").val());
	var page="<s:url value='/gwms/config/setMulticastBatch!getInfoExcelByTime.action'/>?"
...
function openDev(cityId,status){
	...
	var starttime = $.trim($("input[@name='starttime']").val());
	var endtime = $.trim($("input[@name='endtime']").val());
	var page="<s:url value='/gwms/config/setMulticastBatch!getDevByTime.action'/>?"
		+ "cityId=" + cityId 
		+"&status=" + status
		+ "&type=" +type1
