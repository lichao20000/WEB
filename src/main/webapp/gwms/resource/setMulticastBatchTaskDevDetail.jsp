	...
	function ToExcel() {
		...
		if(countNum>100000){
			...
			if(choice==true){
				...
				var page="<s:url value='/gwms/resource/setMulticastBatchCount!showDetailListByTypeExcel.action'/>"+"?task_id="+task_id+"&&cityId="+city_id+"&&type="+type;
			...
			var task_id='<s:property value="task_id" />';
			var city_id='<s:property value="cityId" />';
			var type='<s:property value="type" />';
			var page="<s:url value='/gwms/resource/setMulticastBatchCount!showDetailListByTypeExcel.action'/>"+"?task_id="+task_id+"&&cityId="+city_id+"&&type="+type;
			document.all("childFrm").src=page;
		}
		...
		<tfoot>
			<tr>
				<td colspan="10" align="right">
					<lk:pages url="/gwms/resource/setMulticastBatchCount!showDetailListByType.action" styleClass=""
