...
function query(){
	...
	form.action = "<s:url value='/gwms/resource/setMulticastBatchCount!queryMulticastBatchList.action'/>";
	form.submit();
}
...
<TABLE border=0 cellspacing=0 cellpadding=0 width="100%">
	...
	<TR>
		<TD>
		<FORM NAME="mainForm" id="mainForm" METHOD="post" ACTION="/gwms/resource/setMulticastBatchCount!queryMulticastBatchList.action" target="dataForm">
		<table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="green_gargtd">
			<tr>
				<td width="162"> <div align="center" class="title_bigwhite">批量修改组播参数管理</div> </td>
		...
		<TABLE border=0 cellspacing=0 cellpadding=0 width="98%" align="center">
			<tr>
				...
				<table border=0 cellspacing=1 cellpadding=2 width="100%"
					align="center">
					<tr>
						<th colspan="4" id="gwShare_thTitle">批量修改IPTV组播参数管理</th>
					</tr>
						<tr bgcolor="#FFFFFF">
												...
												<td align="left" width="30%">
													<input type="text"   name="starttime" readonly value="<s:property value='starttime'/>" class=bk >
												...
												<td align="left" width="30%">
													<input type="text"  name="endtime" readonly value="<s:property value='endtime'/>" class=bk >
														<img name="shortDateimg"
