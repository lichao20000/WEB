...
<input type="hidden" name="gwShare_param_one" 
	value="<s:property value="loid"/>|<s:property value="net_username"/>
		  |<s:property value="city_id"/>|<s:property value="device_id"/>
		  |<s:property value="oui"/>|<s:property value="device_serialnumber"/>|<s:property value="user_id"/>|linkage" />
		...
		<tr bgcolor="#FFFFFF">
			<td class=column1>
				<input type="checkbox" name="radioDeviceId" 
					value="<s:property value="loid"/>|<s:property value="net_username"/>|<s:property value="city_id"/>
					|<s:property value="device_id"/>|<s:property value="oui"/>|<s:property value="device_serialnumber"/>|<s:property value="user_id"/>" /></td>
			<td class=column1><s:property value="loid"/></td>
			<td class=column1><s:property value="net_username"/></td>
			<td class=column1><s:property value="device_serialnumber"/>
			</td>
