...
<%
	...
	String AHLT_softUp = StringUtil.getStringValue(request.getParameter("AHLT_softUp")) ;
...
function gwShare_queryDevice(){
    ...
    if("1"==gwShare_queryType){
        ...
        var gwShare_netSpeed = $.trim($("select[@name='gwShare_netSpeed']").val());
        ...
        if(proName == "ah_dx" || proName == "jl_lt"|| proName == "ah_lt"|| proName == "xj_dx"|| proName == "sd_dx"|| proName == "zj_lt"){
        	url = url + "&gwShare_matchSQL=" + gwShare_matchSQL;
			if(AHLT_softUp == '1'){
				url = url + "&AHLT_softUp=" + AHLT_softUp;
			}
        }
        ...
        url = url + "&gwShare_netSpeed=" + gwShare_netSpeed;
...
function gwShare_revalue(){
	...
	if("1"==gwShare_queryType){
		...
		$("select[@name='gwShare_netSpeed']").attr("value",'-1')
...
function gwShare_spellSQL(){
    ...
    $.post(url,{
		...
		gwShare_netSpeed:gwShare_netSpeed,
		...
		<td bgcolor=#999999>
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<TR bgcolor="#FFFFFF" id="gwShare_tr21" STYLE="display:none">
					...
					<TD align="right" class=column width="15%" >签约宽带</TD>
					<TD width="35%"  colspan="3">
						<select name="gwShare_netSpeed" class="bk">
                            <option value="-1">==全部==</option>
				...
				<TR bgcolor="#FFFFFF" id="gwShare_tr24"  STYLE="display:none" >
					...
					<TD width="35%">
						<input type="text" name="gwShare_deviceSerialnumber" value="" size="35" maxlength="35" class="bk"/>
