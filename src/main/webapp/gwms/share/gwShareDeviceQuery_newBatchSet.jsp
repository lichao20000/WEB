...
function gwShare_queryDevice(){
	...
	{
	var url="<s:url value="/gwms/share/gwDeviceQuery!queryDeviceCount.action"/>?gwShare_queryResultType="+gwShare_queryResultType;
	}
	...
	queryTypeNew = gwShare_queryType;
...
function gwShare_queryChange(change){
	...
	switch (change){
		case "2":
			...
			$("tr[@id='gwShare_tr12stb']").css("display","none");
		...
		case "1":
			...
			var gw_type=<%=gw_type %>;
			if("4"==gw_type){
				$("tr[@id='gwShare_tr12stb']").css("display","");
				$("tr[@id='gwShare_tr12']").css("display","none");
			}
			else{
...
function gwShare_change_select(type,selectvalue){
	...
	switch (type){
		...
		case "vendor":
			...
			if('4'==gw_type){
				url = "<s:url value="/gwms/share/gwDeviceQuery!getVendorStb.action"/>";
			}
			$.post(url,{
			},function(ajax){
			...
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<tr bgcolor="#FFFFFF" id="gwShare_tr11" STYLE="display:">
					<td colspan="6" align="center" width="100%">
						<div>
							<input type="input" class="bk" name="gwShare_queryParam" id="gwShare_queryParam" size="64" maxlength="64"/>
				...
				<tr bgcolor="#FFFFFF" id="gwShare_tr12stb" STYLE="display:">
		            <td colspan="6" align="center" width="100%">
		                <div align="center">
