			...
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<tr bgcolor="#FFFFFF">
					<td colspan="4" align="right" class="green_foot" width="100%">
						<%if(request.getParameter("do_type").equals("1")){%>
						...
						<%}else{%>
							<%-- <ms:inArea areaCode="js_dx" notInMode="true"> --%>
								<input type="button" class=jianbian onclick="javascript:gwShare_queryChange('2');" name="gwShare_gaoji" value="高级查询" />
							<%-- </ms:inArea> --%>
							<input type="button" class=jianbian onclick="javascript:gwShare_queryChange('3');" name="gwShare_import" value="导入查询" />
							
							<input type="button" class=jianbian onclick="javascript:gwShare_queryChange('4');" name="gwShare_upimport" value="升级导入查询" />
							<input type="button" onclick="javascript:do_query()" class=jianbian 
							name="gwShare_queryButton" value=" 查 询 " />
							<input type="button" class=jianbian onclick="javascript:gwShare_revalue()" 
							name="gwShare_reButto" value=" 重 置 " />
