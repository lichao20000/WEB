...
function do_query(){
	...
	setTimeout("gwShare_queryDevice(1)", 2000);
}
...
function gwShare_revalue(){
	...
	if("1"==gwShare_queryType){
		...
		$("tr[@id='trData']").css("display","none");
		$("tr[@id='trData1']").css("display","none");
		$("tr[@id='trData2']").css("display","none");
	}else if("2"==gwShare_queryType){
	...
	$('input[name="checkAllButton"]').attr("checked",false);
	$("tr[@id='trData3']").css("display","none");
	$("tr[@id='trData4']").css("display","none");
	$("tr[@id='trData5']").css("display","none");
	$("select[@name='conf_type_id']").attr("value",'-1');
	...
	<tr>
		<td bgcolor=#999999>
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<tr id="gwShare_tr31" bgcolor="#FFFFFF"  style="display:none">
					...
					<td colspan="3" width="85%">
						<div id="importUsername">
							<iframe id="gwShare_loadForm" name="gwShare_loadForm" FRAMEBORDER=0 SCROLLING=NO src="<s:url value="/paramConfig/batchConfigUpload.jsp"/>" height="20" width="100%">
							</iframe> 
							<!-- <input type="file" name ="myFile" size="40" label ="Image File" cssClass="bk"> -->
				...
				<tr bgcolor="#FFFFFF" id="button">
					<td colspan="4" align="right" class="green_foot" width="100%" >
						<input type="hidden" name="dotype" value="3" />
						<input type="button" class=jianbian style="CURSOR:hand" 
						onclick="javascript:gwShare_queryChange('1');" name="gwShare_jiadan" value="简单查询" style="display: none" /> 
						<input type="button" class=jianbian style="CURSOR:hand" 
							onclick="javascript:gwShare_queryChange('2');" name="gwShare_gaoji" style="display: none"  value="高级查询" />
						<input type="button" class=jianbian style="CURSOR:hand"  
						onclick="javascript:gwShare_queryChange('3');" name="gwShare_import" style="display: none"  value="导入查询" />
						...
						name="gwShare_reButto" value=" 重新定制  " />
					</td>
				</tr>
			</table>
		</td>
