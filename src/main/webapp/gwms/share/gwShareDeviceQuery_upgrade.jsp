	...
	<tr>
		<td bgcolor=#999999>
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<tr bgcolor="#FFFFFF" id="gwShare_tr11" STYLE="display:none">
				...
				<tr bgcolor="#FFFFFF" id="gwShare_tr12" STYLE="display:none">
					<td colspan="4" align="center" width="100%">
				...
				<tr bgcolor="#FFFFFF">
					<td colspan="4" align="right" class="green_foot" width="100%">
						...
						<input type="button" class=jianbian style="CURSOR:hand" style="display: " 
