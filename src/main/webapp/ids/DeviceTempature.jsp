...
<script type="text/javascript">
	...
	function query() {
	    ...
	    var url = "<s:url value='/ids/voiceRegStatusAnanlyReport!deviceTempQuery.action' />";
	    $.post(url,{
	    	city_id : cityId,
	...
	function downFile(city_id,numInfo){
		...
		var num = "";
		//ponStatus_00_deviceCount_1_2014-06-16.zip
		
		var tempPath = "/ponStatus_" +city_id+"_deviceCount_"+dateType+"_"+endOpenDate+".zip";
