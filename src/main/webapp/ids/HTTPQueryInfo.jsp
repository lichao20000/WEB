										...
										<TD bgcolor=#999999>
												<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
														...
														<TR bgcolor="#FFFFFF">
															...
															<TD width="35%"><input type="text" name="column1" size="20" class="bk"  />
															<%if("nx_dx".equals(LipossGlobals.getLipossProperty("InstArea.ShortName"))){%>
															<span style="color:green">例如：http://202.100.96.14:8182/SpeedTest/SpeedFile.zip</span>
															<%
																}
															%>
															</TD>
															
															<TD nowrap align="right" class=column width="15%">报文设置的优先级</TD>
