...
function testCheck(devSn,oui,city_id,city_name){
	...
	if("ah_lt" == area){
		...
		$.post("<s:url value='/ids/IdsShareDevice!queryPPPOE.action'/>", {
			...
			function(ajax){
				$("input[@name='column1']").val("http://58.242.194.246:5901/speedfile/services/contractrate/contract/rate/");
				$("input[@name='column2']").val("http://58.242.194.246:5901/speedfile/services/contractrate/results/insert/");
		 });
	}
...
<!-- 															<TD nowrap align="right" class=column width="15%">PPPOE账号</TD>
 ...
 -->													</TR>
														<!-- <TR bgcolor="#FFFFFF" id="testUserInfo2" >
															...
															<TD width="35%" colspan="1"><input type="text" id="userName" name="userName" size="20" class="bk"  /></TD>
															<TD nowrap align="right" class=column width="15%">仿真密码</TD>
															<TD width="35%" colspan="1"><input type="password" id="password" name="password" size="20" class="bk"  /></TD>
														</TR> -->
