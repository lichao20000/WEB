	...
	$.post(wanurl, {idsShare_queryField : ids_queryField,
				 ...
				 function(ajax){
						...
						if("1"==data[0]){
							...
							if("nx_lt" == area){
								$("input[@name='column1']").val("http://42.63.1.14:8092/speedfile/services/contractrate/contract/rate/");
								$("input[@name='column2']").val("http://42.63.1.14:8092/speedfile/services/contractrate/results/insert/");
							}
						}
