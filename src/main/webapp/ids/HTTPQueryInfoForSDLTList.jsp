...
<table class="listtable" id="listTable">
	...
	<thead>
		...
		<tbody>
						...
						<tr>
							<td align="center"><s:property value="httpMap['cityName']" /></td>
							<td align="center"><s:property value="httpMap['deviceModel']" /></td>
							<td align="center"><s:property value="httpMap['deviceVendor']" /></td>
