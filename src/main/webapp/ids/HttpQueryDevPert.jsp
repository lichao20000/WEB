...
function doQuery(){
	...
	var serialnumber = $.trim($("input[@name='serialnumber']").val());
	...
	<tr>
		<td>
			<form name="frm" id="selectForm" method="post"
				action="<s:url value='/ids/httpDownload!queryDevBySerialnumber.action'/>"
				target="dataForm">
				<table class="querytable">
					<tr>
						<th colspan=4>测速结果查询</th>
					</tr>
					...
					<tr bgcolor=#ffffff>
						...
						<td ><input type="text" name="serialnumber" class='bk'></td>
