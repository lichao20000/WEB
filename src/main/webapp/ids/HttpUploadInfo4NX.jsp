...
function doQuery(){
	...
	//}
		...
		url = "<s:url value='/ids/httpUpload!addTaskInfo4NX.action'/>";
		$.post(url,{
			taskname : taskname,
			//filename : filename,
			deviceIds : deviceIds,
				...
				<tr>
					...
					<tr bgcolor=#ffffff>
					 ...
					 <tr bgcolor=#ffffff>
							...
							value="http://202.100.96.14:8182/SpeedTest/" onfocus="if (value =='http://202.100.96.14:8182/SpeedTest/'){value =''}"onblur="if (value ==''){value='http://202.100.96.14:8182/SpeedTest/'}"/><span style="color:green">例如：http://202.100.96.14:8182/SpeedTest/</span> </td>
					</tr>
					<tr bgcolor=#ffffff>
