...
<script type="text/javascript">
	...
	function query() {
	    ...
	    var url = "<s:url value='/ids/voiceRegStatusAnanlyReport!pppoeFailStatus.action' />";
	    $.post(url,{
	    	cityId : cityId,
	...
	//pppoeFailStatus_564_timeout_1_2014-06-16.zip  
	function downFile(city_id,numInfo){
		...
		switch(numInfo){
		case '1': num="_timeout_"; 
		break;
		case '2': num="_authFailure_";
		break;
		case '3': num="_disconnect_";
		break;
		}
		var tempPath = "/pppoeFailStatus_" +city_id+num+dateType+"_"+endOpenDate+".zip";
