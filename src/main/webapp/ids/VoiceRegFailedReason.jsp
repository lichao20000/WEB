...
<script type="text/javascript">
	...
	function query() {
	    ...
	    var url = "<s:url value='/ids/voiceRegStatusAnanlyReport!voiceRegFailedReasonQuery.action' />";
	    $.post(url,{
	    	city_id : cityId,
	...
	function downFile(city_id,numInfo){
		...
		var num = "";
		//voiceStatus_00_ladError_1_2014-06-14.zip routeError serverError accountError unknownError
		switch(numInfo){
		case '1': num="_ladError_"; 
		break;
		case '2': num="_routeError_";
		break;
		case '3': num="_serverError_";
		break;
		case '4': num="_accountError_";
		break;
		case '5': num="_unknownError_";
		break;
		}
		var tempPath = "/voiceStatus_" +city_id+num+dateType+"_"+endOpenDate+".zip";
