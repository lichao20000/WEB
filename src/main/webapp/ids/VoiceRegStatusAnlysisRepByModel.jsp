...
<script type="text/javascript">
	...
	function query() {
		...
		var deviceModelId = $.trim($("select[@name='city_id']").val());
		 var endOpenDate = "";
		 if(dateType=='1'){
	    ...
	    var url = "<s:url value='/ids/voiceRegStatusAnanlyReport!voiceRegQueryInfoByModel.action' />";
	    $.post(url,{
	...
	//get the file path  按照型号的
	function downFile(deviceModelId,numInfo){
		...
		var tempPath = "/voicePortByModel_" +deviceModelId+"_line"+num+"_"+dateType+"_"+endOpenDate+".zip";
