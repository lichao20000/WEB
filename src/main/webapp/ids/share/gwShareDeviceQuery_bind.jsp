...
function gwShare_queryDevice(){
	...
	var url="<s:url value='/gwms/service/gwBindDevQuery!queryDeviceList.action'/>?gwShare_queryResultType="+gwShare_queryResultType;
   ...
   if("1"==gwShare_queryType){
	...
	var tips = "";
	var isHaveBind;
	if("batch_on"==servType||"batch_off"==servType){
...
function doTest1(){
	...
	var url="<s:url value='/gwms/service/gwBindDevQuery!getDeviceLists.action'/>";
...
function gwShare_spellSQL(){
	var url = "<s:url value='/gwms/service/gwBindDevQuery!queryDeviceListSQL.action'/>";
	var gwShare_queryResultType = $("input[@name='gwShare_queryResultType']").val();
    var gwShare_queryType = $("input[@name='gwShare_queryType']").val();
	var gwShare_cityId = $.trim($("select[@name='gwShare_cityId']").val());
    var gwShare_onlineStatus = $.trim($("select[@name='gwShare_onlineStatus']").val());
...
function gwShare_change_select(type,selectvalue){
	switch (type){
		case "city":
			var url = "<s:url value='/gwms/service/gwBindDevQuery!getCityNextChild.action'/>";
			$.post(url,{
			},function(ajax){
		...
		case "nextCity":
			...
			var url = "<s:url value='/gwms/service/gwBindDevQuery!getCityNextChildCore.action'/>";
			$.post(url,{
			...
			break;
		case "vendor":
			var url = "<s:url value='/gwms/service/gwBindDevQuery!getVendor.action'/>";
			$.post(url,{
			},function(ajax){
			...
			break;
		case "deviceModel":
			var url = "<s:url value='/gwms/service/gwBindDevQuery!getDeviceModel.action'/>";
			...
			break;
		case "devicetype":
			var url = "<s:url value='/gwms/service/gwBindDevQuery!getDevicetype.action'/>";
			var vendorId = $("select[@name='gwShare_vendorId']").val();
...
<form name="gwShare_selectForm" name="gwShare_selectForm" action="<s:url value="/inmp/bss/gwDeviceQuery!queryDeviceList.action"/>"
...
<TABLE border=0 cellspacing=0 cellpadding=0 width="100%" align="center" >
	...
	<tr>
		<td bgcolor=#999999>
			...
			<table class="querytable" id="batchPart" border=0 cellspacing=1 cellpadding=2 width="100%" align="center" display="none">
				<tr  bgcolor="#FFFFFF" >
			...
			<td bgcolor=#999999 colspan="4">
							...
							<TABLE id="tb1" border=0 cellspacing=1 cellpadding=2 width="100%" class="querytable">
								...
								<TR bgcolor="#FFFFFF">
									...
									<TD align="right" class=column width="15%">宽带账号</TD>
									<TD width="35%">
