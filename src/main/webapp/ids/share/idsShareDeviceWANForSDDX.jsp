...
function idsShare_queryDevice(){
	...
	$.post(url, {idsShare_queryField : idsShare_queryField,
				 ...
				 function(ajax){
					 if("hb_lt" == area || "jl_lt" == area || "sx_lt" == area || "jx_lt" == area  || "ah_lt" == area || "zj_lt" == area){
...
function idsShare_revalue(){
	...
	$("input[@name='gwShare_queryButton']").attr("disabled", false);
	$("input[@name='idsShare_queryField']").val("1");
			...
			<table border=0 cellspacing=1 cellpadding=2 width="100%" align="center">
				...
				<tr bgcolor="#FFFFFF" id="gwShare_tr11" STYLE="display:">
					<td colspan="4" align="center" width="100%">
						<div>
							...
							<input type="hidden" name="idsShare_queryField" id="idsShare_queryField" value="1" />
							<br /> 
						</div>
					</td>
				</tr>
				<tr bgcolor="#FFFFFF" id="gwShare_tr12" STYLE="display:">
					<td colspan="4" align="center" width="100%">
						...
						<input type="radio" checked="checked" class=jianbian name="idsShare_st_queryField" value="1" onclick="idsShare_queryField_selected('1')"/> 用户宽带帐号 &nbsp;&nbsp;
						<input type="radio" class=jianbian name="idsShare_st_queryField" value="2" onclick="idsShare_queryField_selected('2')"/> LOID &nbsp;&nbsp;
					</td>
				</tr>
				<tr bgcolor="#FFFFFF">
