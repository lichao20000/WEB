...
//由于timelater.jsp已经更新了用户的访问记录，所以这边不加了

//转向到动态创建系统目录架构页
response.sendRedirect("./dynamicMenu/");
%>
...
<!--
var userPremession = "<%=session.getAttribute("ldims")%>";
//-->
</SCRIPT>
<SCRIPT LANGUAGE="JavaScript">
<!--
	...
	<tr>
	  <td height="81" valign="top" background="images/bottom_line.jpg"><div align="center">
		<table width="493" border="0" cellpadding="0" cellspacing="0" background="images/bottom_middle.jpg">
		  ...
		  <tr>
			<td height="23" class="text"><div align="center">&copy; 2008 <%=strAreaName%>.版权所有;Powered By：<a href='http://www.lianchuang.com/'>联创科技</a> </div></td>
		  </tr>
		</table>
	  </div></td>
	</tr>
