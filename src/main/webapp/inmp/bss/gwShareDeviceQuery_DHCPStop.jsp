...
function gwShare_queryDevice(){
	...
	var url="<s:url value="/inmp/share/gwDeviceQuery!queryDeviceList.action"/>?gwShare_queryResultType="+gwShare_queryResultType;
	...
	var gwShare_queryParam = $.trim($("input[@name='gwShare_queryParam']").val());
	var isBindUrl = "<s:url value='/inmp/config/netByDHCPStop!isBind.action'/>";
	if(gwShare_queryField == "deviceIp" || gwShare_queryField  == "voipPhoneNum"){
