...
function config(lanId, lanWlanId) {
	...
	var url = "<s:url value='/inmp/diagnostics/wlanACT!config.action'/>";
	$.post(url,{
...
function del(lanId, lanWlanId) {
	...
	var url = "<s:url value='/inmp/diagnostics/wlanACT!del.action'/>";
	$.post(url,{
		deviceId:deviceId.val(),
		lanId:lanId,
		lanWlanId:lanWlanId
...
function add() {
	...
	var url = "<s:url value='/inmp/diagnostics/wlanACT!add.action'/>";
	$.post(url,{
		deviceId:deviceId,
		lanId:lanId,
		ssid:ssid,
...
function edit() {
	...
	var url = "<s:url value='/inmp/diagnostics/wlanACT!edit.action'/>";
	$.post(url,{
		deviceId:deviceId,
		lanId:lanId,
		lanWlanId:lanWlanId,
				...
				<s:else>
					<s:iterator var="list" value="list" status="row">
						<TR bgcolor="#FFFFFF">
							...
							<TD align="center"><IMG SRC="../../images/inmp/edit.gif" WIDTH="14" HEIGHT="12" BORDER="0" ALT="编辑" onclick="chgForm(2,<s:property value='#list.lanId' default=''/>,<s:property value='#list.lanWlanId' default='1'/>,'<s:property value='#list.ssid' default='1'/>', '<s:property value='#list.beacontype' default='None'/>', '<s:property value='#list.wepKey' default=''/>', '<s:property value='#list.wpaKey' default=''/>')" onMouseOver="this.style.cursor='hand';">&nbsp;&nbsp;<IMG SRC="../../images/del.gif" WIDTH="14" HEIGHT="12" BORDER="0" ALT="删除"  onclick="del(<s:property value='#list.lanId' default='1'/>,<s:property value='#list.lanWlanId' default='1'/>)" onMouseOver="this.style.cursor='hand';">&nbsp;&nbsp;<IMG SRC="../../images/add.gif" WIDTH="14" HEIGHT="12" BORDER="0" ALT="添加"  onclick="chgForm(1,<s:property value='#list.lanId' default='1'/>,'','','','','')" onMouseOver="this.style.cursor='hand';"></TD>
						</TR>
					</s:iterator>
				</s:else>
			</TABLE>
