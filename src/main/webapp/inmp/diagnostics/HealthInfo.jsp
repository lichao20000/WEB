...
function editBussHtml(stv) {
	if (stv == "1") {
		...
		$("input[@name='subBtns']").attr({value:" 编辑保存 "});
	...
	$("input[@name='subBtns']").click(function(){editBuss(stv);});
	parent.dyniframesize1();
...
function editHealthHtml() {
	...
	$("input[@name='subBtns']").click(function(){editHealth();});
							...
							<tr align="left">
								 <td colspan="4" align="right" class="column">
									...
									<button name='addImg' onclick="editHealthHtml()">编辑</button>
									 -->
									<input type="button" class=jianbian value="重新采集" onclick="getWireInfoHtml()"> &nbsp;

									<input type="button" class=jianbian value="编辑" onclick="editHealthHtml()">
								</td>
							</tr>
							...
							<s:else>
								<tr align="left">
								 <td colspan="4" align="right" class="column">
									...
									<input type="button" class=jianbian value="编辑" onclick="editBussHtml(1)">
								</td>
								</tr>
							...
							<s:else>
								<tr align="left">
									 <td colspan="4" align="right" class="column">
										...
										<input type="button" class=jianbian value="编辑" onclick="editBussHtml(2)">
									</td>
								</tr>
							...
							<s:else>
								<tr align="left">
									<td colspan="4" align="right" class="column">
										...
										<input type="button" class=jianbian value="编辑" onclick="editBussHtml(3)">
									</td>
								</tr>
			...
			<TABLE border=0 cellspacing=1 cellpadding=2 width="100%" >
				...
				<TR bgcolor="#FFFFFF">
					<TD colspan="4" class="column" align="right"  >
						<input type="button" name="subBtns" class=jianbian value="" />
					</TD>
				</TR>
