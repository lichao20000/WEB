...
function EC(leaf){
	...
	if("basicInfo"==leaf){
		...
		if(m_bShow) {	
			sobj.src = "../../images/inmp/up_enabled.gif";
		}
		else{
			sobj.src = "../../images/inmp/down_enabled.gif";
		}
		...
		if(m_bShow) {
			sobj.src = "../../images/inmp/up_enabled.gif";
			var url = "<s:url value="/inmp/diagnostics/deviceInfo!getAllInfo.action"/>";
...
function detailDevice(deviceId, lanId, lanWlanId){
	var url = "<s:url value="/inmp/diagnostics/deviceInfo!getGwWlanAsso.action?deviceId="/>"+deviceId+"&lanId="+lanId+"&lanWlanId="+lanWlanId;
			...
			<table width="100%" height="30" border="0" cellspacing="0"
				...
				<tr>
					<td width="162" align="center" class="title_bigwhite" style="background:none;">
						...
						【基本信息】
						<IMG name="imgbasic" SRC="../../images/inmp/up_enabled.gif" WIDTH="7" HEIGHT="9" BORDER="0" ALT="">
						</a>
					</td>
				</tr>
			</table>
			...
			<table width="100%" height="30" border="0" cellspacing="0"
				...
				<tr>
					<td width="162" align="center" class="title_bigwhite" style="background:none;">
						...
						【业务信息】
						<IMG name="imgbussess" SRC="../../images/inmp/down_enabled.gif" WIDTH="7" HEIGHT="9" BORDER="0" ALT="">
						</a>
					</td>
				</tr>
			</table>
