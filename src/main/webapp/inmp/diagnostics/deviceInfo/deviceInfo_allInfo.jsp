			...
			<TABLE border=0 cellspacing=0 cellpadding=0 width="100%">
				<tr align="left" height="25">
					<td colspan="5" class="green_title_left">
						<a href="javascript:wideBandNet();" stytle="CURSOR:hand;">
							宽带上网 <IMG name="imgnet" SRC="../../images/inmp/up_enabled.gif"
								WIDTH="7" HEIGHT="9" BORDER="0" ALT=""> </a>
					</td>
				</tr>
		...
		<tr>
			<td>
				<tABLE border=0 cellspacing=0 cellpadding=0 width="100%">
					<tr align="left" height="25">
						<td colspan="5" class="green_title_left">
							<a href="javascript:iptvInfo();" stytle="CURSOR:hand;">
								&nbsp;&nbsp;IPTV&nbsp; <IMG name="imgiptv"
									SRC="../../images/inmp/up_enabled.gif" WIDTH="7" HEIGHT="9"
									BORDER="0" ALT=""> </a>
						</td>
					</tr>
							...
							<div id="diviptv">
								<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
									...
									<s:iterator value="iptvInfoList" var="wideNetInfo">
											...
											<s:else>
												<TD align="center">
													<s:property value="multicast_vlan" />
												</TD>
											</s:else>
											<%} %>
											<s:if
		...
		<tr>
			<td>
				<TABLE border=0 cellspacing=0 cellpadding=0 width="100%">
					<tr align="left" height="25">
						<td colspan="5" class="green_title_left">
							<a href="javascript:voipInfo();" stytle="CURSOR:hand;">
							...
							<div id="divvoip">
								...
								<s:if
									test="#wideNetInfo.ip=='N/A' || #wideNetInfo.ip=='null' ">
											...
											<s:if test="voipProtocalTypeStr=='H.248'">
												<s:if test="#wideNetInfo.media_gateway_controler=='N/A' ||  #wideNetInfo.media_gateway_controler=='null' ">
													<TD align="center">
															-
														</TD>
												</s:if>
												...
												<s:if test="#wideNetInfo.media_gateway_controler_2=='N/A' ||  #wideNetInfo.media_gateway_controler_2=='null' ">
													<TD align="center">
															-
														</TD>
												</s:if>
												...
												<s:if test="#wideNetInfo.h248_device_id=='N/A' ||  #wideNetInfo.h248_device_id=='null' ">
													<TD align="center">
															-
														</TD>
												</s:if>
												<s:else>
													<TD align="center">
															<s:property value="h248_device_id" />
														</TD>
												</s:else>
												<s:if test="#wideNetInfo.physical_term_id=='N/A' ||  #wideNetInfo.physical_term_id=='null' ">
													<TD align="center">
															-
														</TD>
												</s:if>
												<s:else>
													<TD align="center">
															<s:property value="physical_term_id" />
														</TD>
												</s:else>
											</s:if>
											<s:else>
													...
													<s:if
														test="#wideNetInfo.regist_status=='Up'">
														<TD align="center">
															已注册
														</TD>
													</s:if>
		...
		<tr>
			<td>
				<tABLE border=0 cellspacing=0 cellpadding=0 width="100%">
					<tr align="left" height="25">
						<td colspan="5" class="green_title_left">
							<a href="javascript:ponInfo();" style="CURSOR:hand;">
							...
							<s:else>
								...
								<IMG name="imgponInfo" SRC="../../images/inmp/up_enabled.gif"
									WIDTH="7" HEIGHT="9" BORDER="0" ALT=""> </a>
						</td>
					</tr>
		...
		<tr>
			<td>
				<tABLE border=0 cellspacing=0 cellpadding=0 width="100%">
					<tr align="left" height="25">
						<td colspan="5" class="green_title_left">
							<a href="javascript:wireinfoInfo();" stytle="CURSOR:hand;">
								线路信息 <IMG name="imgwireinfo" SRC="../../images/inmp/up_enabled.gif"
									WIDTH="7" HEIGHT="9" BORDER="0" ALT=""> </a>
						</td>
					</tr>
								...
								<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
									...
									<s:iterator value="wireInfoObjArr" var="wideNetInfo">
										<tr align="center" bgcolor="#FFFFFF">
											...
											<s:else>
												<TD align="center">
													<s:property value="modulationType" />
												</TD>
											</s:else>
											<s:if
											...
											<s:else>
												<TD align="center">
													<s:property value="upstreamAttenuation" />
												</TD>
											</s:else>
											<s:if
											...
											<s:else>
												<TD align="center">
													<s:property value="downstreamAttenuation" />
												</TD>
											</s:else>
											<s:if
											...
											<s:else>
												<TD align="center">
													<s:property value="upstreamMaxRate" />
												</TD>
											</s:else>
											<s:if
											...
											<s:else>
												<TD align="center">
													<s:property value="downstreamMaxRate" />
												</TD>
											</s:else>
											<s:if
											...
											<s:else>
												<TD align="center">
													<s:property value="interleaveDepth" />
												</TD>
											</s:else>
											<s:if
	...
	<tr>
		<td>
			<tABLE border=0 cellspacing=0 cellpadding=0 width="100%">
				<tr align="left" height="25">
					<td colspan="5" class="green_title_left">
						<a href="javascript:tr069Info();" stytle="CURSOR:hand;">
							管理通道信息 <IMG name="imgtr069" SRC="../../images/inmp/up_enabled.gif"
								WIDTH="7" HEIGHT="9" BORDER="0" ALT=""> </a>
					</td>
				</tr>
						...
						<div id="divtr069">
							<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
								...
								<tr align="center" bgcolor="#FFFFFF">
									...
									<s:else>
										<TD align="center">
											<s:property value="gwTr069OBJ.pvc" />
										</TD>
									</s:else>
									...
									<s:else>
										<TD align="center">
											<s:property value="gwTr069OBJ.url" />
										</TD>
									</s:else>
									<s:if
									...
									<s:else>
										<TD align="center">
											<s:property value="gwTr069OBJ.cpeUsername" />
										</TD>
									</s:else>
									<s:if
									...
									<s:else>
										<TD align="center">
											<s:property value="gwTr069OBJ.cpePasswd" />
										</TD>
									</s:else>
									<s:if
									...
									<s:else>
										<TD align="center">
											<s:property value="gwTr069OBJ.loopbackIp" />
										</TD>
									</s:else>
								</tr>
								<tr align="center" bgcolor="#FFFFFF">
									<TD align="center" colspan="5">
										<s:property value="tr069Msg" />
									</TD>
								</tr>
							</TABLE>
						</div>
	...
	<tr>
		<td>
			<tABLE border=0 cellspacing=0 cellpadding=0 width="100%">
				<tr align="left" height="25">
					<td colspan="5" class="green_title_left">
						<a href="javascript:lanInfo();" stytle="CURSOR:hand;"> LAN侧信息
							<IMG name="imglan" SRC="../../images/inmp/up_enabled.gif" WIDTH="7"
				...
				<tr align="left" id="trlan" STYLE="display: ">
					...
					<td colspan="4" bgcolor=#999999>
						<div id="divlan">
							<table border=0 cellspacing=1 cellpadding=2 width="100%">
								<tr align="center" bgcolor="#FFFFFF">
									<TD class=column align="right" nowrap width="12%">
										DHCP地址池
									</TD>
									<TD class=column align="right" nowrap width="12%">
										起始地址:
									...
									<TD class=column align="right" width="12%">
										结束地址:
									</TD>
									<TD width="32%">
										<s:if
	...
	<tr>
		<td>
			<tABLE border=0 cellspacing=0 cellpadding=0 width="100%">
				<tr align="left" height="25">
					<td colspan="5" class="green_title_left">
						<a href="javascript:wlanInfo();" stytle="CURSOR:hand;">
							WLAN侧信息 <IMG name="imgwlan" SRC="../../images/inmp/up_enabled.gif"
								WIDTH="7" HEIGHT="9" BORDER="0" ALT=""> </a>
					</td>
				</tr>
