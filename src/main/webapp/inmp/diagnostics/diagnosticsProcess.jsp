...
var iframeSrc=["<s:url value='/inmp/diagnostics/deviceInfo.action?deviceId='/>","<s:url value='/inmp/diagnostics/algACT.action?deviceId='/>","<s:url value='/inmp/diagnostics/deviceDiagnostics.action?deviceId='/>"];
...
function winNavigate(uniformid)
{
	switch (uniformid)
	{
		...
		case 4:
		{
			...
			this.trProcess.style.display="none";
			this.trAdvance.style.display="none";
			document.all("myiframe1").src = iframeHealthSrc[0]+document.all("txtdeviceId").value;
			block1();
			break;
		}
	}
...
<jsp:include page="/inmp/share/selectDeviceJs.jsp">
	...
	<TR  id="tr2"  STYLE="display:none" >
  		<TD>
			<TABLE width="100%" border=0 cellspacing=0 cellpadding=0 align="center" valign="middle">
				...
				<TR>
					<td>
						<DIV id=qh_con0 style="DISPLAY: block"  style="height: 700px; overflow:yes;position:relative;">
							<iframe id=myiframe1 src="" frameborder="0" height="100%" width="100%" onload=this.height=myiframe1.document.body.scrollHeight;></iframe>
						</DIV>
					</td>
				</TR>
			</TABLE>
