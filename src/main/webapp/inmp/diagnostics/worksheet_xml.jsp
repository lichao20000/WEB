		...
		<table border=0 cellspacing=1 cellpadding=2 width="100%" id="idTable"
            ...
            if (fields != null) {
                ...
                while (fields != null) {
					...
					if( serviceType!= null && serviceType.equals("1")){					
                    	tmp =  (String)fields.get("service_name");
	                    out.println("<td><nobr>" + tmp
	                            + "</nobr></td>"); 
	                    tmp =  (String)fields.get("oui") + "-" + (String)fields.get("device_serialnumber");
	                    out.println("<td><nobr>" + tmp
	                            + "</nobr></td>"); 
                    } else {
	                    ...
	                    out.println("<td><nobr>" + serv_typeMap.get(tmp)
	                            + "</nobr></td>");
						tmp =  (String)fields.get("oper_type_id");
					...
					out.println("<td><nobr>"
                            ...
                            + "</nobr></td>");
					tmp = (String) fields.get("fault_code");
					int fault_code=Integer.parseInt(tmp);
