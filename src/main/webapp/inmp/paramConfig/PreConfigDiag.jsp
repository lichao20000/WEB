...
<SCRIPT LANGUAGE="JavaScript">
	...
	function deviceResult(returnVal){
	    ...
	    var url = '<s:url value='/inmp/config/preConfigDiag!baseInfo.action'/>'; 
		$.post(url,{
			deviceId:deviceId,
			gw_type:gw_type
		},function(ajax){	
	...
	function wideNetconfig(accessType){
		var url = "<s:url value='/inmp/config/preConfigDiag!wideNetconfig.action'/>";
	...
	function iptvconfig(accessType){
		var url = "<s:url value='/inmp/config/preConfigDiag!iptvconfig.action'/>";
	...
	function voipconfig(accessType){
		var url = "<s:url value='/inmp/config/preConfigDiag!voipconfig.action'/>";
	...
	function qosconfig(){
		var url = "<s:url value='/inmp/config/preConfigDiag!qosconfig.action'/>";
	...
	function getStrategyById(strategyId,divName){
		var url = "<s:url value='/inmp/config/preConfigDiag!getStrategyById.action'/>";
		$.post(url,{
	...
	function getHgwcustServById(userId,divName){
		var url = "<s:url value='/inmp/config/preConfigDiag!getHgwcustServById.action'/>";
		$.post(url,{
			userId:userId
		},function(ajax){
			var s = ajax.split(";");
