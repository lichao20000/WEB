...
<script type="text/javascript" src="../../Js/inmp/jsDate/WdatePicker.js"></script>
		...
		<s:if test="devList.size()>0">
			<s:iterator value="devList">
				<tr>
					...
					<td>
						<IMG SRC="../../images/inmp/view.gif" BORDER="0" ALT="详细信息"
		...
		<tr>
			<td colspan="8">
				<span style="float: right;"> <lk:pages
						url="/inmp/itms/report/softUpResult!getDev.action" styleClass=""
