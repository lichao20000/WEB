							...
							<TD width="35%">
								<%
									...
									if ("1".equals((String) fields.get("is_chk_bind"))){
										is_chk_bind = "自动绑定验证重绑成功&nbsp;<IMG SRC='../../images/inmp/check.gif' BORDER='0' ALT='验证成功' style='cursor:hand'>";
									}else if ("2".equals((String) fields.get("is_chk_bind"))){
										is_chk_bind = "自动绑定验证成功&nbsp;<IMG SRC='../../images/inmp/check.gif' BORDER='0' ALT='验证成功' style='cursor:hand'>";
									}else{
