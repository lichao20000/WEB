							...
							<TR bgcolor="#FFFFFF">
								...
								<TD>
									<%
												...
												{
											is_chk_bind = "未验证&nbsp;<IMG SRC='../../images/inmp/button_s.gif' BORDER='0' ALT='未验证' style='cursor:hand'>";
												}
												else if ("1".equals((String) fields.get("is_chk_bind")))
												{
											is_chk_bind = "MAC绑定验证成功&nbsp;<IMG SRC='../../images/inmp/check.gif' BORDER='0' ALT='验证成功' style='cursor:hand'>";
												}
												else if ("2".equals((String) fields.get("is_chk_bind")))
												{
											is_chk_bind = "桥接账号验证成功&nbsp;<IMG SRC='../../images/inmp/check.gif' BORDER='0' ALT='验证成功' style='cursor:hand'>";
												}
									%> <%=is_chk_bind%></TD>
								<%
										}
...
<script>
	function testOnline(obj, device_id) {
		...
		var url = "<s:url value='/inmp/resource/cardInfo!getCardStatus.action'/>";
		$.post(url, {
			device_id : device_id
		}, function(ajax) {
			//alert(ajax);
