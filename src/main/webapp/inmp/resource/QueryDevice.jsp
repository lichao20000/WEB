...
<SCRIPT LANGUAGE="JavaScript" SRC="../../Js/inmp/prototype.js"></SCRIPT>
...
//}
	if(null != queryTypeValue && "简 单 查 询" == queryTypeValue){
		...
		//MAC地址
		var cpe_mc = document.frm.cpe_mc.value;
		//LOID
		var device_id_ex = document.frm.device_id_ex.value;
		// 开始时间
		var starttime = document.getElementsByName("starttime")[0].value
		
		// 以下四个参数只要有一个参数有值，就可以执行查询
		if(device_serial.length != 0 || loopback_ip.length != 0 || cpe_mc.length != 0 || device_id_ex.length != 0){
...
function initDate()
{
	...
	endtimetemp = theday.getFullYear()+"-" + month + "-" + day + " " + hour +":"+ mimute +":" + second;
	//alert("444");
}
						...
						<TD bgcolor=#999999>
							<TABLE border=0 cellspacing=1 cellpadding=2 width="100%"
								...
								<TR id="args2" STYLE="display:none">
									...
									<TD bgcolor="#ffffff" align="left" height="23">
										<input type="text" value="" name="device_id_ex" class="bk">
										<font color="red">*</font>
									</TD>
								</TR>
							...
							strUserDomains-->
									...
									<TD bgcolor="#ffffff" align="left" height="23"><%=strDevTypeList%></TD>
								</TR>
								...
								<TR>
									<TD class="column" align="right" height="23" colspan=4>
										...
										<input type=submit name="queryBtn" class=jianbian value=" 查 询 ">&nbsp; 
