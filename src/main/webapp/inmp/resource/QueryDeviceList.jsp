...
if (fields == null) {
    ...
    while (fields != null) {
       ...
       // strData += "<TR><TD class=column2 align='center'><input type=checkbox name=chkCheck value='"+ device_id +"'></TD>";
		...
		if("1".equals(device_status)){
			...
			strOper = "&nbsp;&nbsp;<a href=javascript:// onclick=\""+ StringUtils.replace(detailStr,"?",device_id) +"\"><IMG SRC='../../images/inmp/view.gif' BORDER='0' ALT='详细信息' style='cursor:hand'></a>";
			...
			strOper = "&nbsp;&nbsp;<a href='#' onclick=\""+ StringUtils.replace(detailStr,"?",device_id) +"\"><IMG SRC='../../images/inmp/view.gif' BORDER='0' ALT='详细信息' style='cursor:hand'></a>";
			strOper += "&nbsp;&nbsp;<a href=javascript:// onclick=\""+ StringUtils.replace(confirmStr,"?",device_id) +"\"><IMG SRC='../../images/inmp/check1.gif' BORDER='0' ALT='确认设备' style='cursor:hand'></a>";
		}
	...
	if("1".equals(LipossGlobals.getLipossProperty("isReport"))){
		strData += "<TR><TD class=green_foot COLSPAN=10><a href=\""+prt_Page+"\" alt=\"导出当前页数据到Excel中\"><IMG SRC='../../images/inmp/excel.gif' BORDER='0' ALT='导出列表' style='cursor:hand'></a></TD></TR>";
	}
}
%>
...
<link rel="stylesheet" href="../../css/inmp/css/listview.css" type="text/css">
