...
<script type="text/javascript">
	...
	function query() {
		...
		var url = '<s:url value='/inmp/resource/UserSpecTerminals!getUserSpecTerminals.action'/>'; 
		$.post(url,{
			spec_id:spec_id,
			city_id:city_id,
	...
	function doQuery(spec_id,cityId,startOpenDate,endOpenDate) {
		var page = "<s:url value='/inmp/resource/UserSpecTerminals!getTerminalSpecList.action'/>?"
				+ "city_id="
				+ cityId
				+ "&startOpenDate="
				+ startOpenDate
	...
	function ToCityExcel(spec_id,cityId,startOpenDate,endOpenDate){
		...
		mainForm.action = "<s:url value='/inmp/resource/UserSpecTerminals!getCityExcel.action' />";
		mainForm.submit();
		mainForm.action = "<s:url value='/inmp/resource/UserSpecTerminals!getUserSpecTerminals.action' />";
	}
</script>
</head>
...
<body>
	<form id="form" name="selectForm" id="selectForm"
		action="<s:url value='/inmp/resource/UserSpecTerminals!getUserSpecTerminals.action'/>">
		...
		<table>
				...
				<td>
					<table width="100%" height="30" border="0" cellspacing="0"
						...
						<tr>
							...
							<td nowrap>
								<img src="<s:url value="../../images/inmp/attention_2.gif"/>"
					...
					<table class="querytable">
						...
						<TR bgcolor="#FFFFFF">
							<td align="right" colspan="4"  class="green_foot" width="100%">
								<input type="button" onclick="query()" class=jianbian value="查 询" style="margin-left: 1183" />
							</td>
						</TR>
					</table>
				</td>
			...
			<tr>
				<td id="dataTd"><iframe id="dataForm" name="dataForm" height="1000" frameborder="0" scrolling="no" width="100%" src=""></iframe>
				</td>
			</tr>
		</table>
		<br>
