...
<SCRIPT LANGUAGE="JavaScript" SRC="<s:url value="../../Js/inmp/prototype.js"/>"></SCRIPT>
...
<SCRIPT LANGUAGE="JavaScript"
	SRC="<s:url value="../../Js/inmp/CheckFormForm.js"/>"></SCRIPT>
...
function getDeviceInfo(){
	...
	var url = "<s:url value='/inmp/resource/updateDevCityByIP!getDeviceInfo.action'/>";
	if(deviceSN=="至少最后6位"){
		deviceSN="";
	}
	if(loopbackIp=="完整IP"){
...
function getUserinstInfo(){
	...
	var device_serialnumber = $.trim(document.frm.device_serialnumber.value);
	var loopbackIp = $.trim(document.frm.loopbackIp.value);
	var url = "<s:url value='/inmp/resource/itmsInst!getDeviceInfo.action'/>";
	if(device_serialnumber=="至少最后6位"){
		device_serialnumber="";
	}
	if(loopbackIp=="完整IP"){
...
function updateCity(){
	...
	document.frm.action="<s:url value='/inmp/resource/updateDevCityByIP!updateCity.action'/>";
	document.frm.submit();
}
...
function nextstep(){
	...
	var url = "<s:url value='/inmp/resource/itmsInst!getInstUserInfo.action'/>";
	$.post(url,{
		userName:userName,
		nameType:nameType,
		gw_type:gw_type
