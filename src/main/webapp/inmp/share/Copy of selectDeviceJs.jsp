...
function deviceSelect_change_select(type){
	...
	if("vendor"==type){
		...
		var url = "/inmp/share/selectDeviceTag!getDeviceModel.action";
		$.post(url,{
			vendor_id:vendor_id
		},function(ajax){
	...
	//根据型号查询设备版本
	if("model"==type){
		var url = "/inmp/share/selectDeviceTag!getVersion.action";
		$.post(url,{
			vendor_id:vendor_id,
...
function deviceSelect_relateDeviceByUsername(){
	...
	var url = "/inmp/share/selectDeviceTag!getDeviceByUsername.action";
	$.post(url,{
...
function deviceSelect_relateDeviceByVOIPNum(){
	...
	var url = "/inmp/share/selectDeviceTag!getDeviceByVoipTelNum.action";
	$.post(url,{
		select_type:select_type,
		voipPara:voipPara,
		selectType:selectType,
...
function deviceSelect_relateDeviceByItvUserName(){
	...
	var url = "/inmp/share/selectDeviceTag!getDeviceByITVUserName.action";
	$.post(url,{
		select_type:select_type,
...
function deviceSelect_relateDeviceByWideNet(){
	...
	var url = "/inmp/share/selectDeviceTag!getDeviceByWideAccount.action";
	$.post(url,{
		select_type:select_type,
...
function deviceSelect_relateDeviceBySerialno(){
	...
	var url = "/inmp/share/selectDeviceTag!getDeviceBySerialno.action";
	$.post(url,{
		select_type:select_type,
...
function deviceSelect_relateDeviceBySenior(){
	...
	var url = "/inmp/share/selectDeviceTag!getDeviceByCity.action";
	$.post(url,{
		city_id:city_id,
		office_id:office_id,
		select_type:select_type,
...
//加载URL
var deviceSelect_url = "/inmp/share/selectDeviceTag!reload.action";
