	...
	<TR>
		...
		<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
			<TR bgcolor="#FFFFFF" STYLE="display: ">
				...
				<TD align="left" width="85%" colspan="3"><label
					STYLE="display:<s:property value="byDevicenoState" />"><input
					type="radio" value="2"
					onclick="deviceSelect_ShowDialog(this.value)" name="checkType"
					<s:property value="byDevicenoChecked"/>>按设备&nbsp;</label> <label
					STYLE="display:<s:property value="byUsernameState" />"><input
					type="radio" value="1"
					onclick="deviceSelect_ShowDialog(this.value)" name="checkType"
					<s:property value="byUsernameChecked"/>>按用户</label> <label
					STYLE="display:<s:property value="byCityState" />"><input
					type="radio" value="0"
					onclick="deviceSelect_ShowDialog(this.value)" name="checkType"
					<s:property value="byCityChecked"/>>高级查询</label> <label
					STYLE="display:<s:property value="byImportState" />"><input
					type="radio" value="3"
					onclick="deviceSelect_ShowDialog(this.value)" name="checkType"
					<s:property value="byImportChecked"/>>按文件导入</label> <label
					STYLE="display:<s:property value="byItvState" />"><input
					type="radio" value="5"
					onclick="deviceSelect_ShowDialog(this.value)" name="checkType"
					<s:property value="byItvChecked"/>>按iTV</label> <label
					STYLE="display:<s:property value="byNetAccountState" />"><input
					type="radio" value="6"
					onclick="deviceSelect_ShowDialog(this.value)" name="checkType"
					<s:property value="byNetAccountChecked"/>>按宽带帐号</label> <!-- 宁夏要求 按VOIP电话号码查询 dd by zhangchy 2012-02-21 -->
				<label STYLE="display:<s:property value="byVOIPState" />"><input
					type="radio" value="4"
					onclick="deviceSelect_ShowDialog(this.value)" name="checkType"
					<s:property value="byVOIPChecked"/>>按VOIP电话号码</label></TD>
			</TR>
			...
			<TR bgcolor="#FFFFFF" id="tr14"
				...
				<TD width="35%"><input type="text" name="loopback_ip" value=""
					class="bk" /></TD>
				<TD align="center" width="50%" colspan="2"><input type="button"
			...
			<TR bgcolor="#FFFFFF" id="tr31"
				...
				<TD align="right" width="15%">设 备 IP</TD>
				<TD width="35%"><input type="text" name="loopback_ip_" value=""
					class="bk" /> <input type="button" class=jianbian value=" 查  询 "
