						...
						<td>
							<form id="form">
								...
								<table width="100%" height="30" border="0" cellspacing="0" cellpadding="0" >
									<tr>
										<td align="left" class=column width="20%">本Filters标签所代表的白名单的版本号<input
										...
										<TABLE id="table_showConfig" width="100%" border=0 cellspacing=0 cellpadding=0 align="center" class="querytable">
											<tr>
												<td align="right">
													...
													<button type="button" id="doAdd" class=btn>增加Filter</button>
												</td>
											</tr>
											<tr bgcolor="#FFFFFF">
												<td colspan="4">
										...
										<TABLE id="table_showConfig" width="100%" border=0 cellspacing=0 cellpadding=0 align="center" class="querytable">
											<tr>
												<td align="right">
													...
													<button type="button" id="doAddButton<s:property value='#rtl.index'/>" class=btn>增加Filter
														</button>
												</td>
											</tr>
											<tr bgcolor="#FFFFFF">
															...
															<div id="paramAddDiv<s:property value='#rtl.index'/>" class="paramAddDiv">
																<table border=0 cellspacing=1 cellpadding=2 width="100%">
																	<TR bgcolor="#FFFFFF">
																		<td nowrap align="right" class=column width="20%">
																			<span>
																					<button type="button" id="delete" name="delete" class=btn>删除Filter</button>
																			</span>本白名单所包含的目标地址
																		</td>
																		<td width="70%" colspan="1">
