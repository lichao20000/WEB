											...
											<table class="listtable" id="listTable">
												...
												<tfoot>
													<tr>
														...
														<lk:pages
																url="/intelspeaker/intelSpeakerConfigMgrAction!listHistory.action?type=2" styleClass=""
...
$(document).ready(function(){
	$(".viewbtn").bind('click',function(){
		var viewurl='<s:url value="/intelspeaker/intelSpeakerConfigMgrAction!queryOneVersion.action?type=2&version="/>'+$(this).attr("ver");
		window.open(viewurl,"_blanket","","");
	})	
	$(".downloadbtn").bind('click',function(){
		var downloadUrl='<s:url value="/intelspeaker/intelSpeakerConfigMgrAction!downloadOneVerFile.action?type=2&version="/>'+$(this).attr("ver");
