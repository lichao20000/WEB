	...
	<TR id=tr1 style="display: none">
		...
		<table id="changeConnType" border=0 cellspacing=1 cellpadding=2
			...
			<tr bgcolor="#FFFFFF" id="line1" style="display: ">
				...
				<td><input type="text" name="routePasswd" class="bk" value="" style="display: none">
				&nbsp;&nbsp; <font color=red style="display: none">*</font></td>
			</tr>
			<tr bgcolor="#FFFFFF" id="line2" style="display:none ">
