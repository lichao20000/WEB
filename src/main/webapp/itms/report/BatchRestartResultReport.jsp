...
function doQuery(){
    ...
    var url = '<s:url value='/itms/report/batchRestartResult!countAll.action'/>'; 
	$.post(url,{
		cityId:cityId,
		starttime:starttime,
		endtime:endtime
...
function ToExcel(cityId,starttime,endtime) {
	var page="<s:url value='/itms/report/batchRestartResult!countAllExcel.action'/>?"
		+ "cityId=" + cityId
		+ "&starttime=" + starttime
		+ "&endtime=" + endtime;
...
function detail(flag, cityId, starttime, endtime){
	
	var page="<s:url value='/itms/report/batchRestartResult!getDetail.action'/>?"+
		"cityId="+cityId+"&flag="+flag+"&starttime=" + starttime +"&endtime="+endtime;
