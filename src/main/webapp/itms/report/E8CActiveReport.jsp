...
function doQuery(){
    ...
    var url = '<s:url value='/itms/report/E8CActiveReport!getE8CData.action'/>'; 
	$.post(url,{
		cityId:cityId,
		isActive:isActive,
...
// 		+ "&cityId=" + cityId;
	...
	mainForm.action = "<s:url value='/itms/report/E8CActiveReport!getCityExcel.action'/>";
	mainForm.submit();
	mainForm.action = "";
...
function openCus(cityId,isActive,starttime1,endtime1,type){
	...
	var page="<s:url value='/itms/report/E8CActiveReport!getCustomerList.action'/>?"
		+ "cityId=" + cityId 
...
function countBycityId(cityId,usertype,starttime1,endtime1){
    $("tr[@id='trData']").show();
    $("div[@id='QueryData']").html("正在统计，请稍等....");
    var url = '<s:url value='/itms/report/getBindRateByCityid!getBindRateByCityid.action'/>'; 
	$.post(url,{
		cityId:cityId,
		usertype:usertype,
