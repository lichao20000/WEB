...
function doQuery(){
    ...
    var url = '<s:url value='/itms/report/PVCDeploymentReport!packagePvc.action'/>'; 
	$.post(url,{
		cityId:cityId,
		starttime:starttime,
		endtime:endtime
...
function ToExcel() {
	var page="<s:url value='/itms/report/PVCDeploymentReport!getPackageExcel.action'/>?"
...
function openHgw(cityId,starttime1,endtime1,flag,isAll){
	var page="<s:url value='/itms/report/PVCDeploymentReport!getPackageHgw.action'/>?"
		+ "cityId=" + cityId 
				...
				<tr>
					...
					<td>
						<img src="<s:url value="/images/attention_2.gif"/>" width="15"
							height="12">
						针对使用尊享e家套餐的IPTV用户；查询时间为iTV账户生效时间。
					</td>
				</tr>
			</table>
		</td>
				...
				<table width="100%" border="0" cellspacing="1" cellpadding="2"
					...
					<tr bgcolor=#ffffff>
						<td class=column colspan=4 align=right>
							<input type="button" value=" 统 计 " name="button" onclick="doQuery()"
								class="jianbian">
						</td>
					</tr>
				</table>
