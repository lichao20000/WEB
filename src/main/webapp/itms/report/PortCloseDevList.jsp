	...
	function ToExcel() {
		...
		if(countNum>100000){
			...
			if(choice==true){
				...
				var page="<s:url value='/itms/report/portCloseCount!reportDevListExcel.action'/>"+"?city_id="+city_id+"&&type="+type;
		...
		<tfoot>
			<tr>
				<td colspan="10" align="right">
					<lk:pages url="/itms/report/portCloseCount!queryDevList.action" styleClass=""
