...
function doQuery(){
    ...
    var url = '<s:url value='/itms/report/bindWay.action'/>'; 
	$.post(url,{
		cityId:cityId,
		starttime:starttime,
		endtime:endtime
...
function ToExcel(cityId) {
	var page="<s:url value='/itms/report/bindWay!getExcel.action'/>?"
...
function openHgw(cityId,starttime1,endtime1,userTypeId,userline,isChkBind){
	var page="<s:url value='/itms/report/bindWay!getHgw.action'/>?"
		+ "cityId=" + cityId 
