			...
			<s:iterator value="data" var="map1">
				<tr>
					<td align="center">
						...
						<a href="javascript:countBycityId('<s:property value="cityId"/>','<s:property value="starttime"/>','<s:property value="endtime"/>','<s:property value="gwType"/>');">
					...
					<td align="center">
						<a href="javascript:openHgw('<s:property value="cityId"/>','<s:property value="starttime1"/>',
						   				...
						   				<s:property value="broadbandSucRate" /> </a>
					</td>
					<td align="center">
						<a href="javascript:openHgw('<s:property value="cityId"/>','<s:property value="starttime1"/>',
					...
					<td align="center">
						<a href="javascript:openHgw('<s:property value="cityId"/>','<s:property value="starttime1"/>',
										...
										<s:property value="voipSucRate" /> </a>
					</td>
					<td align="center">
						<a href="javascript:openHgw('<s:property value="cityId"/>','<s:property value="starttime1"/>',
													'<s:property value="endtime1"/>','-1','<s:property value="gwType"/>')">
										<s:property value="totalSucRate" /> </a>
					</td>
				</tr>
			</s:iterator>
		</tbody>
