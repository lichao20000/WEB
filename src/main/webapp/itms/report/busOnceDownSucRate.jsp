...
function doQuery(){
    ...
    var url = '<s:url value='/itms/report/busOnceDownSucRate!queryList.action'/>'; 
	$.post(url,{
		cityId:cityId,
		starttime:starttime,
		endtime:endtime,
...
function ToExcel(cityId,starttime1,endtime1,gwType) {
	var page="<s:url value='/itms/report/busOnceDownSucRate!getAllResultExcel.action'/>?"
		+ "cityId=" + cityId
...
function openHgw(cityId, starttime1, endtime1,servTypeId,gwType){
  
	var page="<s:url value='/itms/report/busOnceDownSucRate!getServInfoDetail.action'/>?";
	var url = page
			+ "cityId=" + cityId 
			+ "&starttime1=" +starttime1 
			+ "&endtime1=" +endtime1
