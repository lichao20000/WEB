...
function ToExcel(cityId,starttime1,endtime1,gwType) {
	var page="<s:url value='/itms/report/busOnceDownSucACTSxlt!getAllResultExcel.action'/>?"
		+ "cityId=" + cityId
...
function openHgw(cityId, starttime1, endtime1,servTypeId,gwType,openStatus){
	...
	var page="<s:url value='/itms/report/busOnceDownSucACTSxlt!getServInfoDetail.action'/>?";
	var url = page
			+ "cityId=" + cityId 
			+ "&starttime1=" +starttime1 
			+ "&endtime1=" +endtime1
