...
function ListToExcel(cityId,starttime1,endtime1,servTypeId,gwType) {
	var page="<s:url value='/itms/report/busOnceDownSucRate!getServInfoExcel.action'/>?"
		+ "&cityId=" + cityId 
		...
		<tr>
			<td colspan="10">
				<span style="float: right;"> <lk:pages
						url="/itms/report/busOnceDownSucRate!getServInfoDetail.action" styleClass=""
