...
function ToExcel(cityId,usertype,starttime1,endtime1) {
	var page="<s:url value='/itms/report/getBindRateByCityid!getBindRateByCityidExcel.action'/>?"
...
function openHgw(cityId,starttime1,endtime1,flag,usertype){
	var page="<s:url value='/itms/report/getBindRateByCityid!getUser.action'/>?"
		+ "cityId=" + cityId 
		+ "&starttime1=" +starttime1
		+ "&endtime1=" +endtime1
		+ "&bind_flag=" +flag
