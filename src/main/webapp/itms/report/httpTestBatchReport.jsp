...
function queryhttpTestBatch(){
	document.selectForm.action = "<s:url value='/itms/report/httpTestBatch!qryHttpTestList.action'/>";
...
function toExcel(){
	...
	var page = "<s:url value='/itms/report/httpTestBatch!qryExcel.action'/>?"
			+ "&startTime="
			+ startTime
			+ "&cityId="
			+ city_id
...
function detail(cityId,type) {
	...
	var startTime =  selectForm.startTime.value;
	var endTime =  selectForm.endTime.value;
	var strpage = "<s:url value='/itms/report/httpTestBatch!qryDetail.action'/>?cityId="
			+ cityId
			+ "&type="+type
	        + "&startTime="
	        + startTime
...
<body>
<form name="selectForm" action="<s:url value="/itms/report/httpTestBatch!queryHttpTestList.action"/>" target="dataForm">
...
<TABLE width="98%" class="querytable" align="center">
	<tr><th colspan="4" id="thTitle" class="title_1">高带宽测速信息查询</th></tr>
	<TR id="tr21" STYLE="display:">
		<TD width="10%"  class="title_2">属地</TD>
		<TD width="40%">
		...
		<%-- <TD width="10%"  class="title_2">统计口径</TD>
		<TD width="40%">
			<select name="statCaliber" id="statCaliber" class="bk">
			<option value="-1">===请选择统计口径===</option>
			<option value="0">全部</option>
			<option value="1">网厅</option>
			<option value="6">预处理</option>
			</select>
		</TD> --%>
	</TR>
	
	<TR id="tr22" STYLE="display:">
		<TD width="10%"  class="title_2">测试开始时间</TD>
		<TD width="40%">
		...
		<TD width="10%" class="title_2" >测速结束时间</TD>
		<TD width="40%">
	...
	<tr align="right">
		<td colspan="4" class="foot" align="right">
			<div class="right">
				<button align="right" onclick="javascript:queryhttpTestBatch()"> 查 询 </button>
			</div>
		</td>
	</tr>
</TABLE>
