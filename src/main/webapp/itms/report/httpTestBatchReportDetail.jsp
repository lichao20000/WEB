...
<script type="text/javascript">
function ToExcel(){
	var page="<s:url value='/itms/report/httpTestBatch!getDetailExcel.action'/>"
		...
		<tfoot>
			<tr>
				<td colspan="12" align="right"><lk:pages
						url="/itms/report/httpTestBatch!qryDetailNext.action" styleClass=""
