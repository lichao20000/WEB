...
function doQuery(){
    ...
    var url = '<s:url value='/itms/report/netAccSpeedAction!countAll.action'/>'; 
	$.post(url,{
		cityId:cityId,
		starttime:starttime,
		endtime:endtime
...
function ToExcel(cityId,starttime1,endtime1) {
	var page="<s:url value='/itms/report/netAccSpeedAction!getAllExcel.action'/>?"
		+ "cityId=" + cityId
...
function openHgw(bindFlag, cityId, starttime1, endtime1){
	...
	var  page="<s:url value='/itms/report/netAccSpeedAction!getList.action'/>?"
			+ "bindFlag=" + bindFlag 
			+ "&cityId=" + cityId 
			+ "&starttime1=" +starttime1
			+ "&endtime1=" +endtime1;
