...
<script type="text/javascript">
	function query() {
		...
		var url = "<s:url value='/itms/report/tianyiStoreBusinessQuery!countTianyiStoreBusiness.action' />";
	...
	function countBycityId(city_id, userType) {
		$("tr[@id='trData']").show();
	...
	function openDevForWbdTerminal(city_id, userType) {
		var startOpenDate = $.trim($("input[@name='startOpenDate']").val());
		var endOpenDate = $.trim($("input[@name='endOpenDate']").val());
		var page = "<s:url value='/itms/report/tianyiStoreBusinessQuery!getDevListForWbdTerminal.action'/>?"
				+ "city_id="
				+ city_id
				+ "&startOpenDate="
				+ startOpenDate
	...
	function ToExcel(city_id, userType) {
		var startOpenDate = $.trim($("input[@name='startOpenDate']").val());
		var endOpenDate = $.trim($("input[@name='endOpenDate']").val());
		var page = "<s:url value='/itms/report/tianyiStoreBusinessQuery!getExcel.action'/>?"
				+ "city_id="
				+ city_id
				+ "&startOpenDate="
				+ startOpenDate
