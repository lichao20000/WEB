...
function query(){
	...
	form.action = "<s:url value='/itms/resource/batchSetTempManaACT!queryList.action'/>";
	form.submit();
	dyniframesize();
}
...
<TABLE border=0 cellspacing=0 cellpadding=0 width="100%">
	...
	<TR>
		...
		<table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="green_gargtd">
			<tr>
				<td width="162"> <div align="center" class="title_bigwhite">批量参数下发任务查询</div> </td>
		...
		<TABLE border=0 cellspacing=0 cellpadding=0 width="98%" align="center">
			<tr>
				...
				<table border=0 cellspacing=1 cellpadding=2 width="100%"
						align="center">
					<tr>
						<th colspan="4" id="gwShare_thTitle">批量参数下发任务查询</th>
					</tr>
					<tr bgcolor="#FFFFFF">
						...
						<tr bgcolor="#FFFFFF">
												...
												<td align="left" width="30%">
													<input type="text"   name="expire_time_start" readonly value="<s:property value='starttime'/>" class=bk >
												...
												<td align="left" width="30%">
													<input type="text"  name="expire_time_end" readonly value="<s:property value='endtime'/>" class=bk >
														<img name="shortDateimg"
