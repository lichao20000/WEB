...
<html>
	<head>
		...
		<title>BSS终端规格与实际终端规格不一致比对</title>
		<%
			 /**
			 * BSS终端规格与实际终端规格不一致比对
			 * 
...
$(window).resize(function(){
	...
	<body>
		<form id="form" name="selectForm" action="<s:url value='/itms/resource/BssSpecRealInfo!getBssSpecRealInfo.action'/>"
			target="dataForm">
					...
					<table class="green_gargtd">
						<tr>
							...
							<td><img src="<s:url value="/images/attention_2.gif"/>"
								width="15" height="12" /> 全部为必填项<font color="red">*</font></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td>
					<table class="querytable">
						...
						<TR>
							<th colspan="4">BSS终端规格与实际终端规格查询</th>
						</tr>
						<TR>
						...
						<TR>
							...
							<TD width="35%"><SELECT id="cust_type_id"
								name="cust_type_id" onchange="changeCust()">
									<option selected value="0">==请选择==</option>
									<option value="1">家庭客户</option>
									<option value="2">政企客户</option>
							</SELECT> &nbsp; <font color="red">*</font></TD>
							<TD class=column width="15%" align='right'>BSS终端规格</TD>
							<TD width="35%"><select name="spec_id" id="spec_id"
								disabled="true">
