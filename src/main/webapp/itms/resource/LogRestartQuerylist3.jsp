...
<script type="text/javascript"
	...
	<script type="text/javascript">
	function unDoneNumExcel(unDoneNum,add_time,task_name,type)
	{
	
		var page="<s:url value='/itms/resource/LogRestartQuery!unexecuteExcel.action'/>?"
			+"&unDoneNum="+unDoneNum
			+"&add_time="+add_time
			+"&task_name="+task_name			
			+"&type="+type;
...
<img alt="导出表格" src="<%=absPath%>/images/excel.gif" border="0" style='cursor: hand' onclick="unDoneNumExcel( '<s:property value="unDoneNum"/>','<s:property value="add_time"/>','<s:property value="task_name"/>','<s:property value="type" />')"> 
</td>
<td colspan="6" align="right">
<lk:pages url="itms/resource/LogRestartQuery!unDoneNum.action" 
