...
<script type="text/javascript">
	function SUMExcel(add_time,task_name)
	{
		...
		var page="<s:url value='/itms/resource/QueryBatchModifyTerminal!sunExcel.action'/>?"								
			+"&add_time="+add_time
			+"&task_name="+task_name;
	...
	{
		var page="<s:url value='/itms/resource/QueryBatchModifyTerminal!Detailed.action'/>?"								
			+"&add_time="+add_time
			+"&task_name="+task_name;
		document.all("childFrm").src=page;
	}
