...
<script type="text/javascript">
	...
	function ToExcel() {
		...
		mainForm.action = "<s:url value='/itms/resource/TerminalE8CInfo!getTerminalE8CInfoExcel.action'/>"
		mainForm.submit();
		mainForm.action = "<s:url value='/itms/resource/TerminalE8CInfo!getTerminalE8CInfo.action'/>"
	}
...
<body>
	<form id="form" name="selectForm"
		action="<s:url value='/itms/resource/TerminalE8CInfo!getTerminalE8CInfo.action'/>"
		target="dataForm">
		<table>
			<tr>
				<td HEIGHT=20>&nbsp;</td>
