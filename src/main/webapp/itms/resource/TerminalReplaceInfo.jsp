...
<script type="text/javascript">
	...
	function ToExcel() {
		...
		mainForm.action = "<s:url value='/itms/resource/TerminalReplaceInfo!getTerminalReplaceInfoExcel.action'/>"
		mainForm.submit();
		mainForm.action = "<s:url value='/itms/resource/TerminalReplaceInfo!getTerminalReplaceInfo.action'/>"
	}
...
<body>
	<form id="form" name="selectForm"
		action="<s:url value='/itms/resource/TerminalReplaceInfo!getTerminalReplaceInfo.action'/>"
		target="dataForm">
		<table>
			<tr>
				<td HEIGHT=20>&nbsp;</td>
