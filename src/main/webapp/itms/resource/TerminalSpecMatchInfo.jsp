...
<script type="text/javascript">
	...
	function ToExcel() {
		...
		mainForm.action = "<s:url value='/itms/resource/TerminalSpecMatchInfo!getTerminalSpecMatchInfoExcel.action'/>"
		mainForm.submit();
		mainForm.action = "<s:url value='/itms/resource/TerminalSpecMatchInfo!getTerminalSpecMatchInfo.action'/>"
	}
...
<body>
	<form id="form" name="selectForm"
		action="<s:url value='/itms/resource/TerminalSpecMatchInfo!getTerminalSpecMatchInfo.action'/>"
		target="dataForm">
		<table>
			<tr>
				<td HEIGHT=20>&nbsp;</td>
