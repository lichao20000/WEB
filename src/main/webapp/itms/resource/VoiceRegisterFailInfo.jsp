...
<script type="text/javascript">
	...
	function query() {
	    ...
	    var url = "<s:url value='/itms/resource/VoiceRegisterFailQuery!voiceRegisterFailQueryInfo.action' />";
	    $.post(url,{
	    	city_id:cityId,
	...
	function openCity(city_id,line_id){
	    var startOpenDate = $.trim($("input[@name='startOpenDate']").val());
	    var endOpenDate = $.trim($("input[@name='endOpenDate']").val());
		var page="<s:url value='/itms/resource/VoiceRegisterFailQuery!voiceRegisterFailDevQueryInfo.action'/>?"
				+ "city_id=" + city_id+"&startOpenDate="+startOpenDate+"&endOpenDate=" +endOpenDate+"&line_id="+line_id;
		window.open(page,"","left=50,top=50,height=550,width=900,toolbar=no,menubar=no,location=no,resizable=yes scrollbars=yes");
	}
	
	function ToExcel(){
		var mainForm = document.getElementById("selectForm");
		mainForm.action = "<s:url value='/itms/resource/VoiceRegisterFailQuery!voiceRegisterFailQueryExcel.action'/>";
		mainForm.submit();
		mainForm.action = "<s:url value='/itms/resource/VoiceRegisterFailQuery!voiceRegisterFailQueryInfo.action'/>";
	}
...
<body>
	<form id="form" name="selectForm"
		action="<s:url value='/itms/resource/VoiceRegisterFailQuery!voiceRegisterFailQueryInfo.action'/>">
		<table>
			<tr>
				<td HEIGHT=20>&nbsp;</td>
			</tr>
