...
<script type="text/javascript">
	function doQuery() {
		...
		barScript.src = "../../Js/echarts/devChangeBycity.js";
		document.body.appendChild(barScript);
	}

	function exportDetail() {
		var form = document.getElementById("frm");
		form.action = "<s:url value='/itms/resource/devWriteOffRate!parseChangeDetail.action'/>";
		form.submit();
	}

	function exportAllDetail() {
		var form = document.getElementById("frm");
		form.action = "<s:url value='/itms/resource/devWriteOffRate!parseChangeAllDetail.action'/>";
		form.submit();
	}

	function exportReport() {
		var form = document.getElementById("frm");
		form.action = "<s:url value='/itms/resource/devWriteOffRate!parseChangeExcel.action'/>";
		form.submit();
	}
</script>
</head>
	...
	<div class="it_main">
		...
		<div class="search-container">
			<form name="frm" id="frm">
				...
				<div class="search-item">
					<div class="search-label">更换设备时间：</div>
					<div class="search-con">
		...
		<div class="chart-container">
			...
			<div id="toExcel" class="chart-toolbar" style="display: none;">
				<a href="javascript:void(0);" onclick="exportReport()"><i
					class="iconstyle icon-excel">&nbsp;</i>导出报表</a>
				<!-- &nbsp;&nbsp;|&nbsp;&nbsp;
				<a href="javascript:void(0);" onclick="exportDetail()"
					display="none"><i class="iconstyle icon-excel">&nbsp;</i>导出不规范更换清单</a> -->
				&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:void(0);"
					onclick="exportAllDetail()"><i class="iconstyle icon-excel">&nbsp;</i>导出更换清单</a>
			</div>
		</div>
	</div>
