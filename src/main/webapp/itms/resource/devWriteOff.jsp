...
<script type="text/javascript">
	function doQuery() {
		...
		barScript.src = "../../Js/echarts/devWriteOffBycity.js";
		document.body.appendChild(barScript);
	}

	function exportDetail() {
		var form = document.getElementById("frm");
		form.action = "<s:url value='/itms/resource/devWriteOffRate!parseDetail.action'/>";
		form.submit();
	}

	function exportReport() {
		var form = document.getElementById("frm");
		form.action = "<s:url value='/itms/resource/devWriteOffRate!parseExcel.action'/>";
		form.submit();
	}
</script>
</head>
		...
		<h3 class="main-ttl">
			...
			<div class="search-container">
				<form name="frm" id="frm">
					...
					<div class="search-item">
						<div class="search-label">核销时间：</div>
						<div class="search-con">
					...
					<div class="search-item">
						<div class="search-label">核销方式：</div>
						<div class="search-con">
							<select class="select" name="writeOffType" style="width: 85px;">
			...
			<div class="chart-container">
				...
				<div id="toExcel" class="chart-toolbar" style="display: none;">
					<a href="javascript:void(0);" onclick="exportReport()"><i
						class="iconstyle icon-excel">&nbsp;</i>导出报表</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
						href="javascript:void(0);" onclick="exportDetail()"><i
						class="iconstyle icon-excel">&nbsp;</i>导出清单</a>
				</div>
			</div>
	</div>
