				...
				<s:iterator value="dataList">
						<tr>
							...
							<s:if test='%{userName=="admin" || userName=="szxadmin"}'>
								<a href="javaScript:editOUI('<s:property value='id'/>','<s:property value="vendor_name" />','<s:property value="oui" />','<s:property value="vendor_add" />','<s:property value="remark" />','2','<s:property value="deviceModel" />','<s:property value="deviceType" />');" >编辑</a>|
