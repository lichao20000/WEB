					...
					<TR bgcolor="#FFFFFF" id="gwShare_tr21" STYLE="">
						...
						<TD align="left" width="35%">
							...
							name="access_style_relay_id" class="bk" 
								value= "<s:property value='modifyVersion.is_check'  />">
						...
						<TD width="35%" nowrap><s:select list="devTypeMap" name="rela_dev_type"
									headerKey="-1" headerValue="<s:property value='modifyVersion.is_check'  />" listKey="type_id"
					 ...
					 <TR bgcolor="#FFFFFF" id="gwShare_tr21" STYLE="">
						...
						<TD align="left" width="35%"><select
							name="access_style_relay_id" class="bk" value= "<s:property value='modifyVersion.is_check'  />">
							<option value="-1">==请选择==</option>
							<option value="1">ADSL</option>
							<option value="2">LAN</option>
							<option value="3">EPON光纤</option>
