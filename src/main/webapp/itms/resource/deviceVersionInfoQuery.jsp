...
function queryDevice()
{
	...
	// 普通方式提交
	var form = document.getElementById("mainForm");
	form.action = "<s:url value="/itms/resource/deviceVersionManageACT!queryDeviceVersion.action"/>";
	//form.action = "<s:url value="/itms/resource/deviceTypeInfo!queryList.action"/>";
	form.submit();
}
...
function excel()
{
	// 普通方式提交
	var form = document.getElementById("mainForm");
	form.action = "<s:url value="/itms/resource/deviceVersionManageACT!excel.action"/>";
	form.submit();
}
