					...
					<table class="green_gargtd">
						<tr>
							...
							<td><img src="<s:url value="/images/attention_2.gif"/>"
								width="15" height="12" /> 时间为 操作时间</td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td>
					<table class="querytable">
						...
						<TR>
							<th colspan="4">超级权限日志查询</th>
						</tr>
							<TR>
							<TD class="column" width='15%' align="right">权限名称</TD>
						...
						<TR>
							<TD class=column width="15%" align='right'>操作开始时间</TD>
							<TD width="35%">
							...
							<TD class=column width="15%" align='right'>操作结束时间</TD>
							<TD width="35%">
