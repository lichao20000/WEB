...
function Init(){
	...
	form.action = "<s:url value="/itms/resource/deviceVersionInfo!queryList.action"/>";
...
<TABLE border=0 cellspacing=0 cellpadding=0 width="100%">
	...
	<TR>
		...
		<table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="green_gargtd">
			<tr>
				<td width="162"> <div align="center" class="title_bigwhite">设备版本</div> </td>
				<td> <img src="/itms/images/attention_2.gif" width="15" height="12">查询时间为设备版本的添加时间</td>
			</tr>
		</table>
		<!-- 高级查询part -->
			...
			<tr>
				...
				<table border=0 cellspacing=1 cellpadding=2 width="100%"
					...
					<TR bgcolor="#FFFFFF" id="gwShare_tr21" STYLE="">
						...
						<TD align="right" class=column width="15%"><br></TD>
						<TD width="35%" nowrap><br></TD>
					</TR>
	...
	<TR>
		<TD HEIGHT=5><IFRAME ID=childFrm SRC="" STYLE="display: none"></IFRAME>&nbsp;</TD>
	</TR>
