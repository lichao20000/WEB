...
function netWanTypeChange(){
	var netWanType=$("select[@name='obj.netWanType']").children('option:selected').val();//这就是selected的值 
	if("1"==netWanType){
		$("input[@name='obj.netUsername']").parent().parent().css("display", "block");
		$("input[@name='netPort']").parent().parent().css("display", "block");
	}
	else if("2"==netWanType){
		$("input[@name='obj.netUsername']").parent().parent().css("display", "block");
		$("input[@name='netPort']").parent().parent().css("display", "none");
		//$("input[@name='obj.netPort']").val("");
...
function checkLoid()
{
	...
	//业务触发
	var url = "<s:url value='/itms/service/bssSheetByHand4HBLT!checkLoid.action'/>";
	$.post(url,{
...
function checkCustomerId()
{
	...
	//业务触发
	var url = "<s:url value='/itms/service/bssSheetByHand4HBLT!checkCustomerId.action'/>";
	$.post(url,{
...
function delBusiness()
{
	...
	if(netServTypeId == "" && iptvServTypeId == "" && hvoipServTypeId == ""){
		...
		if(netServTypeId != ""){
			...
			if(hvoipServTypeId != ""||iptvServTypeId != ""){
				alertstr = alertstr+"、";
			}
		}
		if(iptvServTypeId != ""){
	...
	//业务触发
	var url = "<s:url value='/itms/service/bssSheetByHand4HBLT!delBusiness.action'/>";
	$.post(url,{
...
function doBusiness()
{
	...
	//业务触发
	var url = "<s:url value='/itms/service/bssSheetByHand4HBLT!doBusiness.action'/>";
	$.post(url,{
...
{
	var url = "<s:url value='/itms/service/bssSheetByHand4HBLT!changeVoipPort.action'/>";
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<tbody id="internetBssSheet" style="display:none">
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD width="35%" >
							<SELECT name="obj.netWanType" id="objnetWanType" onChange="netWanTypeChange()" class="bk">
					...
					<tbody id="iptvBssSheet" style="display:none">
						<TR bgcolor="#FFFFFF">
							...
							<TD width="35%" colspan="1">
								<input type="text" name="obj.iptvOltFactory" class=bk value="">
								&nbsp;<font color="#FF0000">*</font>
							</TD> -->
							<TD width="15%" class=column align="right">上网方式：</TD>
							<TD width="35%" colspan="3">
							<SELECT name="obj.iptvWanType" id="objiptvWanType" onChange="iptvWanTypeChange()" class="bk">
								<option value="-1">==请选择操作类型==</option>
								<option value="1">==桥接==</option>
								<option value="2">==路由==</option>
								<!--<option value="3">==STATIC==</option>-->
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD width="35%" >
								<input type="text" name="obj.multicastVlan" class=bk value="">
									<!-- &nbsp;<font color="#FF0000">*</font> -->
							</TD>
						</TR>
						<TR bgcolor="#FFFFFF">
							...
							<TD width="35%" >
								<input type="text" name="obj.iptvUserName" class=bk value="">
								&nbsp;<font color="#FF0000">*</font>
							</TD>
							<TD class=column align="right" nowrap width="15%">IPTV宽带密码:</TD>
							<TD width="35%" >
								<input type="text" name="obj.iptvPasswd" class=bk value="">
								&nbsp;<font color="#FF0000">*</font>
							</TD>
						</TR>
						<TR bgcolor="#FFFFFF">
							<TD class=column align="right" nowrap width="15%">静态路由目的地址:</TD>
							<TD width="35%" >
								<input type="text" name="obj.iptvDestIp" class=bk value="10.0.0.0" disabled>
								&nbsp;<font color="#FF0000">*</font>
							</TD>
							<TD width="15%" class=column align="right">静态路由掩码:</TD>
							<TD id="iptvTD1" width="35%" >
								<input type="text" name="obj.iptvDestMark" class=bk value="255.0.0.0" disabled>
							&nbsp;<font color="#FF0000">*
							</font>
							</TD>
						</TR>
						<TR bgcolor="#FFFFFF">
							...
							<!-- <TD id="iptvTD1" width="35%" colspan="3">
								<input type="text" name="obj.iptvPort" class=bk value="" >
							&nbsp;<font color="#FF0000">*
							</font>
							</TD>
							 -->
					...
					<tbody id="H248BssSheet" style="display:none">
						...
						<TR id="h248Dns" bgcolor="#FFFFFF" >
							<TD class=column align="right" nowrap width="15%">EID:</TD>
							<TD width="35%">
								<input type="text" name="obj.hvoipEid" class=bk value="">
								&nbsp;<font color="#FF0000">*</font>
							</TD>
							<TD class=column align="right" nowrap width="15%">电话业务逻辑号:</TD>
							<TD width="35%">
								<input type="text" name="obj.hvoipPhone" class=bk value="">
								&nbsp;<font color="#FF0000">*</font>
							</TD>
					...
					<tbody id="sipBssSheet" style="display:none">
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD width="15%" class=column align="right">VLANID</TD>
							<TD width="35%">
								<input type="text" name="obj.sipVlanId" class=bk value="" >
								&nbsp;<font color="#FF0000">*</font>
							</TD>
						</TR>
						<TR bgcolor="#FFFFFF">
						...
						<TR bgcolor="#FFFFFF" id="ims" style="display: none">
							...
							<TD><INPUT TYPE="text" NAME="obj.sipUserAgentDomain" maxlength=20 class=bk value="ah.ctcims.cn" >
							</TD>
						</TR>
					</tbody>
