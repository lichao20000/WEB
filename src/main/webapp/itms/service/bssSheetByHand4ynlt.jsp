...
function checkLoid()
{
	...
	//业务触发
	var url = "<s:url value='/itms/service/bssSheetByHand4ynlt!checkLoid.action'/>";
	$.post(url,{
		...
		else
		{
			...
			if("15" == relt[31])
			{
				...
				$("input[@name='obj.deviceName']").val(relt[81]);
				$("input[@name='obj.dscpMark']").val(relt[82]);
...
function checkCustomerId()
{
	...
	//业务触发
	var url = "<s:url value='/itms/service/bssSheetByHand4ynlt!checkCustomerId.action'/>";
	$.post(url,{
...
function doBusiness()
{
	...
	else
	{
		...
		{
			alert("IPTV宽带接入帐号不可为空。");
			$("input[@name='obj.iptvUserName']").focus();
			return false;
		}
		if("" == $("input[@name='obj.iptvPort']").val())
		{
			alert("开通端口不可为空。");
			return false;
		}
	...
	else
	{
		...
		if("" == $("input[@name='obj.deviceName']").val())
		{
			alert("设备名不可为空。");
			$("input[@name='obj.deviceName']").focus();
			return false;
		}
		if("" == $("input[@name='obj.dscpMark']").val())
		{
			alert("DSCP值不可为空。");
			$("input[@name='obj.dscpMark']").focus();
			return false;
		}
	}
	if("14" != sipServTypeId)
	...
	else
	{
		...
		{
			alert("input[@name='obj.sipVoipPwd']");
			$("认证密码不能为空。").focus();
			return false;
		}
	...
	//业务触发
	var url = "<s:url value='/itms/service/bssSheetByHand4ynlt!doBusiness.action'/>";
	$.post(url,{
		...
		"obj.deviceName":$("input[@name='obj.deviceName']").val(),
		"obj.dscpMark":$("input[@name='obj.dscpMark']").val(),
...
{
	var url = "<s:url value='/itms/service/bssSheetByHand4ynlt!changeVoipPort.action'/>";
	...
	if("h248" == voipType && "2" == h248SendPost)
	{
		$.post(url,{
			...
			if("-1" == ajax)
			{
				...
				$("input[@name='obj.deviceName']").val("");
				$("input[@name='obj.dscpMark']").val("");
			...
			else
			{
				...
				$("input[@name='obj.deviceName']").val(relt[14]);
				$("input[@name='obj.dscpMark']").val(relt[15]);
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<tbody id="jirRuBssSheet" >
						...
						<TR bgcolor="#FFFFFF" >
							...
							<TD width="35%" >
								<s:select list="specList" name="obj.specId"
								headerKey="-1" headerValue="--请选择--" listKey="spec_id"
								listValue="spec_name" value="" cssClass="bk"></s:select>
							<font color="#FF0000">*</font>
							</TD>
						</TR>
					...
					<tbody id="iptvBssSheet" style="display:none">
						<TR bgcolor="#FFFFFF">
							...
							<TD id="iptvTD1" width="35%" >
								<input type="text" name="obj.iptvPort" class=bk value="L2" disabled>
							&nbsp;<font color="#FF0000">*
							</font>
							</TD>
						</TR>
						<TR bgcolor="#FFFFFF">
							...
							<TD width="15%" class=column align="right">IPTV个数:</TD>
							<TD width="35%" >
								<input type="text" name="obj.iptvNum" class=bk value="1">
									&nbsp;<font color="#FF0000">*</font>
							</TD>
						</TR>
					</tbody>
					...
					<tbody id="H248BssSheet" style="display:none">
						...
						<TR bgcolor="#FFFFFF" >
							<TD class=column align="right" nowrap width="15%">设备名:</TD>
							<TD width="35%" >
								<input type="text" name="obj.deviceName" class=bk value="ONT">
								&nbsp;<font color="#FF0000">*</font>
							</TD>
							<TD width="15%" class=column align="right">DSCP值:</TD>
							<TD width="35%">
								<input type="text" name="obj.dscpMark" class=bk value="0" >
								&nbsp;<font color="#FF0000">*</font>
							</TD>
						</TR>
					</tbody>	
