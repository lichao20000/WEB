			...
			<s:iterator value="bssSheetList">
				...
				<s:if test="protocol!='H248' && protocol != 'IMS H248'">
					...
					if("ah_dx".equals(InstArea)){%>
						...
						********&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="hidden" class=jianbian name="look" value="查看" onclick="look('<s:property value="voip_passwd" />','<s:property value="voip_username" />')"> 
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="hidden" name="look" class=jianbian id="look"  value="查看" onclick="look('<s:property value="voip_passwd" />','<s:property value="voip_username" />')"> 
						</td>
						<% }else{%>
						<TD class=column width="15%" align='right'>
							VoIP认证密码
						...
						<TD width="35%">
							<%if("sx_dx".equals(InstArea) || "nx_dx".equals(InstArea)){%>
							<s:property value="voip_passwd" />
							<% }else{%>
							********&nbsp;&nbsp;&nbsp;&nbsp;
							<%}%>
					...
					<tr>
						...
						<TD width="35%">
							<s:property value="serOneTime" />
						</TD>
						<TD class=column width="15%" align='right'>
							状态
						</TD>
						<TD width="35%">
							<s:property value="serOneStatues" />
						</TD>
					</TR>
					<%}%>
