...
<script type="text/javascript">
	...
	//	var mainForm=parent.document.getElementById("form");
		...
		mainForm.action="<s:url value='/itms/service/bssSheetServSDLT!toExcel.action'/>"
		mainForm.submit();
		mainForm.action="<s:url value='/itms/service/bssSheetServSDLT!getBssCustomerServInfo.action'/>";
...
<table class="listtable" id="listTable">
	...
	<tfoot>
		<tr>
			...
			<lk:pages
				url="/itms/service/bssSheetServSDLT!getBssCustomerServInfo.action"
...
function getServ(userId)
{
	...
	var url = "<s:url value='/itms/service/bssSheetServSDLT!getServByUser.action'/>?userId=" + userId + "&gw_type=" + gw_type;
