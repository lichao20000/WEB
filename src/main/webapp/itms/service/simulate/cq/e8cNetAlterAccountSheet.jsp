...
<script type="text/javascript">
	...
	function CheckForm() {
		...
		var newadaccount = $("input[@name='newadaccount']");
		...
		if (!IsNull(adaccount.val(), "用户账号")) {
			adaccount.focus();
			return false;
		}
		if (!IsNull(newadaccount.val(), "新用户账号")) {
			newadaccount.focus();
			return false;
		}
							...
							<TD bgcolor=#999999>
								<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
									...
									<TR bgcolor="#FFFFFF">
										...
										<TD colspan="3"><INPUT TYPE="text" NAME="loid" maxlength=100 onblur="checkLoid()"
									...
									<TR bgcolor="#FFFFFF">
										...
										<TD width="20%" class=column align="right" nowrap>新用户账号</TD>
										<TD width="30%"><INPUT TYPE="text" NAME="newadaccount"
											class=bk value="">&nbsp; <font color="#FF0000">*
										</font></TD>
									</TR>
