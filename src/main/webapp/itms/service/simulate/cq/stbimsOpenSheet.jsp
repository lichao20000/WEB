...
<script type="text/javascript">
	...
	function CheckForm() {
		...
		/* 业务字段 */
		var imsid = $("input[@name='imsid']");
		var imspassword = $("input[@name='imspassword']");
		var bacdomain = $("input[@name='bacdomain']");
		var bacaddress1 = $("input[@name='bacaddress1']");
		var bacaddress2 = $("input[@name='bacaddress2']");
		...
		if (!IsNull(imsid.val(), "视频通话业务帐号")) {
			imsid.focus();
			return false;
		}
		if (!IsNull(imspassword.val(), "视频通话业务密码")) {
			imspassword.focus();
			return false;
		}
						...
						<TR>
							<TD bgcolor=#999999>
								<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
									<TR class="green_title">
										<TD colspan="4"><input type="hidden" name="servTypeId"
											...
											<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%"
												BORDER="0">
												<TR>
													<TD align="center"><font size="2"><b>stb_ims开户信息</b></font></TD>
												</TR>
											</TABLE></TD>
									</TR>
									...
									<TR bgcolor="#FFFFFF">
										<TD width="20%" class=column align="right" nowrap>视频通话业务帐号</TD>
										<TD width="30%"><INPUT TYPE="text" NAME="imsid" maxlength=36
											class=bk value="">&nbsp; <font color="#FF0000">*
										</font></TD>
										<TD width="20%" class=column align="right" nowrap>视频通话业务密码</TD>
										<TD width="30%"><INPUT TYPE="password" NAME="imspassword" maxlength=16
											class=bk value="">&nbsp; <font color="#FF0000">*
										</font></TD>
									</TR>
									
									<TR bgcolor="#FFFFFF">
										<TD width="20%" class=column align="right" nowrap>BAC域名</TD>
										<TD width="30%"><INPUT TYPE="text" NAME="bacdomain" maxlength=2048
											class=bk value="">&nbsp; <font color="#FF0000">
										</font></TD>
										<TD width="20%" class=column align="right" nowrap>BAC服务地址1</TD>
										<TD width="30%"><INPUT TYPE="text" NAME="bacaddress1" maxlength=128
											class=bk value="">&nbsp; <font color="#FF0000">
										</font></TD>
									</TR>
									
									<TR bgcolor="#FFFFFF">
										<TD width="20%" class=column align="right" nowrap>BAC服务地址2</TD>
										<TD colspan="3"><INPUT TYPE="text" NAME="bacaddress2" maxlength=128
											class=bk value="">&nbsp; <font color="#FF0000">
										</font></TD>
									</TR>
