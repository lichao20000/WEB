...
<script type="text/javascript">
	...
	function orderTypeChange() {
		var _orderType = $("select[@name='orderType']").val();
		if (_orderType == 1) {
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					<TR class="green_title">
						...
						<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" BORDER="0">
							<TR>
								<TD align="center"><font size="2"><b>e8b
								IPTV开户信息</b></font></TD>
							</TR>
						</TABLE>
						</TD>
					...
					<TR id="vlanid" bgcolor="#FFFFFF" style="display: none">
						...
						<TD colspan="3"><INPUT TYPE="text" NAME="vlanId" maxlength=5
							class=bk value="">&nbsp; <font color="#FF0000">* </font></TD>
					</TR>

					<TR id="pvc" bgcolor="#FFFFFF" style="display: none">
						<TD class=column align="right" nowrap>PVC</TD>
						<TD><INPUT TYPE="text" NAME="vpi" size="3"
							maxlength=5 class=bk value="8">&nbsp;/&nbsp;<INPUT
							TYPE="text" NAME="vci" size="3" maxlength=5 class=bk value="35">&nbsp;
						<font color="#FF0000">* </font></TD>
					...
					<TR bgcolor="#FFFFFF">
						...
						<TD><INPUT TYPE="text" NAME="maxDownSpeed" maxlength=20
							class=bk value=""></TD>
						<TD class=column align="right" nowrap>最大上行速率</TD>
						<TD><INPUT TYPE="text" NAME="maxUpSpeed" maxlength=20
							class=bk value=""></TD>
					</TR>
					...
					<TR bgcolor="#FFFFFF">
						...
						<TD><textarea name="homeAddr" cols="30" rows="2"></textarea>
