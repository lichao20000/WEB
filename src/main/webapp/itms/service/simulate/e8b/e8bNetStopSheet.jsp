...
function CheckForm(){
	...
	//用户账号
	if(!IsNull(_netUsername.val(), "用户账号")){
		_netUsername.focus();
		return false;
	}
	//属地
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					<TR class="green_title">
						...
						<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" BORDER="0">
							<TR>
								<TD align="center"><font size="2"><b>e8b上网业务拆机工单</b></font></TD>
							</TR>
						</TABLE>
						</TD>
					</TR>
					...
					<TD class=column align="right" nowrap>宽带帐号</TD>
						<TD><INPUT TYPE="text" NAME="netUsername" maxlength=50 class=bk
							value="">&nbsp; <font id="usernameDiv" color="#FF0000">* </font></TD>
					</TR>

					<TR bgcolor="#FFFFFF">
						<TD class=column align="right" width="20%">属地</TD>
						<TD  colspan="3" width="30%"><s:select list="cityList" name="cityId"
