...
function CheckForm(){
	var areaName  = "<s:property value='instAreaName' />";
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<TR bgcolor="#FFFFFF">
						...
						<s:if test='%{instAreaName=="nmg_dx"}'>
							<TD class=column align="right" nowrap>逻辑SN号</TD>
					...
					<TR id="id_static1" bgcolor="#FFFFFF">
						<TD class=column align="right" width="20%">终端接入方式</TD>
						<TD width="30%"><select name="orderType" class="bk">
							...
							<s:if test='%{instAreaName=="nmg_dx"}'>
								...
								<option value="4" selected="selected">==GPON==</option>
							</s:if>
							<s:else>
					...
					<TR bgcolor="#FFFFFF">
						<s:if test='%{instAreaName=="nmg_dx"}'>
								...
								<TD colspan="3"><INPUT TYPE="text"  NAME="customerAccount" class=bk
								maxlength=20 value=""> &nbsp;</TD>
						</s:if>
						<s:else>
					...
					<TD class=column align="right">客户密码</TD>
						...
						<s:if test='%{instAreaName=="nmg_dx"}'>
							...
							<TD >
							<INPUT TYPE="text" name="homeAddr"  class=bk
