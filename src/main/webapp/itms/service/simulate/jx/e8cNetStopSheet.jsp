...
function CheckForm(){
	...
	//宽带帐号
	if('' == _netUsername.val() || '-1' == _netUsername.val()){
		alert("请输入宽带帐号");
		_netUsername.focus();
		return false;
	}
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					<TR class="green_title">
						...
						<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" BORDER="0">
							<TR>
								<TD align="center"><font size="2"><b>上网业务拆机工单信息</b></font></TD>
							</TR>
						</TABLE>
						</TD>
					</TR>
					...
					<TR id="netUsername" bgcolor="#FFFFFF">
						<TD  class=column align="right" nowrap>宽带帐号</TD>
						<TD colspan="3"><INPUT TYPE="text" NAME="netUsername" maxlength=50 class=bk
							value="">&nbsp; <font color="#FF0000">* </font></TD>
					</TR>
					<TR>
