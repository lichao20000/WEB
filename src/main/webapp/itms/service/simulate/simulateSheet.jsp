...
<script type="text/javascript">
	function checkLoid() {
		...
		var url = "<s:url value='/itms/service/simulateSheet!initLoid.action'/>";
		$.post(url, {
			loid : loid
		}, function(ajax) {
...
<body>
	<form name="mainfrm"
		action="<s:url value='/itms/service/simulateSheet!showSheet.action'/>"
		target="dataForm">
					...
					<table class="green_gargtd">
						<tr>
							...
							<td><img src="<s:url value="/images/attention_2.gif"/>"
								width="15" height="12" /> BSS模拟工单，只用于e8-c用户</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td>
					<table class="querytable">
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD><INPUT type="text" name="loid" maxlength=20 class=bk
						...
						<TR bgcolor="#FFFFFF">
							...
							<TD width="30%"><select name="servTypeId" class=bk>
									...
									<s:if test='%{instAreaName=="nmg_dx"}'>
										<option value="20" selected>建设流程</option>
									...
									<s:else>
										...
										<option value="25">天翼看店业务</option> 
										<option value="6">路由开通业务</option>
									</s:else>
