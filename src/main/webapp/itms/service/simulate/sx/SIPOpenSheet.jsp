...
$(function() {
	...
	$("input[name='RegistrarServer']").val("si.ims.chinaunicom.cn");
	$("input[name='RegistrarServer_a']").val("si.ims.chinaunicom.cn");
});
var isHasUsername = 0;
function CheckForm(){
	...
	var _voiceport = $("select[@name='voiceport']");
	...
	//语音端口
	if('' == _voiceport.val() || '-1' == _voiceport.val()){
