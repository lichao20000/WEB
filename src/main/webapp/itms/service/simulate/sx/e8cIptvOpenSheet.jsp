...
function CheckForm(){
	...
	var _iptvVlanId = $("input[@name='iptvVlanId']");
	var _orderNo = $("input[@name='orderNo']");
	...
	//IPTV宽带接入账号
	if(!IsNull(_iptvVlanId.val(), "VLANID")){
		_iptvVlanId.focus();
		return false;
	}
	//属地
	...
	//IPTV个数
	if(!IsNull(_orderNo.val(), "订单序列号")){
		_orderNo.focus();
		return false;
	}
	var netPortStr = "";
	var checkBoxNet = document.frm.iptvPort;
	var portflag = false;
...
<body>
<form name="frm" action="<s:url value='/itms/service/simulateSxNewSheet!sendSheet.action'/>"  method="post">
		...
		<TABLE width="100%" border=0 cellspacing=0 cellpadding=0 align="center">
			<TR>
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					...
					<TR bgcolor="#FFFFFF">
						<TD class=column align="right" nowrap>订单序列号</TD>
						<TD><INPUT TYPE="text" NAME="orderNo"  maxlength=50 class=bk
							value="">&nbsp; <font color="#FF0000">* </font></TD> 
						<TD class=column align="right" width="20%">厂商</TD>
						<TD   width="30%"><INPUT TYPE="text" NAME="oltFactory" maxlength=20 class=bk
							value="">
						</TD>
					</TR>
					<TR  bgcolor="#FFFFFF">
						<TD class=column align="right" width="20%">VLANID</TD>
						<TD  width="30%"><INPUT TYPE="text" NAME="iptvVlanId" maxlength=20 class=bk
							value="">&nbsp;<font color="#FF0000">*</font>
						</TD>
