...
function CheckForm(){
	...
	var _newusername = $("input[@name='newusername']");
	...
	//新用户账号
	if(!IsNull(_newusername.val(), "用户账号")){
		_newusername.focus();
		return false;
	}
	//用户类型
				...
				<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
					<TR class="green_title">
						...
						<TABLE CELLPADDING="0" CELLSPACING="0" WIDTH="100%" BORDER="0">
							<TR>
								<TD align="center"><font size="2"><b>用户移机工单信息</b></font></TD>
							</TR>
						</TABLE>
						</TD>
					</TR>
					...
					<TR bgcolor="#FFFFFF">
						...
						<TD><INPUT TYPE="text" NAME="userAccount" onblur="checkUserInfo()"  maxlength=20 class=bk
							value="">&nbsp; <font color="#FF0000">* </font></TD> -->
						<TD class=column align="right" nowrap>旧逻辑SN</TD>
					...
					<TR bgcolor="#FFFFFF">
						<TD class=column align="right" width="20%">新逻辑SN</TD>
						<TD><INPUT TYPE="text" id="username"  NAME="newusername" maxlength=50 class=bk
						 >&nbsp; <font color="#FF0000">* </font></TD>
