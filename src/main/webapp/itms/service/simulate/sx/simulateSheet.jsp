...
<script type="text/javascript">
	...
	function queryServerType(servType){
		   if(servType=="14"){
			   $("select[@name='operateType'] option[value='2']").remove();
			   $("select[@name='operateType']").append("<option value='2'>修改</option>");
		   }
		   else if(servType =="20")
		   {
			   $("select[@name='operateType'] option[value='2']").remove();
			   $("select[@name='operateType']").append("<option value='2'>移机</option>");
		   }
		   else 
		   {
			   $("select[@name='operateType'] option[value='2']").remove();
...
<body>
<form name="mainfrm"
	action="<s:url value='/itms/service/simulateSxNewSheet!showSheet.action'/>"
	target="dataForm">
	...
	<tr>
		...
		<table class="querytable">
			...
			<TR bgcolor="#FFFFFF">
				...
				<TD width="30%"><select name="servTypeId" onchange="queryServerType(this.value)" class=bk>
