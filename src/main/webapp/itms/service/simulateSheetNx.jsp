...
<table>
	...
	<tr>
		...
		<table class="green_gargtd">
			<tr>
				<td width="162" align="center" class="title_bigwhite">宁夏VOIP(H248)</td>
				<td><img src="<s:url value='/images/attention_2.gif'/>" width="15" height="12" /> 宁夏VOIP(H248)</td>
			</tr>
		</table>
		</td>
	</tr>
	<tr>
		...
		<table class="querytable">
			...
			<TR> <th colspan="5">宁夏VOIP(H248)</th> </tr>

			<TR bgcolor="#FFFFFF">
				<TD class=column align="left" width="8%">操作类型</TD>
