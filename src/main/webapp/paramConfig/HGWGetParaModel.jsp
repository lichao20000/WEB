								...
								<TR bgcolor="#FFFFFF">
									...
									<TD colspan="4">
										<INPUT TYPE="text" NAME="paraV" class="bk"
											style="width: 550px;">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<INPUT TYPE="checkbox" NAME="doeshavechild" class="bk"
											value="0" checked>
										是否包含下级
									</TD>
								</TR>
...
function getPara() {
		...
		var hasChild = 1;
		if(document.frm.doeshavechild.checked){
			hasChild = 0;
		}
		document.all.tableView.display = "";
		document.all.tableView.innerHTML = "<BR><BR>正在获取,请稍候...";
		document.all("childFrm3").src = "HGWGetParaModelSubmit.jsp?device_id=" + $("input[@name='textDeviceId']").val() + "&paraV=" + document.frm.paraV.value + "&doeshavechild=" + hasChild + "&refresh=" + new Date().getTime()+ "&gwType="+<%=request.getParameter("gw_type")%>;
