...
<FORM name="frm" action="configiTV_strategy_result.jsp" onsubmit="checkForm()">
	...
	<TABLE width="95%" border=0 cellspacing=0 cellpadding=0 align="center">
		<TR>
			<TD>
				<TABLE width="100%" height="30" border="0" cellspacing="0" cellpadding="0" class="green_gargtd">
					<TR>
						<td width="162" align="center" class="title_bigwhite">IPTV配置管理</td>
						<td><img src="../images/attention_2.gif" width="15" height="12">
						根据管理员账号或用户宽带账号等信息，查询IPTV的配置策略信息.&nbsp;&nbsp; 
						</td>
					</TR>
				</TABLE>
			</TD>
		...
		<TR>
			...
			<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
				<TR><TH colspan="4">IPTV配置策略查询</TH></TR>
				<tr bgcolor="#FFFFFF">
						<td align="right" width="20%" class=column2>
		                    管理员登录账号：
		                </td>
						<td class=column2><input type="text" name="acc_loginname"
							value="" class="bk"></td>
						<td align="right" width="20%" class=column2>
		                    用户宽带账号：
		                </td>
						<td class=column2><input type="text" name="username"
							value="" class="bk">
						</td>
					</tr>
				<tr bgcolor="#FFFFFF">
	               <td align="right" width="15%" class=column2>
	                    开始时间：
	               </td>
	               <td width="25%">
