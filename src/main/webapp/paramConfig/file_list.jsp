						...
						<td>
							<table width="100%" height="30" border="0" cellspacing="0"
								...
								<tr>
									...
									<!-- <td align="right"><input type="button" name="Button_1" value="添加文件" class="btn"
						...
						<TD bgcolor=#999999>
							<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
								...
								<TR bgcolor="#FFFFFF">
									...
									<TD class=column align="right" width="10%" nowrap>状态</TD>
									<TD>
								...
								<TR bgcolor="#FFFFFF">
									...
									<TD class=column>
										...
										<input type=hidden name="button1" value="选择域" onclick=areaSelect('s_area_name','s_area_id')>
										<nobr class="BT" onmouseover="this.className='BTOver'"
