								...
								<TR>
									<TD bgcolor=#999999>
										<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
											...
											<TR bgcolor="#FFFFFF">
												<td align="right" width="15%">系统日志是否启用</td>
												<td width="35%"><input type="text" name="LocalSyslogEnable"></td>
												<td align="right" width="15%">系统日志等级</td>
												<td width="35%"><input type="text" name="LocalLevel"></td>
											</TR>
											<TR bgcolor="#FFFFFF">
...
<!--
	function getStatus() {
     		if(CheckForm()){
		        page = "syslogConfigStatus.jsp?device_id=" +did 
		        	+ "&type=" + (document.getElementById("rd1").checked ? "1" : "2")
		        	+ "&refresh=" + new Date().getTime();
				document.all("div_ping").innerHTML = "正在获取设备系统日志信息，请耐心等待....";
     ...
     function ExecMod(){
     		if(CheckForm()){
		        page = "syslogConfigSave.jsp?device_id=" +did 
		        	+ "&type=" + (document.getElementById("rd1").checked ? "1" : "2")
		        	+ "&LocalSyslogEnable=" + document.frm.LocalSyslogEnable.value 
		        	+ "&LocalLevel=" + document.frm.LocalLevel.value 
		        	+ "&refresh=" + new Date().getTime();
				document.all("div_ping").innerHTML = "正在配置设备系统日志信息，请耐心等待....";
				document.all("childFrm").src = page;
			}else{
				return false;
			}	
