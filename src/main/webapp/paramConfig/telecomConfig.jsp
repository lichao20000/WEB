								...
								<TR>
									<TD bgcolor=#999999>
										<TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
											...
											<TR bgcolor="#FFFFFF">
												<td align="right" width="15%">帐号是否启用</td>
												<td width="35%"><input type="text" name="RemoteEnable"></td>
												<td align="right" width="15%">帐号密码</td>
...
<!--
	function getStatus() {
     		if(CheckForm()){
				...
				document.all("div_ping").innerHTML = "正在获取设备电信维护帐号信息，请耐心等待....";
     ...
     function ExecMod(){
     		if(CheckForm()){
		        page = "telecomConfigSave.jsp?device_id=" +did 
		        	...
		        	+ "&refresh=" + new Date().getTime();
				document.all("div_ping").innerHTML = "正在配置设备电信维护帐号信息，请耐心等待....";
				document.all("childFrm").src = page;
			}else{
				return false;
			}	
