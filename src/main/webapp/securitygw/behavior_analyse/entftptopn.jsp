...
<script language="JavaScript" src="coolmenu_res.js"></script>
...
<body onclick="parent.document_click()" onLoad="MM_preloadImages('../../images/left_jton.jpg')">
<jsp:include page="entlinks.jsp" flush="false" />
<table width="100%" border="0" cellpadding="0" cellspacing="0">
 <tr>
  <td width="10"></td>
  <td><br>
  <form name="frmQuery" action="EntFtpTopn!toEntFtpSiteTopn.action" onSubmit="checkQuery()"><input
   type=hidden name="deviceid" value="<s:property value="deviceid"/>"><input type=hidden name="time"
   value="0"><input type=hidden name="remark" value="<s:property value="remark"/>">
  <table width="99%" border="1" cellpadding="0" cellspacing="0" class="table">
   <tr class="tab_title">
    <td colspan="2"><span class="title_white">企业FTP站点Top10 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><input
     ...
     onclick="$.open('EntFtpTopn!popup.action?<s:property value="parstr"/>','740px','400px','200px','200px','false')">
      -->
      </span>
      </td>
   </tr>
