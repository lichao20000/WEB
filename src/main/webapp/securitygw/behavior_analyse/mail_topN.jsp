...
//高级查询事件
function highQuery(){
	$.open("<s:url value='/securitygw/pBMaiHighQuery.action'/>?deviceId="+"<s:property value="deviceid"/>"+"&remark="+"<s:property value="remark"/>","740px","400px","200px","200px","false");
}
//-->
</script>
      ...
      <tr>
        <td align="left" valign="top"><table width="98%"  border="1" cellpadding="0" cellspacing="0" class="table">
                  ...
                  <tr class="trOver_blue">
                    ...
                    <td class="text">Top-1收发mail次数</td>
                    </tr>
                  <tr class="tr_white">
        ...
        <br>
          <table width="99%"  border="1" cellpadding="0" cellspacing="0" class="table">
            <tr class="tab_title">
              <td><span class="title_white">员工MAIL浏览Top<s:property value="topN"/>&nbsp;&nbsp;
		...
		<tr>
			<td class="tr_white">
				<div align="center"><br>
					<a href="securitygw/PBDetailAction.action?deviceid=<s:property value="deviceid"/>&date=<s:property value="start"/>&step=1&prot_type=2"><img border="0" src="<s:url value="%{imgUrlDay}"/>" /><br>
					</a>
				</div><br>
				<div align="center">
		...
		<tr>
			<td class="tr_white">
				<div align="center"><br>
					<a href="securitygw/PBDetailAction.action?deviceid=<s:property value="deviceid"/>&date=<s:property value="start"/>&step=7&prot_type=2"><img border="0" src="<s:url value="%{imgUrlWeek}"/>" /><br>
					</a>
				</div><br>
				<div align="center">
					<table width="670" border="0" cellpadding="0" cellspacing="0" class="table">
		...
		<tr>
			<td class="tr_white">
				<div align="center"><br>
					<a href="securitygw/PBDetailAction.action?deviceid=<s:property value="deviceid"/>&date=<s:property value="start"/>&step=30&prot_type=2"><img border="0" src="<s:url value="%{imgUrlMonth}"/>" /><br>
					</a>
				</div><br>
				<div align="center">
					<table width="670" border="0" cellpadding="0" cellspacing="0" class="table">
