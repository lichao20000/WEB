...
function Query(){
	...
	var url="<s:url value="/securitygw/PBTopNAction!getTopNWeek.action"><s:param name="deviceid" value="deviceid"/></s:url>&date=" + time + "&tt=" + new Date()+"&topN=10";
	$("#chartWeek").attr("src",url);
	getTableData("<s:url value="/securitygw/PBTopNAction!getNetBehaviorTopNWeekTable.action"/>","#tableWeek",time);

	var url="<s:url value="/securitygw/PBTopNAction!getTopNMonth.action"><s:param name="deviceid" value="deviceid"/></s:url>&date=" + time + "&tt=" + new Date()+"&topN=10";
	$("#chartMonth").attr("src",url);
	getTableData("<s:url value="/securitygw/PBTopNAction!getNetBehaviorTopNMonthTable.action"/>","#tableMonth",time);
}
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    <td><table width="99%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="left" valign="top"><table width="98%"  border="1" cellpadding="0" cellspacing="0" class="table">
                  <tr class="tab_title">
        ...
        <br>
          <table width="99%"  border="1" cellpadding="0" cellspacing="0" class="table">
            <tr class="tab_title">
              <td><span class="title_white">员工上网行为Top<s:property value="topN"/>&nbsp;&nbsp;
                  ...
                  <!-- <input name="query2" type="button" onclick="hLquery()" class="jianbian" value="高级查询" />
                   -->
                   	</td>
            </tr>
            <tr>
		...
		<tr>
			<td class="tr_white">
				<div align="center"><br>
					<a href="securitygw/PBDetailAction.action?deviceid=<s:property value="deviceid"/>&date=<s:property value="start"/>&step=1"><img border="0" src="<s:url value="%{imgUrlDay}"/>" /><br>
					</a>
				</div><br>
				<div align="center">
					<table width="670" border="1" cellpadding="0" cellspacing="0" class="table">
						<tr>
						...
						<td class="tr_white"><s:property value="#mapD.precent"/>%</td>
						</tr>
						</s:iterator>
					</table>
				</div><br>
		...
		<tr>
			<td class="tr_white">
				<div align="center"><br>
					<a href="securitygw/PBDetailAction.action?deviceid=<s:property value="deviceid"/>&date=<s:property value="start"/>&step=7"><img border="0" id="chartWeek" src="../images/loading.gif" /><br>
					</a>
				</div><br>
		...
		<tr>
			<td class="tr_white">
				<div align="center"><br>
					<a href="securitygw/PBDetailAction.action?deviceid=<s:property value="deviceid"/>&date=<s:property value="start"/>&step=30"><img border="0" id="chartMonth" src="../images/loading.gif" /><br>
					</a>
				</div>
...
<!--
	function query() {
		...
		var url = "/securitygw/PBTopN.action?deviceid=" + "<s:property value="deviceid"/>" + "&remark=" + "<s:property value="remark"/>" + "&start=" + date;
		window.location = url;
	}

	function hLquery() {

		var url = "/securitygw/AdvNetBehaviorTopN!toAdvNetBehaviorTopN.action?deviceid=" + "<s:property value="deviceid"/>";
		$.open(url,"740px","400px","200px","200px","false");
	}
//-->
</SCRIPT>
