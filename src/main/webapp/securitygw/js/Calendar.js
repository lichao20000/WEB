...
document.write("<DIV id=idCalendar style='position:absolute;top:100px;left:100px;width:260px;height:200px;border: #000000 1px solid;background-color: #ffffff;display:none;z-index:1000'></DIV>");

function initCalendar(){
	var CaleHTML="";
	CaleHTML += "<TABLE border=0 cellspacing=0 cellpadding=1 width='100%' height='100%'>";
...
function TDClick(){
	...
	if(showtype=="day"){
		...
		if (MonthStr < 10 || MonthStr.length == 1)
		{
			MonthStr = "0" + MonthStr;
		}
		if (DayStr < 10 || DayStr.length == 1)
		{
			DayStr = "0" + DayStr;
		}
		if(timeStr=="")
