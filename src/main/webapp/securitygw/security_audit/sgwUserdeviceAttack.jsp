...
<script type="text/javascript">
function query(time,atype)
{
	var stamp = new Date().getTime();
	var url ="<s:url value="/securitygw/UserTopReport!attackTopDayChart.action"><s:param name="device_id" value="device_id"/></s:url>";
 	$("#chartDay").attr("src",url+"&strTime="+time+"&at="+atype+"&stamp="+stamp);
 	var turl ="<s:url value="/securitygw/UserTopReport!attackTopDayTable.action"></s:url>";
	$.post(
		turl,
		{
	...
	var wurl = "<s:url value="/securitygw/UserTopReport!attackTopWeekChart.action"><s:param name="device_id" value="device_id"/></s:url>";
	 $("#chartWeek").attr("src",wurl+"&strTime="+time+"&at="+atype+"&stamp="+stamp);
	 	var wturl ="<s:url value="/securitygw/UserTopReport!attackTopWeekTable.action"></s:url>";
	 	$.post(
		wturl,
		{
			device_id:"<s:property value="device_id" />",
	...
	var murl = "<s:url value="/securitygw/UserTopReport!attackTopMonthChart.action"><s:param name="device_id" value="device_id"/></s:url>";
	 $("#chartMonth").attr("src",murl+"&strTime="+time+"&at="+atype+"&stamp="+stamp);
	 	var mturl ="<s:url value="/securitygw/UserTopReport!attackTopMonthTable.action"></s:url>";
	 	$.post(
		mturl,
		{
			device_id:"<s:property value="device_id" />",
...
function adQuery()
{
$.open("<s:url value="/securitygw/UserTopReport!attackAD.action"><s:param name="device_id" value="device_id"/></s:url>","740px","400px","200px","200px","true");
}
</script>
<style type="text/css">
<!--
		...
		<table width="100%" border="1" cellpadding="0" cellspacing="0"
			...
			<tr class="tr_glory">
				...
				<td class="text" colspan="4"><s:url id="link"
					...
					<s:param name="customerName" value="funInfo.customname"></s:param>
				</s:url> <s:a href="%{link}">
