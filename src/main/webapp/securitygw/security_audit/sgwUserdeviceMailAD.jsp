...
function query(stime,etime)
{
	...
	var url ="<s:url value="/securitygw/UserTopReport!asmailTopADChart.action"><s:param name="device_id" value="device_id"/></s:url>";
 	$("#chartDay").attr("src",url+"&strTime="+stime+"&endTime="+etime);
 	var turl ="<s:url value="/securitygw/UserTopReport!asmailTopADTable.action"></s:url>";
	$.post(
		turl,
		{
...
<table width=98% style="margin-left: 5px;"
	align=center>
	<tr class="tab_title">
		<td colspan="2" class="title_white">垃圾邮件用户排名高级查询 <INPUT TYPE="text"
