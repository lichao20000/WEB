...
function Query(){
	...
	var url="<s:url value="/securitygw/AttackReport!getAttackDay.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date()
	$("#chartDay").attr("src",url);
	getTableData("<s:url value="/securitygw/AttackReport!getAttackDayTable.action"/>","#tableDay",dateValue);

	var url="<s:url value="/securitygw/AttackReport!getAttackWeek.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date()
	$("#chartWeek").attr("src",url);
	getTableData("<s:url value="/securitygw/AttackReport!getAttackWeekTable.action"/>","#tableWeek",dateValue);

	var url="<s:url value="/securitygw/AttackReport!getAttackMonth.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date()
	$("#chartMonth").attr("src",url);
	getTableData("<s:url value="/securitygw/AttackReport!getAttackMonthTable.action"/>","#tableMonth",dateValue);
...
$(function(){
	...
	var url = "<s:url value="/securitygw/entSecStat!getAttackOrginData.action" />";
...
function AdvancedQuery(){
	var url="<s:url value="/securitygw/AttackReport!advQuery.action"><s:param name="deviceid" value="deviceid"/></s:url>";
...
<table width=98% style="margin-left: 5px;margin-top: 10px;" align=center>
	...
	<tr class="tab_title">
		<td colspan="2" class="title_white">企业攻击事件报表
