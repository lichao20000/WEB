...
function Query(){
	...
	var url="<s:url value="/securitygw/FilterReport!getFilterDay.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date()
	$("#chartDay").attr("src",url);

	getTableData("<s:url value="/securitygw/FilterReport!getFilterDayTable.action"/>","#tableDay",dateValue);

	var url="<s:url value="/securitygw/FilterReport!getFilterWeek.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date()
	$("#chartWeek").attr("src",url);
	getTableData("<s:url value="/securitygw/FilterReport!getFilterWeekTable.action"/>","#tableWeek",dateValue);

	var url="<s:url value="/securitygw/FilterReport!getFilterMonth.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date()
	$("#chartMonth").attr("src",url);
	getTableData("<s:url value="/securitygw/FilterReport!getFilterMonthTable.action"/>","#tableMonth",dateValue);
...
$(function(){
	...
	var url = "<s:url value="/securitygw/entSecStat!getFilterOrginData.action" />";
...
function AdvancedQuery(){
	var url="<s:url value="/securitygw/FilterReport!advQuery.action"><s:param name="deviceid" value="deviceid"/></s:url>";
...
<table width=98% style="margin-left: 5px;margin-top: 10px;" align=center>
	...
	<tr class="tab_title">
		<td colspan="2" class="title_white">企业过滤事件报表
