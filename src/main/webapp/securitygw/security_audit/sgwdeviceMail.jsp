...
function Query(){
	...
	var url="<s:url value="/securitygw/TrashMailReport!getTrashMailDay.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date();
	$("#chartDay").attr("src",url);

	getTableData("<s:url value="/securitygw/TrashMailReport!getTrashMailDayTable.action"/>","#tableDay",dateValue);

	var url="<s:url value="/securitygw/TrashMailReport!getTrashMailWeek.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date();
	$("#chartWeek").attr("src",url);

	getTableData("<s:url value="/securitygw/TrashMailReport!getTrashMailWeekTable.action"/>","#tableWeek",dateValue);

	var url="<s:url value="/securitygw/TrashMailReport!getTrashMailMonth.action"><s:param name="deviceid" value="deviceid"/></s:url>&nowDateString=" + dateValue + "&tt=" + new Date();
	$("#chartMonth").attr("src",url);

	getTableData("<s:url value="/securitygw/TrashMailReport!getTrashMailMonthTable.action"/>","#tableMonth",dateValue);
...
function AdvancedQuery(){
	var url="<s:url value="/securitygw/TrashMailReport!advQuery.action"><s:param name="deviceid" value="deviceid"/></s:url>";
...
<table width=98% style="margin-left: 5px;margin-top: 10px;" align=center>
	...
	<tr class="tab_title">
		<td colspan="2" class="title_white">企业垃圾邮件事件报表
