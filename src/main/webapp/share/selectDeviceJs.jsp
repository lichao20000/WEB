...
function deviceSelect_relateDeviceByUsername(){
	...
	var hguser = $.trim($("input[@name='hguser']").val());
	...
	$("input[@id='Usernamebutton']").attr("disabled", true);
	...
	$.post(url,{
		...
		$("input[@id='Usernamebutton']").attr("disabled", false);
...
function deviceSelect_relateDeviceByVOIPNum(){
	...
	var voipPara = $.trim($("input[@name='voipPara']").val());
	var selectType = $("input[@name='selectType']").val();
	var jsFunctionName = $("input[@name='jsFunctionName']").val();
	var jsFunctionNameBySn = $("input[@name='jsFunctionNameBySn']").val();
	...
	$("input[@id='VOIPNumbutton']").attr("disabled", true);
	...
	$.post(url,{
		...
		$("input[@id='VOIPNumbutton']").attr("disabled", false);
		$("div[@id='div_device']").html("");
		$("div[@id='div_device']").append(ajax);
	});
}
...
function deviceSelect_relateDeviceByItvUserName(){
	...
	var iTVUserName = $.trim($("input[@name='iTVUserName']").val());
	var selectType = $("input[@name='selectType']").val();
	var jsFunctionName = $("input[@name='jsFunctionName']").val();
	var jsFunctionNameBySn = $("input[@name='jsFunctionNameBySn']").val();
	...
	$("input[@id='ItvUserNamebutton']").attr("disabled", true);
	...
	$.post(url,{
		...
		$("input[@id='ItvUserNamebutton']").attr("disabled", false);
		$("div[@id='div_device']").html("");
		$("div[@id='div_device']").append(ajax);
	});
}
...
function deviceSelect_relateDeviceByWideNet(){
	...
	var wideNetPara = $.trim($("input[@name='wideNetPara']").val());
	var selectType = $("input[@name='selectType']").val();
	var jsFunctionName = $("input[@name='jsFunctionName']").val();
	var jsFunctionNameBySn = $("input[@name='jsFunctionNameBySn']").val();
	...
	$("input[@id='WideNetbutton']").attr("disabled", true);
	...
	$.post(url,{
		...
		$("input[@id='WideNetbutton']").attr("disabled", false);
		$("div[@id='div_device']").html("");
		$("div[@id='div_device']").append(ajax);
	});
}
...
function deviceSelect_relateDeviceBySerialno(){
	...
	var loopback_ip = $.trim($("input[@name='loopback_ip_']").val());
	var jsFunctionNameBySn = $("input[@name='jsFunctionNameBySn']").val();
	...
	$("input[@id='Serialnobutton']").attr("disabled", true);
	...
	$.post(url,{
		...
		$("input[@id='Serialnobutton']").attr("disabled", false);
		$("div[@id='div_device']").html("");
		$("div[@id='div_device']").append(ajax);
	});
}
...
function deviceSelect_relateDeviceBySenior(){
	...
	if(loopback_ip=='undefined' || typeof(loopback_ip)=='undefined'){
		loopback_ip="";
	}
