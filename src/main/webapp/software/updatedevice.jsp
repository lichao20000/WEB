...
//{
//	alert("调用后台成功");
//	document.getElementById("idList").innerHTML = "正在执行，请稍后";
//	document.getElementById("idList").innerHTML = "调用后台执行软件升级成功";
//}
//else
//{
//	alert("调用后台失败");
//	document.getElementById("idList").innerHTML = "正在执行，请稍后";
//	document.getElementById("idList").innerHTML = "调用后台执行软件升级失败";
//}
