		...
		<TR>
			<TD bgcolor=#999999>
				...
				<TR bgcolor="#FFFFFF">
					...
					<TD><INPUT TYPE="text" NAME="role_name" maxlength=25 class=bk size=20>&nbsp;<font color="#FF0000">*</font></TD>
				</TR>
				<TR bgcolor="#FFFFFF">
					<TD class=column align="right" >角色描述</TD>
					<TD><INPUT TYPE="text" NAME="role_desc" maxlength=40 class=bk size=40></TD>
				</TR>
