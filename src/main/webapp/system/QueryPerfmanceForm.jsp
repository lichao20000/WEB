  ...
  <TR><TD>
		<table width="100%" align=center  height="30" border="0" cellspacing="0" cellpadding="0" class="green_gargtd">
			<tr>
				...
				<td ><img
					src="../images/attention.gif" width=15 height=12>&nbsp;主机性能历史查询</td>
			</tr>
		</table>
	</TD></TR>
	<TR><TD>
		<TABLE border=0 cellspacing=1 cellpadding=2 width="100%" align=center valign=middle bgcolor="#999999">
			...
			<tr bgcolor="#FFFFFF">
					...
					<td nowrap>
						...
						<input type="button" value="▼" class=btn onClick="showCalendar('day',event)" name="button2" size="10">
						<input type="text" name="start_ms" id="start_ms" class=bk value="00:00:00" size="8">
					</td>
					<td class=column>
					...
					<td nowrap>
						...
						<input type="button" value="▼" class=btn onClick="showCalendar('day',event)" name="button2" size="10">
						<input type="text" name="end_ms" id="end_ms" class=bk  value="23:59:59" size="8">
					</td>
			</tr>	
			<tr bgcolor="#FFFFFF">
				<td nowrap class=column>
					<div align="right" align=right>采集点</div>
				</td>
				<td>
					<%=gatherList%>
				</td>
			...
			<tr bgcolor="#FFFFFF" class=green_foot>
				<td nowrap align=right colspan=4>
					<input type=button class=jianbian value=" 查 询 " onclick="QueryInstance()">
				</td>
			</tr>
		</TABLE>
