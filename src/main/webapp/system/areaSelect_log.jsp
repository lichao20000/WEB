                    ...
                    <table width="100%" border="0" align="center">
                      <tr> 
                        <td> 
							...
							<div id="idTreeView" XMLSrc="../Resource/area_xml.jsp?area_pid=<%=area_pid%>" onselectstart='return false' style="overflow:auto;width:<%=request.getParameter("width")%>;height:300;padding:2pt 2pt 2pt 2pt" > 
								<script language="JavaScript">init_tree();</script>
							</div>
                        </td>
                      </tr>
                    </table>
	...
	if(tree.getSelect()){
		...
		if(areaIdMore.indexOf("["+ area_id +",")!=-1 || areaIdMore.indexOf(", "+ area_id +"]")!=-1 || areaIdMore.indexOf(", "+ area_id +",")!=-1){
			...
			if (window.opener != undefined) {
		         //for chrome  
		         window.opener.deviceResult(returnObj);
		     }
		     else {
