...
if(strAction.equals("delete")){
	...
	if(strAction.equals("add")){	
		...
		if(DataSetBean.getRecord(strSQL)!=null)
			...
			strSQL = "insert into tab_broad_info (id,title,content,titletype,city_id) values ("+ id +",'"+ Str_biaoti +"','"+ Str_content +"','"+ Str_service_year +"','"+ Str_kinds +"')";
		...
		// teledb
		if (DBUtil.GetDB() == 3) {
			strSQL = "select id from tab_broad_info where id="+Str_title;
		}
		if(DataSetBean.getRecord(strSQL)!=null)
			strMsg = "标题\""+Str_biaoti+"\"已经存在，请换一个标题。";
		else{
