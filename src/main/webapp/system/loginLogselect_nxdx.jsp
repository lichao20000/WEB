...
function resultChange () {
	$("#errordesc").val(-1);
	$("#result").val() == 1 ? $("#errordesc").removeAttr("disabled") : $("#errordesc").attr("disabled","disabled");
}
</script>
		<style type="text/css">
<!--
...
-->
	...
	<body>
		<form name="selectForm" action="<s:url value="loginLog_nxdx.jsp"/>" target="dataForm">
					...
					<td>
						<table class="querytable">
							...
							<tr leaf="high" style="display: ">
								...
								<td width="23%">
									<select name="result" id="result" class="bk" onchange="resultChange()">
								...
								<td width="23%">
									<select name="errordesc" id="errordesc" class="bk" disabled>
									<option value="-1" selected>请选择</option>
									<option value="1">认证失败</option>
									<option value="2">密码过期</option>
									<option value="3">处于锁定时间段内</option>
									</select>
								</td>
							</tr>
