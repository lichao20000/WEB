...
String sql = "select id,title,content from tab_broad_info where id="+ id +" and titletype='提示'" ;						
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<tr>
		...
		<p align="center"><font color="#ffffff">南京联创科技股份有限公司 版权所有 Copyright By 
		Linkage Technology Co.,Ltd. All rights reserved.2005-2006&nbsp;&nbsp;</font></td>
	</tr>
	</table>
