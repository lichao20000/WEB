...
<%
	...
	Date dt = new Date();
	long lms = dt.getTime() - 24*3600*1000;
...
function userNameSelect() {
	...
	var page = "customerFlux_inside.jsp?customerID="+customerID+"&username="+username+"&start="+curTime+"&refresh="+Math.random();
	...
	<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=775 border=0>
			<TR>
				...
				<TD class=font1 width=701>客户终端流量信息</TD>
			</TR>
		</TABLE>
		</TD>
	</TR>
