...
function userNameSelect() {
	...
	var page = "customerReport_inside.jsp?customerID="+customerID+"&username="+username+"&start="+curTime+"&refresh="+Math.random();
...
//下载运行报告
function doDownload(file_path) {
	//&refresh=" + new Date().getTime()	
	var page = "customerReport_download.jsp?file_path=" + file_path+"&refresh="+Math.random();
	document.all("childFrm").src = page;
}
	...
	<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=775 border=0>
			<TR>
				...
				<TD class=font1 width=701>客户运行分析报告下载</TD>
			</TR>
		</TABLE>
		</TD>
	</TR>
	...
	<TR>
		...
		<TABLE width="100%" border=0 align='center' cellpadding='1' cellspacing='1' bgcolor='#efefef'>
			<TR class="trr">
				...
				<td class='tdd'>请选择日期：&nbsp;&nbsp;<select name="queryDate" onchange="refreshData()"></select></td>
			</TR>
		</TABLE>
		</TD>
	</TR>
