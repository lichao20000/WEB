...
<%	
	...
	String vpn_id = (String)fields.get("vpn_id");
...
%>
<form method=post action="AccessVPNUserInfoUpdate.jsp" name="frm" onsubmit="CheckForm()" target="childFrm">
...
function showUserInfo(v){
	...
	if(v=="null"){
		...
		var page="AccessgetUserInfo.jsp?&vpn_auto_id="+vpn_auto_id+"&tt="+new Date().getTime();
	}
	else{
		var page="AccessgetUserInfo.jsp?vpn_id="+v+"&tt="+new Date().getTime();		
	}
	document.all("childFrm").src=page;
}
