...
<%
	...
	if(fields != null){
		while(fields != null){
			...
			strBuffer.append("<td nowrap> <a href='javascript:;' onclick=\"delParm(" + param + ")\">删除</a></td>");
			strBuffer.append("</tr>");
			fields = cursor.getNext();
		}
	}else{
	    strBuffer.append("<tr bgcolor='#ffffff'>");
		strBuffer.append("<td colspan=6>无数据</td>");
		strBuffer.append("</tr>");
	}
%>
  ...
  <TR>
	<TD bgcolor=#000000>
		<TABLE border=0 cellspacing=1 cellpadding=2 width="100%"  bordercolorlight="#000000" bordercolordark="#FFFFFF">
			<TR>
				<TH align="center" nowrap>参数编号</TH>
				<TH align="center" nowrap>设备型号</TH>
				<TH align="center" nowrap>软件版本</TH>
				<TH align="center" nowrap>参数名称</TH>
				<TH align="center" nowrap>参数备注</TH>
				<TH align="center" nowrap>示例备注</TH>
