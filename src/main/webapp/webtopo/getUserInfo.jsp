...
if(str_vpn_id==null){
	...
	// teledb
	if (DBUtil.GetDB() == 3) {
		strSQL = "select cust_level_id, complete_time, vpn_name, ext_vpn_id, username, vpn_type_id, topo_type, linkman, " +
				"address, user_state, linkphone, mobile, email, remark1, cred_type_id, cardno" +
