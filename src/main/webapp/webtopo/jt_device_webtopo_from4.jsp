...
<SCRIPT LANGUAGE="JavaScript">
     ...
     function ExecMod(){
                var deviceID = document.frm.device_id.value;
     		    ...
     		    page = "jt_device_webtopo_from4_save.jsp?device_id="+deviceID;
		...
		<table width="95%" border="0" align="center" cellpadding="0"
			...
			<tr>
				...
				<table width="100%" height="30" border="0" cellspacing="0"
					...
					<tr>
						<td width="162">
						<div align="center" class="title_bigwhite">系统命令</div>
						</td>
				...
				<table width="100%" border=0 align="center" cellpadding="1"
					...
					<tr bgcolor="#FFFFFF">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<INPUT TYPE="hidden" name="gather_id" value="<%=gather_id%>"> &nbsp;&nbsp;</div>
								</TH>
							</tr>
						</table>
						</div>
					...
					<TR bgcolor="#FFFFFF">
						<TD align="center" nowrap class=column>诊断结果</TD>
						<td colspan="3" valign="top" class=column>
						<div id="div_ping" style="width:100%; height:120px; z-index:1; top: 100px; overflow:scroll"></div>
						</td>
					</TR>
				</table>
				</td>
