...
<TR>
	...
	<TD width="100%" valign="top">
			...
			<div align="left">
                <table  height="22"  border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="30" class=trOutimg onmouseover="className='trOverimg'" onmouseout="className='trOutimg'" id="INCREMENTFINDTOPO" style="display:none"><div align="center"><img src="images/topban_8.gif" width="20" height="15" title="增量发现拓扑" onclick="javascript:AddTopo();" ></div></td>
                    <td width="30" class=trOutimg onmouseover="className='trOverimg'" onmouseout="className='trOutimg'"  id="SAVETOPO" style="display:none"><div align="center"><img src="images/topban_9.gif" width="20" height="15"  title="保存拓扑" onclick="javascript:SaveTopo(<%=iType%>)"></div></td>
                    <td width="30"><div align="center"><img src="images/topban_line.gif" width="30" height="22"></div></td>
	  ...
	  <TR >
		  ...
		  <Div id="idWebTopo" style="width:800px;overflow:auto;" src="getTopoByIdXML.jsp?pid=<%=idStr%>" onmousedown="Main_MouseDown()" onmousemove="Main_MouseMove()" onmouseup="Main_MouseUp()" >
	  ...
	  <TR style="display:none" >
		  ...
		  <TABLE id="idBottomView" width="0" cellpadding="0" cellspacing="0"  style="display:none" ><TR><TD><!--getAllAlarmXML.jsp?updateTime=0-->
		    <mylist:listview ID="oList" dataXML="" width="0" height="0" onRowSelected="clickRow()" onmousedown="rightclick()"/>
		  </TD></TR></TABLE>
		</TD>
	  </TR>
	  </TABLE>
