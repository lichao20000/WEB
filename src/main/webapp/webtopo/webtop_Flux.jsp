    ...
    <td bgcolor="#FFFFFF"> <br>
        ...
        <table width="100%" height="30"  border="0" align="center" cellpadding="0" cellspacing="0" class="green_gargtd">
          <tr>
            ...
            <a href="#" onclick="JavaScript:window.open('webtopo_liuliang_historyForm.jsp?device_id=<%= device_id%>&type=<%=type %>&device_name=<%=deviceName%>&device_ip=<%=loopbackip%>','历史报表显示','scrollbars=yes,width=820,height=500')">历史报表显示</a>
            <a href="#" onclick="JavaScript:window.open('webtop_liuliang_report.jsp?device_id=<%= device_id %>&device_name=<%= deviceName %>&loopback_ip=<%= loopbackip%>&type=<%=type %>','图形显示','scrollbars=yes,width=820,height=500')"><img src="../images/chart.gif" width="20" height="19" border="0">图形显示</a>
          </tr>
		<tr>
