...
<% 
	...
	QosData[] fluxDataTab = fluxData.getDeviceQosData(device_id,user.getAccount(),user.getPasswd());
  ...
  <tr>
    <td bgcolor="#FFFFFF"> <br>
        ...
        <table width="100%" height="30"  border="0" align="center" cellpadding="0" cellspacing="0" class="blue_gargtd">
          <tr>
            <td align="center" nowrap  class="title_bigwhite">QOS实时显示</td>
        ...
        <table width="100%" border=0 align="center" cellpadding="1" cellspacing="1" bgcolor="#999999" class="text">
          <tr bgcolor="#FFFFFF" class="blue_title">
			...
			<td nowrap>策略描述</td>
			<td nowrap>策略等级</td>
			<td nowrap>预留带宽(bps)</td>
			<td nowrap>流量的速率(bps)</td>
            <td nowrap>流量的包(个/秒)</td>
			<td nowrap>Exceeded(个/秒)</td>
            <td nowrap>Exceeded(bps)</td>
			<td nowrap>Violated(个/秒)</td>
            <td nowrap>Violated(bps)</td>
          </tr>
          ...
          <tr bgcolor="#FFFFFF" >
			...
			<td><%= fluxDataTab[i].qospoliceconformedbps %></td>
			<td><%= fluxDataTab[i].qospoliceconformedpktpps %></td>
			<td><%= fluxDataTab[i].qospoliceexceededpktpps %></td>
			<td><%= fluxDataTab[i].qospoliceexceededbps %></td>
			<td><%= fluxDataTab[i].qospoliceviolatedpps %></td>
			<td><%= fluxDataTab[i].qospoliceviolatedbps %></td>			
		  </tr>
		  <% 
