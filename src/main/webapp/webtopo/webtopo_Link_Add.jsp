...
String className = "ReadDevicePort";
		...
		<tr>
			<td width="30%" valign="top">
				<table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor=#999999 class="text">
					...
					<tr bgcolor=#ffffff>
	 					<td nowrap>端口索引</td>
	 					<td><input type="text" id="ifindex1" name="ifindex1"></td>
	 					<td><input type="text" id="ifindex2" name="ifindex2"></td>
	 				</tr>
					<tr bgcolor=#ffffff>
	 					<td nowrap>端口IP</td>
	 					<td><input type="text" id="ifportip1" name="ifportip1"></td>
	 					<td><input type="text" id="ifportip2" name="ifportip2"></td>
	 				</tr>
	 				<tr bgcolor=#ffffff>
	 					<td nowrap>端口名称</td>
	 					<td><input type="text" id="ifname1" name="ifname1"></td>
	 					<td><input type="text" id="ifname2" name="ifname2"></td>
	 				</tr>
	 				<tr bgcolor=#ffffff>
	 					<td nowrap>端口描述</td>
	 					<td><input type="text" id="ifdescr1" name="ifdescr1"></td>
	 					<td><input type="text" id="ifdescr2" name="ifdescr2"></td>
	 				</tr>
	 				<tr bgcolor=#ffffff>
	 					<td nowrap>端口别名</td>
	 					<td><input type="text" id="ifalias1" name="ifalias1"></td>
	 					<td><input type="text" id="ifalias2" name="ifalias2"></td>
	 				</tr>
	 				<tr bgcolor=#ffffff>
	 					<td nowrap>设备端口数据</td>
					...
					<tr bgcolor=#ffffff>
	 				...
	 				<tr>
	 					<td colspan="3" class="blue_foot"><div align="center"><button type="submit" class="jianbian">保 存</button></div></td>
	 				</tr>
				</table>
			</td>
		</tr>
