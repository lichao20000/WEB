	  	...
	  	<TD bgcolor=#999999>
	    	  <TABLE border=0 cellspacing=1 cellpadding=2 width="100%">
				...
				if(fields!=null){
					...
					GeneralNetPerf netPmMore = new GeneralNetPerf(iStart, iEnd, 5, arr_iid);
...
//					fields = cursor.getNext();
					if(fields == null){
						out.println("<TR bgcolor=#ffffff><TD colspan=5>天报表数据没有入库</TD></TR>");
					}
					else{
