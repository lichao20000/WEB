	...
	<TR>
		<TD>
			<TABLE border=0 cellspacing=1 cellpadding=1 width="100%" height="100%">			
				...
				<TR height=210>
					<TD>
						<table class=text cellSpacing=0 cellPadding=0 align=top bgColor=black border=0 width="100%"
							bordercolorlight="#000000" bordercolordark="#FFFFFF">							
							<tr><td class=column><DIV id="WLAN" align=center></DIV></td></tr>
						</table>
					</TD>
				</TR>			
			</TABLE>		
